const Mc = ":host,sp-theme.todo-theme{display:block;width:100%}.todo-card{padding:1.5rem;border-radius:12px;background:var(--spectrum-background-layer-2-color, #ffffff);box-shadow:0 1px 3px #00000014,0 1px 2px #0000000a;box-sizing:border-box;display:flex;flex-direction:column;gap:1rem}.todo-header{display:flex;align-items:baseline;justify-content:space-between;gap:1rem}.todo-title{margin:0;font-size:1.25rem;font-weight:700;letter-spacing:-.01em;color:var(--spectrum-heading-color, #1e1e2e)}.todo-meta{margin:0;font-size:.8125rem;color:var(--spectrum-body-color, #5c5c6b)}.todo-form{display:flex;flex-direction:column;gap:.25rem}.todo-form-row{display:flex;gap:.5rem;align-items:stretch}.todo-input{flex:1 1 auto;min-width:0}.todo-toast{width:100%;box-sizing:border-box}.todo-status{display:flex;justify-content:center;padding:1.5rem 0}.todo-list{list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:.375rem}.todo-item{display:flex;align-items:center;gap:.75rem;padding:.625rem .75rem;border-radius:8px;background:var(--spectrum-background-layer-1-color, #f4f4f7)}.todo-item-text{flex:1 1 auto;min-width:0;overflow-wrap:anywhere;color:var(--spectrum-body-color, #1e1e2e);font-size:.9375rem;line-height:1.4}.todo-empty{margin:0;padding:1.5rem 0;text-align:center;color:var(--spectrum-body-color, #8a8a99);font-size:.9375rem}";
/**
* @vue/shared v3.5.32
...
const F = {}, Ie = [], Bt = () => {
}, fa = () => !1, Fr = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && // uppercase letter
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), Vr = (e) => e.startsWith("onUpdate:"), at = Object.assign, Wo = (e, t) => {
  const r = e.indexOf(t);
  r > -1 && e.splice(r, 1);
}, Oc = Object.prototype.hasOwnProperty, B = (e, t) => Oc.call(e, t), I = Array.isArray, De = (e) => vr(e) === "[object Map]", va = (e) => vr(e) === "[object Set]", zs = (e) => vr(e) === "[object Date]", D = (e) => typeof e == "function", tt = (e) => typeof e == "string", Mt = (e) => typeof e == "symbol", M = (e) => e !== null && typeof e == "object", ya = (e) => (M(e) || D(e)) && D(e.then) && D(e.catch), xa = Object.prototype.toString, vr = (e) => xa.call(e), Rc = (e) => vr(e).slice(8, -1), ka = (e) => vr(e) === "[object Object]", Go = (e) => tt(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, tr = /* @__PURE__ */ Ko(
...
), wa = Kr((e) => e.charAt(0).toUpperCase() + e.slice(1)), ao = Kr(
  (e) => e ? `on${wa(e)}` : ""
), Pt = (e, t) => !Object.is(e, t), co = (e, ...t) => {
...
let _s;
const Wr = () => _s || (_s = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function Zo(e) {
  if (I(e)) {
    const t = {};
    for (let r = 0; r < e.length; r++) {
      const o = e[r], s = tt(o) ? Gc(o) : Zo(o);
      if (s)
        for (const a in s)
          t[a] = s[a];
    }
...
function Gc(e) {
  const t = {};
  return e.replace(Wc, "").split(Vc).forEach((r) => {
    if (r) {
      const o = r.split(Kc);
...
const Zc = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", Xc = /* @__PURE__ */ Ko(Zc);
function _a(e) {
  return !!e || e === "";
}
function Yc(e, t) {
...
function Yo(e, t) {
  ...
  if (r = M(e), o = M(t), r || o) {
    ...
    for (const c in e) {
      ...
      if (i && !n || !i && n || !Yo(e[c], t[c]))
        return !1;
    }
  }
  return String(e) === String(t);
}
const Ca = (e) => !!(e && e.__v_isRef === !0), he = (e) => tt(e) ? e : e == null ? "" : I(e) || M(e) && (e.toString === xa || !D(e.toString)) ? Ca(e) ? he(e.value) : JSON.stringify(e, $a, 2) : String(e), $a = (e, t) => Ca(t) ? $a(e, t.value) : De(t) ? {
  [`Map(${t.size})`]: [...t.entries()].reduce(
    (r, [o, s], a) => (r[io(o, a) + " =>"] = s, r),
    {}
  )
} : va(t) ? {
  [`Set(${t.size})`]: [...t.values()].map((r) => io(r))
} : Mt(t) ? io(t) : M(t) && !I(t) && !ka(t) ? String(t) : t, io = (e, t = "") => {
  var r;
  return (
...
class Jc {
  ...
  constructor(t = !1) {
    this.detached = t, this._active = !0, this._on = 0, this.effects = [], this.cleanups = [], this._isPaused = !1, this.__v_skip = !0, this.parent = ht, !t && ht && (this.index = (ht.scopes || (ht.scopes = [])).push(
      this
    ) - 1);
  }
  get active() {
...
class Aa {
  ...
  run() {
    if (!(this.flags & 1))
      return this.fn();
    this.flags |= 2, Cs(this), Ea(this);
    const t = N, r = zt;
    N = this, zt = !0;
    try {
      return this.fn();
    } finally {
      Ta(this), N = t, zt = r, this.flags &= -3;
    }
  }
  stop() {
    if (this.flags & 1) {
...
function Ta(e) {
  ...
  for (; o; ) {
    const s = o.prevDep;
    o.version === -1 ? (o === r && (r = s), ts(o), ti(o)) : t = o, o.dep.activeLink = o.prevActiveLink, o.prevActiveLink = void 0, o = s;
  }
...
function Ha(e) {
  if (e.flags & 4 && !(e.flags & 16) || (e.flags &= -17, e.globalVersion === mr) || (e.globalVersion = mr, !e.isSSR && e.flags & 128 && (!e.deps && !e._dirty || !$o(e))))
    return;
  e.flags |= 2;
  const t = e.dep, r = N, o = zt;
  N = e, zt = !0;
  try {
    Ea(e);
...
class es {
  ...
  track(t) {
    if (!N || !zt || N === this.computed)
      return;
    let r = this.activeLink;
    if (r === void 0 || r.sub !== N)
      r = this.activeLink = new ei(N, this), N.deps ? (r.prevDep = N.depsTail, N.depsTail.nextDep = r, N.depsTail = r) : N.deps = N.depsTail = r, Da(r);
    else if (r.version === -1 && (r.version = this.version, r.nextDep)) {
      const o = r.nextDep;
      o.prevDep = r.prevDep, r.prevDep && (r.prevDep.nextDep = o), r.prevDep = N.depsTail, r.nextDep = void 0, N.depsTail.nextDep = r, N.depsTail = r, N.deps === r && (N.deps = o);
    }
    return r;
  }
  trigger(t) {
...
const Ao = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ Symbol(
  ""
), So = /* @__PURE__ */ Symbol(
  ""
), pr = /* @__PURE__ */ Symbol(
...
function ct(e, t, r) {
  if (zt && N) {
    ...
    let s = o.get(r);
    s || (o.set(r, s = new es()), s.map = o, s.key = r), s.track();
  }
}
function Vt(e, t, r, o, s, a) {
  const c = Ao.get(e);
  if (!c) {
    mr++;
    return;
  ...
  if (Jo(), t === "clear")
    ...
    const n = I(e), p = n && Go(r);
    if (n && r === "length") {
      const u = Number(o);
      c.forEach((d, y) => {
        (y === "length" || y === pr || !Mt(y) && y >= u) && i(d);
      });
    } else
      switch ((r !== void 0 || c.has(void 0)) && i(c.get(r)), p && i(c.get(pr)), t) {
        case "add":
          n ? p && i(c.get("length")) : (i(c.get(xe)), De(e) && i(c.get(So)));
          break;
        case "delete":
          n || (i(c.get(xe)), De(e) && i(c.get(So)));
          break;
        case "set":
          De(e) && i(c.get(xe));
          break;
...
function $e(e) {
  ...
  return t === e ? t : (ct(t, "iterate", pr), /* @__PURE__ */ kt(e) ? t : t.map(_t));
}
function Gr(e) {
  return ct(e = /* @__PURE__ */ L(e), "iterate", pr), e;
}
function Ht(e, t) {
  return /* @__PURE__ */ Zt(e) ? Be(/* @__PURE__ */ ke(e) ? _t(t) : t) : _t(t);
}
const ri = {
  __proto__: null,
  [Symbol.iterator]() {
    return lo(this, Symbol.iterator, (e) => Ht(this, e));
  },
  concat(...e) {
  ...
  entries() {
    return lo(this, "entries", (e) => (e[1] = Ht(this, e[1]), e));
  },
  every(e, t) {
  ...
  values() {
    return lo(this, "values", (e) => Ht(this, e));
  }
};
function lo(e, t, r) {
  const o = Gr(e), s = o[t]();
  return o !== e && !/* @__PURE__ */ kt(e) && (s._next = s.next, s.next = () => {
    const a = s._next();
    return a.done || (a.value = r(a.value)), a;
  }), s;
}
const oi = Array.prototype;
function Rt(e, t, r, o, s, a) {
  const c = Gr(e), i = c !== e && !/* @__PURE__ */ kt(e), n = c[t];
  if (n !== oi[t]) {
    const d = n.apply(e, a);
    return i ? _t(d) : d;
  }
  let p = r;
  c !== e && (i ? p = function(d, y) {
    return r.call(this, Ht(e, d), y, e);
  } : r.length > 2 && (p = function(d, y) {
...
function $s(e, t, r, o) {
  const s = Gr(e), a = s !== e && !/* @__PURE__ */ kt(e);
  let c = r, i = !1;
  s !== e && (a ? (i = o.length === 0, c = function(p, u, d) {
    return i && (i = !1, p = Ht(e, p)), r.call(this, p, Ht(e, u), d, e);
...
function uo(e, t, r) {
  ...
  ct(o, "iterate", pr);
  const s = o[t](...r);
  return (s === -1 || s === !1) && /* @__PURE__ */ as(r[0]) ? (r[0] = /* @__PURE__ */ L(r[0]), o[t](...r)) : s;
}
function Ge(e, t, r = []) {
  Wt(), Jo();
...
const si = /* @__PURE__ */ Ko("__proto__,__v_isRef,__isVue"), Pa = new Set(
...
class qa {
  ...
  get(t, r, o) {
    ...
    if (r === "__v_isShallow")
      return a;
    if (r === "__v_raw")
      return o === (s ? a ? bi : Oa : a ? Ma : Ba).get(t) || // receiver is not the reactive proxy, but has the same prototype
    ...
    if ((Mt(r) ? Pa.has(r) : si(r)) || (s || ct(t, "get", r), a))
      return i;
    if (/* @__PURE__ */ it(i)) {
      const n = c && Go(r) ? i : i.value;
      return s && M(n) ? /* @__PURE__ */ Eo(n) : n;
    }
    return M(i) ? s ? /* @__PURE__ */ Eo(i) : /* @__PURE__ */ os(i) : i;
  }
}
class La extends qa {
  constructor(t = !1) {
  ...
  set(t, r, o, s) {
    ...
    const c = I(t) && Go(r);
    if (!this._isShallow) {
      const p = /* @__PURE__ */ Zt(a);
      if (!/* @__PURE__ */ kt(o) && !/* @__PURE__ */ Zt(o) && (a = /* @__PURE__ */ L(a), o = /* @__PURE__ */ L(o)), !c && /* @__PURE__ */ it(a) && !/* @__PURE__ */ it(o))
        return p || (a.value = o), !0;
    }
    const i = c ? Number(r) < t.length : B(t, r), n = Reflect.set(
      t,
      r,
      o,
      /* @__PURE__ */ it(t) ? t : s
    );
    return t === /* @__PURE__ */ L(s) && (i ? Pt(o, a) && Vt(t, "set", r, o) : Vt(t, "add", r, o)), n;
  }
  deleteProperty(t, r) {
    const o = B(t, r);
    t[r];
    const s = Reflect.deleteProperty(t, r);
    return s && o && Vt(t, "delete", r, void 0), s;
  }
  has(t, r) {
    const o = Reflect.has(t, r);
    return (!Mt(r) || !Pa.has(r)) && ct(t, "has", r), o;
  }
  ownKeys(t) {
    return ct(
      t,
...
const ii = /* @__PURE__ */ new La(), ni = /* @__PURE__ */ new ci(), li = /* @__PURE__ */ new La(!0);
const jo = (e) => e, Sr = (e) => Reflect.getPrototypeOf(e);
function ui(e, t, r) {
  return function(...o) {
    const s = this.__v_raw, a = /* @__PURE__ */ L(s), c = De(a), i = e === "entries" || e === Symbol.iterator && c, n = e === "keys" && c, p = s[e](...o), u = r ? jo : t ? Be : _t;
    return !t && ct(
      a,
      "iterate",
      n ? So : xe
...
function mi(e, t) {
  const r = {
    get(s) {
      ...
      e || (Pt(s, i) && ct(c, "get", s), ct(c, "get", i));
      const { has: n } = Sr(c), p = t ? jo : e ? Be : _t;
      if (n.call(c, s))
        return p(a.get(s));
      if (n.call(c, i))
        return p(a.get(i));
    ...
    get size() {
      ...
      return !e && ct(/* @__PURE__ */ L(s), "iterate", xe), s.size;
    },
    has(s) {
      const a = this.__v_raw, c = /* @__PURE__ */ L(a), i = /* @__PURE__ */ L(s);
      return e || (Pt(s, i) && ct(c, "has", s), ct(c, "has", i)), s === i ? a.has(s) : a.has(s) || a.has(i);
    },
    forEach(s, a) {
      const c = this, i = c.__v_raw, n = /* @__PURE__ */ L(i), p = t ? jo : e ? Be : _t;
      return !e && ct(n, "iterate", xe), i.forEach((u, d) => s.call(a, p(u), p(d), c));
    }
  };
  return at(
    r,
    e ? {
      ...
      add(s) {
        const a = /* @__PURE__ */ L(this), c = Sr(a), i = /* @__PURE__ */ L(s), n = !t && !/* @__PURE__ */ kt(s) && !/* @__PURE__ */ Zt(s) ? i : s;
        return c.has.call(a, n) || Pt(s, n) && c.has.call(a, s) || Pt(i, n) && c.has.call(a, i) || (a.add(n), Vt(a, "add", n, n)), this;
      },
      set(s, a) {
        !t && !/* @__PURE__ */ kt(a) && !/* @__PURE__ */ Zt(a) && (a = /* @__PURE__ */ L(a));
        const c = /* @__PURE__ */ L(this), { has: i, get: n } = Sr(c);
        let p = i.call(c, s);
        p || (s = /* @__PURE__ */ L(s), p = i.call(c, s));
        const u = n.call(c, s);
        return c.set(s, a), p ? Pt(a, u) && Vt(c, "set", s, a) : Vt(c, "add", s, a), this;
      },
      delete(s) {
        const a = /* @__PURE__ */ L(this), { has: c, get: i } = Sr(a);
        let n = c.call(a, s);
        n || (s = /* @__PURE__ */ L(s), n = c.call(a, s)), i && i.call(a, s);
        const p = a.delete(s);
        return n && Vt(a, "delete", s, void 0), p;
      },
      clear() {
...
const Ba = /* @__PURE__ */ new WeakMap(), Ma = /* @__PURE__ */ new WeakMap(), Oa = /* @__PURE__ */ new WeakMap(), bi = /* @__PURE__ */ new WeakMap();
function hi(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function fi(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : hi(Rc(e));
}
// @__NO_SIDE_EFFECTS__
function os(e) {
  return /* @__PURE__ */ Zt(e) ? e : ss(
    e,
    !1,
    ii,
    pi,
...
function ss(e, t, r, o, s) {
  if (!M(e) || e.__v_raw && !(t && e.__v_isReactive))
    return e;
  const a = fi(e);
  if (a === 0)
    return e;
...
// @__NO_SIDE_EFFECTS__
function ke(e) {
  return /* @__PURE__ */ Zt(e) ? /* @__PURE__ */ ke(e.__v_raw) : !!(e && e.__v_isReactive);
}
// @__NO_SIDE_EFFECTS__
function Zt(e) {
...
function yi(e) {
  return !B(e, "__v_skip") && Object.isExtensible(e) && za(e, "__v_skip", !0), e;
}
const _t = (e) => M(e) ? /* @__PURE__ */ os(e) : e, Be = (e) => M(e) ? /* @__PURE__ */ Eo(e) : e;
// @__NO_SIDE_EFFECTS__
function it(e) {
...
function xi(e, t) {
  return /* @__PURE__ */ it(e) ? e : new ki(e, t);
}
class ki {
  constructor(t, r) {
    this.dep = new es(), this.__v_isRef = !0, this.__v_isShallow = !1, this._rawValue = r ? t : /* @__PURE__ */ L(t), this._value = r ? t : _t(t), this.__v_isShallow = r;
  }
  get value() {
    return this.dep.track(), this._value;
  }
  set value(t) {
    const r = this._rawValue, o = this.__v_isShallow || /* @__PURE__ */ kt(t) || /* @__PURE__ */ Zt(t);
    t = o ? t : /* @__PURE__ */ L(t), Pt(t, r) && (this._rawValue = t, this._value = o ? t : _t(t), this.dep.trigger());
  }
}
function st(e) {
  return /* @__PURE__ */ it(e) ? e.value : e;
}
const wi = {
  get: (e, t, r) => t === "__v_raw" ? e : st(Reflect.get(e, t, r)),
  set: (e, t, r, o) => {
    const s = e[t];
    return /* @__PURE__ */ it(s) && !/* @__PURE__ */ it(r) ? (s.value = r, !0) : Reflect.set(e, t, r, o);
  }
};
function Ra(e) {
  return /* @__PURE__ */ ke(e) ? e : new Proxy(e, wi);
}
class zi {
  constructor(t, r, o) {
    this.fn = t, this.setter = r, this._value = void 0, this.dep = new es(this), this.__v_isRef = !0, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = mr - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !r, this.isSSR = o;
  }
  /**
   * @internal
   */
...
function _i(e, t, r = !1) {
  let o, s;
  return D(e) ? o = e : (o = e.get, s = e.set), new zi(o, s, r);
}
const Er = {}, qr = /* @__PURE__ */ new WeakMap();
let fe;
function Ci(e, t = !1, r = fe) {
  if (r) {
    let o = qr.get(r);
    o || qr.set(r, o = []), o.push(e);
  }
}
function $i(e, t, r = F) {
  const { immediate: o, deep: s, once: a, scheduler: c, augmentJob: i, call: n } = r, p = (T) => s ? T : /* @__PURE__ */ kt(T) || s === !1 || s === 0 ? oe(T, 1) : oe(T);
  let u, d, y, z, E = !1, A = !1;
  if (/* @__PURE__ */ it(e) ? (d = () => e.value, E = /* @__PURE__ */ kt(e)) : /* @__PURE__ */ ke(e) ? (d = () => p(e), E = !0) : I(e) ? (A = !0, E = e.some((T) => /* @__PURE__ */ ke(T) || /* @__PURE__ */ kt(T)), d = () => e.map((T) => {
    if (/* @__PURE__ */ it(T))
      return T.value;
    if (/* @__PURE__ */ ke(T))
      return p(T);
    ...
    fe = u;
    try {
      return n ? n(e, 3, [z]) : e(z);
    } finally {
      fe = T;
    }
  } : d = Bt, t && s) {
    const T = d, et = s === !0 ? 1 / 0 : s;
    d = () => oe(T(), et);
  }
  const J = Qc(), G = () => {
    u.stop(), J && J.active && Wo(J.effects, u);
  };
  if (a && t) {
    const T = t;
    t = (...et) => {
  ...
  let P = A ? new Array(e.length).fill(Er) : Er;
  const V = (T) => {
    if (!(!(u.flags & 1) || !u.dirty && !T))
      if (t) {
        const et = u.run();
        if (s || E || (A ? et.some((Yt, Ct) => Pt(Yt, P[Ct])) : Pt(et, P))) {
          y && y();
          const Yt = fe;
          fe = u;
          try {
  ...
  return i && i(V), u = new Aa(d), u.scheduler = c ? () => c(V, !1) : V, z = (T) => Ci(T, !1, u), y = u.onStop = () => {
    const T = qr.get(u);
    if (T) {
      if (n)
        n(T, 4);
      else
        for (const et of T) et();
      qr.delete(u);
    }
  }, t ? o ? V(!0) : P = u.run() : c ? c(V.bind(null, !0), !0) : u.run(), G.pause = u.pause.bind(u), G.resume = u.resume.bind(u), G.stop = G, G;
}
function oe(e, t = 1 / 0, r) {
  if (t <= 0 || !M(e) || e.__v_skip || (r = r || /* @__PURE__ */ new Map(), (r.get(e) || 0) >= t))
    return e;
  if (r.set(e, t), t--, /* @__PURE__ */ it(e))
    oe(e.value, t, r);
  else if (I(e))
    ...
    for (const o of Object.getOwnPropertySymbols(e))
      Object.prototype.propertyIsEnumerable.call(e, o) && oe(e[o], t, r);
  }
  return e;
}
/**
...
function Zr(e, t, r, o = !0) {
  const s = t ? t.vnode : null, { errorHandler: a, throwUnhandledErrorInProduction: c } = t && t.appContext.config || F;
  if (t) {
    let i = t.parent;
...
function ji(e) {
  let t = Tt + 1, r = dt.length;
  for (; t < r; ) {
    const o = t + r >>> 1, s = dt[o], a = dr(s);
...
function cs(e) {
  if (!(e.flags & 1)) {
    const t = dr(e), r = dt[dt.length - 1];
    !r || // fast path when the job id is larger than the tail
    !(e.flags & 2) && t >= dr(r) ? dt.push(e) : dt.splice(ji(t), 0, e), e.flags |= 1, Na();
  }
}
function Na() {
  Lr || (Lr = Ua.then(Va));
...
function Ei(e) {
  I(e) ? Pe.push(...e) : re && e.id === -1 ? re.splice(Ee + 1, 0, e) : e.flags & 1 || (Pe.push(e), e.flags |= 1), Na();
}
function As(e, t, r = Tt + 1) {
  for (; r < dt.length; r++) {
    const o = dt[r];
    if (o && o.flags & 2) {
      if (e && o.id !== e.uid)
        continue;
      dt.splice(r, 1), r--, o.flags & 4 && (o.flags &= -2), o(), o.flags & 4 || (o.flags &= -2);
    }
  }
}
function Fa(e) {
  if (Pe.length) {
    const t = [...new Set(Pe)].sort(
      (r, o) => dr(r) - dr(o)
    );
    if (Pe.length = 0, re) {
      re.push(...t);
...
function Va(e) {
  try {
    ...
    Tt = -1, dt.length = 0, Fa(), Lr = null, (dt.length || Pe.length) && Va();
  }
}
let qt = null, Ka = null;
function Br(e) {
  const t = qt;
  return qt = e, Ka = e && e.type.__scopeId || null, t;
}
function Ti(e, t = qt, r) {
  if (!t || e._n)
    return e;
  const o = (...s) => {
    o._d && Bs(-1);
...
function Hi(e, t) {
  if (gt) {
    ...
    o === r && (r = gt.provides = Object.create(o)), r[e] = t;
  }
}
function Hr(e, t, r = !1) {
  const o = qn();
  if (o || qe) {
    let s = qe ? qe._context.provides : o ? o.parent == null || o.ce ? o.vnode.appContext && o.vnode.appContext.provides : o.parent.provides : void 0;
    if (s && e in s)
      return s[e];
...
const Ii = /* @__PURE__ */ Symbol.for("v-scx"), Di = () => Hr(Ii);
function mo(e, t, r) {
  return Wa(e, t, r);
}
function Wa(e, t, r = F) {
  const { immediate: o, deep: s, flush: a, once: c } = r, i = at({}, r), n = t && o || !t && a !== "post";
  let p;
  if (br) {
    if (a === "sync") {
      const z = Di();
      p = z.__watcherHandles || (z.__watcherHandles = []);
    } else if (!n) {
      const z = () => {
      };
      return z.stop = Bt, z.resume = Bt, z.pause = Bt, z;
    }
  }
  const u = gt;
  i.call = (z, E, A) => Ot(z, u, E, A);
  let d = !1;
  a === "post" ? i.scheduler = (z) => {
    bt(z, u && u.suspense);
  } : a !== "sync" && (d = !0, i.scheduler = (z, E) => {
    E ? z() : cs(z);
  }), i.augmentJob = (z) => {
    t && (z.flags |= 4), d && (z.flags |= 2, u && (z.id = u.uid, z.i = u));
  };
  const y = $i(e, t, i);
  return br && (p ? p.push(y) : n && y()), y;
}
function Pi(e, t, r) {
  const o = this.proxy, s = tt(e) ? e.includes(".") ? Ga(o, e) : () => o[e] : e.bind(o, o);
  let a;
  D(t) ? a = t : (a = t.handler, r = t);
  const c = xr(this), i = Wa(s, a.bind(o), r);
  return c(), i;
}
function Ga(e, t) {
  const r = t.split(".");
...
const qi = /* @__PURE__ */ Symbol("_vte"), Li = (e) => e.__isTeleport, Bi = /* @__PURE__ */ Symbol("_leaveCb");
function is(e, t) {
...
function or(e, t, r, o, s = !1) {
  ...
  if (sr(o) && !s) {
    o.shapeFlag & 512 && o.type.__asyncResolved && o.component.subTree.component && or(e, t, r, o.component.subTree);
    return;
  }
  const a = o.shapeFlag & 4 ? ps(o.component) : o.el, c = s ? null : a, { i, r: n } = e, p = t && t.r, u = i.refs === F ? i.refs = {} : i.refs, d = i.setupState, y = /* @__PURE__ */ L(d), z = d === F ? fa : (A) => Ss(u, A) ? !1 : B(y, A), E = (A, J) => !(J && Ss(u, J));
  if (p != null && p !== n) {
    if (js(t), tt(p))
      u[p] = null, z(p) && (d[p] = null);
    else if (/* @__PURE__ */ it(p)) {
      const A = t;
      E(p, A.k) && (p.value = null), A.k && (u[A.k] = null);
    }
  }
  if (D(n))
    yr(n, i, 12, [c, u]);
  else {
    const A = tt(n), J = /* @__PURE__ */ it(n);
    if (A || J) {
      const G = () => {
        if (e.f) {
          const P = A ? z(n) ? d[n] : u[n] : E() || !e.k ? n.value : u[e.k];
          if (s)
            I(P) && Wo(P, a);
          else if (I(P))
            ...
            const V = [a];
            E(n, e.k) && (n.value = V), e.k && (u[e.k] = V);
          }
        } else A ? (u[n] = c, z(n) && (d[n] = c)) : J && (E(n, e.k) && (n.value = c), e.k && (u[e.k] = c));
      };
      if (c) {
        const P = () => {
          G(), Mr.delete(e);
        };
        P.id = -1, Mr.set(e, P), bt(P, r);
      } else
        js(e), G();
    }
  }
...
const sr = (e) => !!e.type.__asyncLoader, Xa = (e) => e.type.__isKeepAlive;
function Oi(e, t) {
  Ya(e, "a", t);
}
function Ri(e, t) {
...
function Ya(e, t, r = gt) {
  ...
  if (Xr(t, o, r), r) {
    let s = r.parent;
    for (; s && s.parent; )
      Xa(s.parent.vnode) && Ui(o, t, r, s), s = s.parent;
  }
}
function Ui(e, t, r, o) {
  const s = Xr(
...
function Xr(e, t, r = gt, o = !1) {
  if (r) {
    const s = r[e] || (r[e] = []), a = t.__weh || (t.__weh = (...c) => {
      Wt();
      const i = xr(r), n = Ot(t, r, e, c);
      return i(), Gt(), n;
    });
...
const Xt = (e) => (t, r = gt) => {
  (!br || e === "sp") && Xr(e, (...o) => t(...o), r);
}, Ni = Xt("bm"), Ja = Xt("m"), Fi = Xt(
  "bu"
), Vi = Xt("u"), Ki = Xt(
  "bum"
), ns = Xt("um"), Wi = Xt(
...
function Ji(e, t, r, o) {
  ...
  const a = r, c = I(e);
  if (c || tt(e)) {
    const i = c && /* @__PURE__ */ ke(e);
    let n = !1, p = !1;
    i && (n = !/* @__PURE__ */ kt(e), p = /* @__PURE__ */ Zt(e), e = Gr(e)), s = new Array(e.length);
    for (let u = 0, d = e.length; u < d; u++)
      s[u] = t(
        n ? p ? Be(_t(e[u])) : _t(e[u]) : e[u],
        u,
        void 0,
        a
      );
...
const To = (e) => e ? yc(e) ? ps(e) : To(e.parent) : null, ar = (
...
), po = (e, t) => e !== F && !e.__isScriptSetup && B(e, t), Qi = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
    ...
    let u, d;
    if (p)
      return t === "$attrs" && ct(e.attrs, "get", ""), p(e);
    if (
    ...
    if (
      // global properties
      d = n.config.globalProperties, B(d, t)
    )
      return d[t];
  },
  set({ _: e }, t, r) {
    const { data: o, setupState: s, ctx: a } = e;
    return po(s, t) ? (s[t] = r, !0) : o !== F && B(o, t) ? (o[t] = r, !0) : B(e.props, t) || t[0] === "$" && t.slice(1) in e ? !1 : (a[t] = r, !0);
  },
  has({
    _: { data: e, setupState: t, accessCache: r, ctx: o, appContext: s, props: a, type: c }
  }, i) {
    let n;
    return !!(r[i] || e !== F && i[0] !== "$" && B(e, i) || po(t, i) || B(a, i) || B(o, i) || B(ar, i) || B(s.config.globalProperties, i) || (n = c.__cssModules) && n[i]);
  },
...
let Ho = !0;
function tn(e) {
  const t = tc(e), r = e.proxy, o = e.ctx;
  Ho = !1, t.beforeCreate && Ts(t.beforeCreate, e, "bc");
  const {
    // state
    data: s,
    computed: a,
  ...
  if (s) {
    const Z = s.call(r, r);
    M(Z) && (e.data = /* @__PURE__ */ os(Z));
  }
  if (Ho = !0, a)
    for (const Z in a) {
      const R = a[Z], le = D(R) ? R.bind(r, r) : D(R.get) ? R.get.bind(r, r) : Bt, $r = !D(R) && D(R.set) ? R.set.bind(r) : Bt, ue = Un({
        get: le,
        set: $r
      });
  ...
  u && Ts(u, e, "c");
  function lt(Z, R) {
    I(R) ? R.forEach((le) => Z(le.bind(r))) : R && Z(R.bind(r));
  }
  if (lt(Ni, d), lt(Ja, y), lt(Fi, z), lt(Vi, E), lt(Oi, A), lt(Ri, J), lt(Xi, Jt), lt(Zi, Yt), lt(Gi, Ct), lt(Ki, P), lt(ns, T), lt(Wi, zr), I(ne))
    if (ne.length) {
  ...
  et && e.render === Bt && (e.render = et), Fe != null && (e.inheritAttrs = Fe), _r && (e.components = _r), Cr && (e.directives = Cr), zr && Za(e);
}
function en(e, t, r = Bt) {
  I(e) && (e = Io(e));
  for (const o in e) {
    const s = e[o];
    let a;
    M(s) ? "default" in s ? a = Hr(
      s.from || o,
      s.default,
      !0
    ) : a = Hr(s.from || o) : a = Hr(s), /* @__PURE__ */ it(a) ? Object.defineProperty(t, o, {
      enumerable: !0,
      configurable: !0,
      get: () => a.value,
      set: (c) => a.value = c
...
function tc(e) {
  ...
  return i ? n = i : !s.length && !r && !o ? n = t : (n = {}, s.length && s.forEach(
    (p) => Or(n, p, c, !0)
  ), Or(n, t, c)), M(t) && a.set(t, n), n;
}
function Or(e, t, r, o = !1) {
  const { mixins: s, extends: a } = t;
  a && Or(e, a, r, !0), s && s.forEach(
    (c) => Or(e, c, r, !0)
  );
  for (const c in t)
    if (!(o && c === "expose")) {
...
function Is(e, t) {
  return e ? I(e) && I(t) ? [.../* @__PURE__ */ new Set([...e, ...t])] : at(
...
function cn(e, t) {
  return function(o, s = null) {
    D(o) || (o = at({}, o)), s != null && !M(s) && (s = null);
    const a = ec(), c = /* @__PURE__ */ new WeakSet(), i = [];
    let n = !1;
    const p = a.app = {
      _uid: an++,
      _component: o,
      ...
      use(u, ...d) {
        return c.has(u) || (u && D(u.install) ? (c.add(u), u.install(p, ...d)) : D(u) && (c.add(u), u(p, ...d))), p;
      },
      mixin(u) {
      ...
      mount(u, d, y) {
        if (!n) {
          const z = p._ceVNode || Kt(o, s);
          return z.appContext = a, y === !0 ? y = "svg" : y === !1 && (y = void 0), e(z, u, y), n = !0, p._container = u, u.__vue_app__ = p, ps(z.component);
        }
      },
      onUnmount(u) {
        i.push(u);
...
let qe = null;
const nn = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${wt(t)}Modifiers`] || e[`${_e(t)}Modifiers`];
function ln(e, t, ...r) {
  if (e.isUnmounted) return;
  const o = e.vnode.props || F;
  let s = r;
  const a = t.startsWith("update:"), c = a && nn(o, t.slice(7));
  c && (c.trim && (s = r.map((u) => tt(u) ? u.trim() : u)), c.number && (s = r.map(Fc)));
  let i, n = o[i = ao(t)] || // also try camelCase event handler (#2249)
  o[i = ao(wt(t))];
  !n && a && (n = o[i = ao(_e(t))]), n && Ot(
    n,
    e,
    6,
    s
...
function rc(e, t, r = !1) {
  const o = r ? un : t.emitsCache, s = o.get(e);
  if (s !== void 0)
    return s;
  const a = e.emits;
  let c = {}, i = !1;
  ...
  return !a && !i ? (M(e) && o.set(e, null), null) : (I(a) ? a.forEach((n) => c[n] = null) : at(c, a), M(e) && o.set(e, c), c);
}
function Yr(e, t) {
  return !e || !Fr(t) ? !1 : (t = t.slice(2).replace(/Once$/, ""), B(e, t[0].toLowerCase() + t.slice(1)) || B(e, _e(t)) || B(e, t));
}
function Ds(e) {
  const {
    type: t,
  ...
  try {
    ...
    cr.length = 0, Zr(T, e, 1), G = Kt(ce);
  }
  let V = G;
  if (P && A !== !1) {
    const T = Object.keys(P), { shapeFlag: et } = V;
    T.length && et & 7 && (a && T.some(Vr) && (P = pn(
      P,
      a
    )), V = Me(V, P, !1, !0));
  }
  return r.dirs && (V = Me(V, null, !1, !0), V.dirs = V.dirs ? V.dirs.concat(r.dirs) : r.dirs), r.transition && is(V, r.transition), G = V, Br(J), G;
}
const mn = (e) => {
  let t;
  for (const r in e)
...
function dn(e, t, r) {
  ...
  if (r && n >= 0) {
    ...
    return (s || i) && (!i || !i.$stable) ? !0 : o === c ? !1 : o ? c ? Ps(o, c, p) : !0 : !!c;
  return !1;
}
function Ps(e, t, r) {
...
function oc(e, t, r) {
  const o = e[r], s = t[r];
  return r === "style" && M(o) && M(s) ? !Yo(o, s) : o !== s;
}
function gn({ vnode: e, parent: t, suspense: r }, o) {
  for (; t; ) {
    const s = t.subTree;
...
function bn(e, t, r, o = !1) {
  const s = {}, a = ac();
  e.propsDefaults = /* @__PURE__ */ Object.create(null), ic(e, t, s, a);
  for (const c in e.propsOptions[0])
    c in s || (s[c] = void 0);
  r ? e.props = o ? s : /* @__PURE__ */ vi(s) : e.type.props ? e.props = s : e.props = a, e.attrs = a;
}
function hn(e, t, r, o) {
  const {
    props: s,
  ...
  if (
    ...
    for (const d in i)
      ...
      ((u = _e(d)) === d || !B(t, u))) && (n ? r && // for camelCase
...
function ic(e, t, r, o) {
  ...
  if (t)
    for (let n in t) {
      ...
      const p = t[n];
      let u;
      s && B(s, u = wt(n)) ? !a || !a.includes(u) ? r[u] = p : (i || (i = {}))[u] = p : Yr(e.emitsOptions, n) || (!(n in o) || p !== o[n]) && (o[n] = p, c = !0);
    }
  if (a) {
    const n = /* @__PURE__ */ L(r), p = i || F;
...
function Do(e, t, r, o, s, a) {
  const c = e[r];
  if (c != null) {
    const i = B(c, "default");
    if (i && o === void 0) {
      const n = c.default;
      if (c.type !== Function && !c.skipFactory && D(n)) {
...
function nc(e, t, r = !1) {
  const o = r ? fn : t.propsCache, s = o.get(e);
  if (s)
    return s;
  const a = e.props, c = {}, i = [];
  let n = !1;
  ...
  if (I(a))
    ...
    for (const u in a) {
      const d = wt(u);
      if (qs(d)) {
        const y = a[u], z = c[d] = I(y) || D(y) ? { type: y } : at({}, y), E = z.type;
        let A = !1, J = !0;
        if (I(E))
          for (let G = 0; G < E.length; ++G) {
            const P = E[G], V = D(P) && P.name;
            if (V === "Boolean") {
              A = !0;
              break;
            } else V === "String" && (J = !1);
        ...
        z[
          ...
          1
          /* shouldCastTrue */
        ] = J, (A || B(z, "default")) && i.push(d);
      }
    }
  const p = [c, i];
  return M(e) && o.set(e, p), p;
}
function qs(e) {
  return e[0] !== "$" && !tr(e);
}
const ls = (e) => e === "_" || e === "_ctx" || e === "$stable", us = (e) => I(e) ? e.map(Dt) : [Dt(e)], vn = (e, t, r) => {
  if (t._n)
    return t;
  const o = Ti((...s) => us(t(...s)), r);
  return o._c = !1, o;
}, lc = (e, t, r) => {
  const o = e._ctx;
  for (const s in e) {
  ...
  if (e.vnode.shapeFlag & 32) {
    const s = t._;
    s ? (mc(o, t, r), r && za(o, "_", s, !0)) : lc(t, o);
  } else t && uc(e, t);
}, xn = (e, t, r) => {
  ...
  if (o.shapeFlag & 32) {
    const i = t._;
    i ? r && i === 1 ? a = !1 : mc(s, t, r) : (a = !t.$stable, lc(t, s)), c = t;
  } else t && (uc(e, t), c = { default: 1 });
  if (a)
    for (const i in s)
      !ls(i) && c[i] == null && delete s[i];
}, bt = Cn;
function kn(e) {
  return wn(e);
}
function wn(e, t) {
  ...
  const {
  ...
  } = e, A = (l, m, g, v = null, b = null, h = null, w = void 0, k = null, x = !!m.dynamicChildren) => {
    if (l === m)
      return;
    l && !Ze(l, m) && (v = Ar(l), $t(l, b, h, !0), l = null), m.patchFlag === -2 && (x = !1, m.dynamicChildren = null);
    const { type: f, ref: S, shapeFlag: _ } = m;
    switch (f) {
      case Jr:
        J(l, m, g, v);
        break;
    ...
    S != null && b ? or(S, l && l.ref, h, m || l, !m) : S == null && l && l.ref != null && or(l.ref, null, h, l, !0);
  }, J = (l, m, g, v) => {
    if (l == null)
      o(
        m.el = i(m.children),
      ...
      const b = m.el = l.el;
      m.children !== l.children && p(b, m.children);
    }
  }, G = (l, m, g, v) => {
    l == null ? o(
      m.el = n(m.children || ""),
    ...
    for (; l && l !== m; )
      g = y(l), s(l), l = g;
    s(m);
  }, et = (l, m, g, v, b, h, w, k, x) => {
    if (m.type === "svg" ? w = "svg" : m.type === "math" && (w = "mathml"), l == null)
      Yt(
        m,
        g,
        v,
      ...
      const f = l.el && l.el._isVueCE ? l.el : null;
      try {
        f && f._beginPatch(), zr(
          l,
          m,
    ...
    let x, f;
    const { props: S, shapeFlag: _, transition: $, dirs: j } = l;
    if (x = l.el = c(
      l.type,
      h,
      S && S.is,
      S
    ), _ & 8 ? u(x, l.children) : _ & 16 && Jt(
      l.children,
      x,
      null,
      v,
      ...
      w,
      k
    ), j && me(l, null, v, "created"), Ct(x, l, l.scopeId, w, v), S) {
      for (const O in S)
        O !== "value" && !tr(O) && a(x, O, null, S[O], h, v);
      "value" in S && a(x, "value", null, S.value, h), (f = S.onVnodeBeforeMount) && Et(f, v, l);
    }
    j && me(l, null, v, "beforeMount");
    const q = zn(b, $);
    q && $.beforeEnter(x), o(x, m, g), ((f = S && S.onVnodeMounted) || q || j) && bt(() => {
      try {
        f && Et(f, v, l), q && $.enter(x), j && me(l, null, v, "mounted");
      } finally {
      }
    }, b);
  }, Ct = (l, m, g, v, b) => {
    ...
    if (b) {
      let h = b.subTree;
      if (m === h || bc(h.type) && (h.ssContent === m || h.ssFallback === m)) {
        const w = b.vnode;
        Ct(
          l,
          w,
  ...
  }, Jt = (l, m, g, v, b, h, w, k, x = 0) => {
    for (let f = x; f < l.length; f++) {
      const S = l[f] = k ? Ft(l[f]) : Dt(l[f]);
      A(
        null,
        S,
        m,
    ...
    const k = m.el = l.el;
    let { patchFlag: x, dynamicChildren: f, dirs: S } = m;
    x |= l.patchFlag & 16;
    const _ = l.props || F, $ = m.props || F;
    let j;
    if (g && pe(g, !1), (j = $.onVnodeBeforeUpdate) && Et(j, g, m, l), S && me(m, l, g, "beforeUpdate"), g && pe(g, !0), (_.innerHTML && $.innerHTML == null || _.textContent && $.textContent == null) && u(k, ""), f ? ne(
      l.dynamicChildren,
      f,
      k,
      g,
      ...
      if (x & 16)
        Fe(k, _, $, g, b);
      else if (x & 2 && _.class !== $.class && a(k, "class", null, $.class, b), x & 4 && a(k, "style", _.style, $.style, b), x & 8) {
        const q = m.dynamicProps;
        for (let O = 0; O < q.length; O++) {
          const U = q[O], Q = _[U], ot = $[U];
          (ot !== Q || U === "value") && a(k, U, Q, ot, b, g);
        }
      }
      x & 1 && l.children !== m.children && u(k, m.children);
    } else !w && f == null && Fe(k, _, $, g, b);
    ((j = $.onVnodeUpdated) || S) && bt(() => {
      j && Et(j, g, m, l), S && me(m, l, g, "updated");
    }, v);
  }, ne = (l, m, g, v, b, h, w) => {
    for (let k = 0; k < m.length; k++) {
      const x = l[k], f = m[k], S = (
        ...
        (x.type === It || // - In the case of different nodes, there is going to be a replacement
        // which also requires the correct parent container
        !Ze(x, f) || // - In the case of a component, it could contain anything.
    ...
    if (m !== g) {
      ...
      for (const h in g) {
        if (tr(h)) continue;
        const w = g[h], k = m[h];
        w !== k && h !== "value" && a(l, h, k, w, b, v);
      }
      "value" in g && a(l, "value", m.value, g.value, b);
    }
  }, _r = (l, m, g, v, b, h, w, k, x) => {
    const f = m.el = l ? l.el : i(""), S = m.anchor = l ? l.anchor : i("");
    let { patchFlag: _, dynamicChildren: $, slotScopeIds: j } = m;
    j && (k = k ? k.concat(j) : j), l == null ? (o(f, g, v), o(S, g, v), Jt(
      // #10007
      ...
      k,
      x
    )) : _ > 0 && _ & 64 && $ && // #2715 the previous fragment could've been a BAILed one as a result
    // of renderSlot() with no valid children
    l.dynamicChildren && l.dynamicChildren.length === $.length ? (ne(
      l.dynamicChildren,
      $,
      g,
      b,
  ...
  }, Cr = (l, m, g, v, b, h, w, k, x) => {
    m.slotScopeIds = k, l == null ? m.shapeFlag & 512 ? b.ctx.activate(
      m,
      g,
      v,
      w,
    ...
    const k = l.component = Pn(
      l,
      v,
      b
    );
    if (Xa(l) && (k.ctx.renderer = Ke), Ln(k, !1, w), k.asyncDep) {
      if (b && b.registerDep(k, lt, w), !l.el) {
        const x = k.subTree = Kt(ce);
        G(null, x, m, g), l.placeholder = x.el;
      }
    } else
      lt(
        k,
    ...
    const v = m.component = l.component;
    if (dn(l, m, g))
    ...
    const k = () => {
      if (l.isMounted) {
        let { next: _, bu: $, u: j, parent: q, vnode: O } = l;
        {
          const St = dc(l);
          if (St) {
            _ && (_.el = O.el, Z(l, _, w)), St.asyncDep.then(() => {
              bt(() => {
                l.isUnmounted || f();
              }, b);
            });
        ...
        let U = _, Q;
        pe(l, !1), _ ? (_.el = O.el, Z(l, _, w)) : _ = O, $ && co($), (Q = _.props && _.props.onVnodeBeforeUpdate) && Et(Q, q, _, O), pe(l, !0);
        const ot = Ds(l), At = l.subTree;
        l.subTree = ot, A(
          At,
          ot,
          ...
          b,
          h
        ), _.el = ot.el, U === null && gn(l, ot.el), j && bt(j, b), (Q = _.props && _.props.onVnodeUpdated) && bt(
          () => Et(Q, q, _, O),
          b
        );
      } else {
        let _;
        const { el: $, props: j } = m, { bm: q, m: O, parent: U, root: Q, type: ot } = l, At = sr(m);
        pe(l, !1), q && co(q), !At && (_ = j && j.onVnodeBeforeMount) && Et(_, U, m), pe(l, !0);
        {
          Q.ce && Q.ce._hasShadowRoot() && Q.ce._injectChildStyle(
            ot,
            l.parent ? l.parent.type : void 0
          );
          const St = l.subTree = Ds(l);
          A(
            null,
            St,
            g,
        ...
        if (O && bt(O, b), !At && (_ = j && j.onVnodeMounted)) {
          const St = m;
          bt(
            () => Et(_, U, St),
            b
        ...
        (m.shapeFlag & 256 || U && sr(U.vnode) && U.vnode.shapeFlag & 256) && l.a && bt(l.a, b), l.isMounted = !0, m = g = v = null;
      }
    };
    l.scope.on();
    const x = l.effect = new Aa(k);
    l.scope.off();
    const f = l.update = x.run.bind(x), S = l.job = x.runIfDirty.bind(x);
    S.i = l, S.id = l.uid, x.scheduler = () => cs(S), pe(l, !0), f();
  }, Z = (l, m, g) => {
    m.component = l;
    const v = l.vnode.props;
    l.vnode = m, l.next = null, hn(l, m.props, v, g), xn(l, m.children, g), Wt(), As(l), Gt();
  }, R = (l, m, g, v, b, h, w, k, x = !1) => {
    const f = l && l.children, S = l ? l.shapeFlag : 0, _ = m.children, { patchFlag: $, shapeFlag: j } = m;
    if ($ > 0) {
      if ($ & 128) {
        $r(
          f,
    ...
    j & 8 ? (S & 16 && Ve(f, b, h), _ !== f && u(g, _)) : S & 16 ? j & 16 ? $r(
      f,
      _,
      g,
      v,
  ...
  }, le = (l, m, g, v, b, h, w, k, x) => {
    l = l || Ie, m = m || Ie;
    const f = l.length, S = m.length, _ = Math.min(f, S);
    let $;
    for ($ = 0; $ < _; $++) {
      const j = m[$] = x ? Ft(m[$]) : Dt(m[$]);
      A(
        l[$],
        j,
        g,
    ...
    let f = 0;
    const S = m.length;
    let _ = l.length - 1, $ = S - 1;
    for (; f <= _ && f <= $; ) {
      const j = l[f], q = m[f] = x ? Ft(m[f]) : Dt(m[f]);
      if (Ze(j, q))
        A(
          j,
          q,
    ...
    if (f > _) {
      ...
      const j = f, q = f, O = /* @__PURE__ */ new Map();
      for (f = q; f <= $; f++) {
        const yt = m[f] = x ? Ft(m[f]) : Dt(m[f]);
        yt.key != null && O.set(yt.key, f);
      }
      let U, Q = 0;
      const ot = $ - q + 1;
      let At = !1, St = 0;
      const We = new Array(ot);
      for (f = 0; f < ot; f++) We[f] = 0;
      for (f = j; f <= _; f++) {
        const yt = l[f];
        if (Q >= ot) {
          $t(yt, b, h, !0);
        ...
        if (yt.key != null)
          ...
          for (U = q; U <= $; U++)
            if (We[U - q] === 0 && Ze(yt, m[U])) {
              jt = U;
              break;
            }
        jt === void 0 ? $t(yt, b, h, !0) : (We[jt - q] = f + 1, jt >= St ? St = jt : At = !0, A(
          yt,
          m[jt],
          g,
          null,
      ...
      const xs = At ? _n(We) : Ie;
      for (U = xs.length - 1, f = ot - 1; f >= 0; f--) {
        const yt = q + f, jt = m[yt], ks = m[yt + 1], ws = yt + 1 < S ? (
        ...
        We[f] === 0 ? A(
          ...
          k,
          x
        ) : At && (U < 0 || f !== xs[U] ? ue(jt, g, ws, 2) : U--);
      }
    }
  }, ue = (l, m, g, v, b = null) => {
    const { el: h, type: w, transition: k, children: x, shapeFlag: f } = l;
    if (f & 6) {
      ue(l.component.subTree, m, g, v);
      return;
    }
    if (f & 128) {
      l.suspense.move(m, g, v);
      return;
    }
    if (f & 64) {
      w.move(l, m, g, Ke);
    ...
    if (v !== 2 && f & 1 && k)
      if (v === 0)
        k.beforeEnter(h), o(h, m, g), bt(() => k.enter(h), b);
      else {
        const { leave: _, delayLeave: $, afterLeave: j } = k, q = () => {
          l.ctx.isUnmounted ? s(h) : o(h, m, g);
        }, O = () => {
          h._isLeaving && h[Bi](
            !0
            /* cancelled */
    ...
    if (_ === -2 && (b = !1), k != null && (Wt(), or(k, null, g, l, !0), Gt()), j != null && (m.renderCache[j] = void 0), S & 256) {
      m.ctx.deactivate(l);
      return;
    }
    const O = S & 1 && $, U = !sr(l);
    let Q;
    if (U && (Q = w && w.onVnodeBeforeUnmount) && Et(Q, m, l), S & 6)
      Bc(l.component, g, v);
    else {
      if (S & 128) {
      ...
      O && me(l, null, m, "beforeUnmount"), S & 64 ? l.type.remove(
        l,
        m,
        g,
        Ke,
      ...
      (h !== It || _ > 0 && _ & 64) ? Ve(
        ...
        !1,
        !0
      ) : (h === It && _ & 384 || !b && S & 16) && Ve(x, m, g), v && vs(l);
    }
    const ot = q != null && j == null;
    (U && (Q = w && w.onVnodeUnmounted) || O || ot) && bt(() => {
      Q && Et(Q, m, l), O && me(l, null, m, "unmounted"), ot && (l.el = null);
    }, g);
  }, vs = (l) => {
    const { type: m, el: g, anchor: v, transition: b } = l;
    if (m === It) {
      Lc(g, v);
      return;
    }
    ...
    if (l.shapeFlag & 1 && b && !b.persisted) {
      const { leave: w, delayLeave: k } = b, x = () => w(g, h);
      k ? k(l.el, h, x) : x();
    } else
      h();
  }, Lc = (l, m) => {
    ...
    const { bum: v, scope: b, job: h, subTree: w, um: k, m: x, a: f } = l;
    Ls(x), Ls(f), v && co(v), b.stop(), h && (h.flags |= 8, $t(w, l, m, g)), k && bt(k, m), bt(() => {
      l.isUnmounted = !0;
    }, m);
  }, Ve = (l, m, g, v = !1, b = !1, h = 0) => {
    for (let w = h; w < l.length; w++)
      $t(l[w], m, g, v, b);
  }, Ar = (l) => {
    if (l.shapeFlag & 6)
      return Ar(l.component.subTree);
    if (l.shapeFlag & 128)
      return l.suspense.next();
    const m = y(l.anchor || l.el), g = m && m[qi];
    return g ? y(g) : m;
  };
  let so = !1;
  const ys = (l, m, g) => {
    let v;
    l == null ? m._vnode && ($t(m._vnode, null, null, !0), v = m._vnode.component) : A(
      m._vnode || null,
      l,
      m,
      null,
      ...
      null,
      g
    ), m._vnode = l, so || (so = !0, As(v), Fa(), so = !1);
  }, Ke = {
    p: A,
    um: $t,
    m: ue,
...
function pc(e, t, r = !1) {
  ...
  if (I(o) && I(s))
    for (let a = 0; a < o.length; a++) {
      const c = o[a];
      let i = s[a];
      i.shapeFlag & 1 && !i.dynamicChildren && ((i.patchFlag <= 0 || i.patchFlag === 32) && (i = s[a] = Ft(s[a]), i.el = c.el), !r && i.patchFlag !== -2 && pc(c, i)), i.type === Jr && (i.patchFlag === -1 && (i = s[a] = Ft(i)), i.el = c.el), i.type === ce && !i.el && (i.el = c.el);
    }
}
function _n(e) {
  const t = e.slice(), r = [0];
...
const It = /* @__PURE__ */ Symbol.for("v-fgt"), Jr = /* @__PURE__ */ Symbol.for("v-txt"), ce = /* @__PURE__ */ Symbol.for("v-cmt"), bo = /* @__PURE__ */ Symbol.for("v-stc"), cr = [];
let xt = null;
function te(e = !1) {
  cr.push(xt = e ? null : []);
}
...
let gr = 1;
function Bs(e, t = !1) {
  gr += e, e < 0 && xt && t && (xt.hasOnce = !0);
}
function hc(e) {
  return e.dynamicChildren = gr > 0 ? xt || Ie : null, $n(), gr > 0 && xt && xt.push(e), e;
}
function de(e, t, r, o, s, a) {
  return hc(
    pt(
      e,
      t,
...
const vc = ({ key: e }) => e ?? null, Ir = ({
  ref: e,
  ref_key: t,
  ref_for: r
}) => (typeof e == "number" && (e = "" + e), e != null ? tt(e) || /* @__PURE__ */ it(e) || D(e) ? { i: qt, r: e, k: t, f: !!r } : e : null);
function pt(e, t = null, r = null, o = 0, s = null, a = e === It ? 0 : 1, c = !1, i = !1) {
  const n = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
  ...
  return i ? (ms(n, r), a & 128 && e.normalize(n)) : r && (n.shapeFlag |= tt(r) ? 8 : 16), gr > 0 && // avoid a block node from tracking itself
  ...
  n.patchFlag !== 32 && xt.push(n), n;
}
const Kt = Sn;
function Sn(e, t = null, r = null, o = 0, s = null, a = !1) {
  if ((!e || e === Yi) && (e = ce), fc(e)) {
    const i = Me(
      e,
      t,
    ...
    return r && ms(i, r), gr > 0 && !a && xt && (i.shapeFlag & 6 ? xt[xt.indexOf(e)] = i : xt.push(i)), i.patchFlag = -2, i;
  }
  if (Rn(e) && (e = e.__vccOpts), t) {
    t = jn(t);
    let { class: i, style: n } = t;
    i && !tt(i) && (t.class = Xo(i)), M(n) && (/* @__PURE__ */ as(n) && !I(n) && (n = at({}, n)), t.style = Zo(n));
  }
  const c = tt(e) ? 1 : bc(e) ? 128 : Li(e) ? 64 : M(e) ? 4 : D(e) ? 2 : 0;
  return pt(
    e,
    t,
    r,
...
function jn(e) {
  return e ? /* @__PURE__ */ as(e) || cc(e) ? at({}, e) : e : null;
}
function Me(e, t, r = !1, o = !1) {
  const { props: s, ref: a, patchFlag: c, children: i, transition: n } = e, p = t ? Hn(s || {}, t) : s, u = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e.type,
    props: p,
    ...
    ref: t && t.ref ? (
      ...
      r && a ? I(a) ? a.concat(Ir(t)) : [a, Ir(t)] : Ir(t)
    ) : a,
    scopeId: e.scopeId,
    ...
    // fast paths only.
    patchFlag: t && e.type !== It ? c === -1 ? 16 : c | 16 : c,
...
function En(e = " ", t = 0) {
  return Kt(Jr, null, e, t);
}
function Tn(e = "", t = !1) {
  return t ? (te(), An(ce, null, e)) : Kt(ce, null, e);
}
function Dt(e) {
  return e == null || typeof e == "boolean" ? Kt(ce) : I(e) ? Kt(
    It,
    null,
    // #3666, avoid reference pollution when reusing vnode
    e.slice()
  ) : fc(e) ? Ft(e) : Kt(Jr, null, String(e));
}
function Ft(e) {
...
function ms(e, t) {
  ...
  if (t == null)
    ...
    if (o & 65) {
      ...
      r = 32;
      const s = t._;
      !s && !cc(t) ? t._ctx = qt : s === 3 && qt && (qt.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
  else D(t) ? (t = { default: t, _ctx: qt }, r = 32) : (t = String(t), o & 64 ? (r = 16, t = [En(t)]) : r = 8);
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    for (const s in o)
      if (s === "class")
        ...
        const a = t[s], c = o[s];
        c && a !== c && !(I(a) && a.includes(c)) ? t[s] = a ? [].concat(a, c) : c : c == null && a == null && // mergeProps({ 'onUpdate:modelValue': undefined }) should not retain
        // the model listener.
        !Vr(s) && (t[s] = c);
      } else s !== "" && (t[s] = o[s]);
  }
...
let Dn = 0;
function Pn(e, t, r) {
  const o = e.type, s = (t ? t.appContext : e.appContext) || In, a = {
    uid: Dn++,
    vnode: e,
    type: o,
    parent: t,
  ...
  return a.ctx = { _: a }, a.root = t ? t.root : a, a.emit = ln.bind(null, a), e.ce && e.ce(a), a;
}
let gt = null;
const qn = () => gt || qt;
let Rr, Po;
...
const xr = (e) => {
  ...
  gt && gt.scope.off(), Rr(null);
};
function yc(e) {
  return e.vnode.shapeFlag & 4;
}
let br = !1;
function Ln(e, t = !1, r = !1) {
  t && Po(t);
  const { props: o, children: s } = e.vnode, a = yc(e);
  bn(e, o, a, t), yn(e, s, r || t);
  const c = a ? Bn(e, t) : void 0;
  return t && Po(!1), c;
}
function Bn(e, t) {
  const r = e.type;
  ...
  if (o) {
    Wt();
    const s = e.setupContext = o.length > 1 ? On(e) : null, a = xr(e), c = yr(
      o,
      e,
      0,
      [
...
function Os(e, t, r) {
  D(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : M(t) && (e.setupState = Ra(t)), xc(e);
}
function xc(e, t, r) {
  const o = e.type;
  e.render || (e.render = o.render || Bt);
  {
    const s = xr(e);
    Wt();
    try {
...
function ps(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(Ra(yi(e.exposed)), {
    get(t, r) {
      if (r in t)
        return t[r];
      if (r in ar)
...
const Un = (e, t) => /* @__PURE__ */ _i(e, t, br), Nn = "3.5.32";
/**
...
if (Rs)
  try {
    qo = /* @__PURE__ */ Rs.createPolicy("vue", {
      createHTML: (e) => e
    });
  } catch {
  }
const kc = qo ? (e) => qo.createHTML(e) : (e) => e, Fn = "http://www.w3.org/2000/svg", Vn = "http://www.w3.org/1998/Math/MathML", Nt = typeof document < "u" ? document : null, Us = Nt && /* @__PURE__ */ Nt.createElement("template"), Kn = {
  insert: (e, t, r) => {
  ...
  createElement: (e, t, r, o) => {
    const s = t === "svg" ? Nt.createElementNS(Fn, e) : t === "mathml" ? Nt.createElementNS(Vn, e) : r ? Nt.createElement(e, { is: r }) : Nt.createElement(e);
...
const Ns = /* @__PURE__ */ Symbol("_vod"), Zn = /* @__PURE__ */ Symbol("_vsh"), Xn = /* @__PURE__ */ Symbol(""), Yn = /(?:^|;)\s*display\s*:/;
function Jn(e, t, r) {
  const o = e.style, s = tt(r);
  let a = !1;
  if (r && !s) {
    if (t)
      if (tt(t))
        ...
        for (const c in t)
          r[c] == null && Dr(o, c, "");
    for (const c in r)
      c === "display" && (a = !0), Dr(o, c, r[c]);
  } else if (s) {
    if (t !== r) {
      const c = o[Xn];
      c && (r += ";" + c), o.cssText = r, a = Yn.test(r);
    }
  } else t && e.removeAttribute("style");
  Ns in e && (e[Ns] = a ? o.display : "", e[Zn] && (o.display = "none"));
}
const Fs = /\s*!important$/;
function Dr(e, t, r) {
  if (I(r))
    r.forEach((o) => Dr(e, t, o));
...
function Ws(e, t, r, o, s, a = Xc(t)) {
  o && t.startsWith("xlink:") ? r == null ? e.removeAttributeNS(Ks, t.slice(6, t.length)) : e.setAttributeNS(Ks, t, r) : r == null || a && !_a(r) ? e.removeAttribute(t) : e.setAttribute(
    t,
    a ? "" : Mt(r) ? String(r) : r
  );
}
function Gs(e, t, r, o, s) {
  ...
  if (r === "" || r == null) {
    const i = typeof e[t];
    i === "boolean" ? r = _a(r) : r == null && i === "string" ? (r = "", c = !0) : i === "number" && (r = 0, c = !0);
  }
  try {
    e[t] = r;
  } catch {
...
let fo = 0;
const sl = /* @__PURE__ */ Promise.resolve(), al = () => fo || (sl.then(() => fo = 0), fo = Date.now());
function cl(e, t) {
  const r = (o) => {
    if (!o._vts)
      o._vts = Date.now();
  ...
  return r.value = e, r.attached = al(), r;
}
function il(e, t) {
  if (I(t)) {
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, nl = (e, t, r, o, s, a) => {
  const c = s === "svg";
  t === "class" ? Gn(e, o, c) : t === "style" ? Jn(e, r, o) : Fr(t) ? Vr(t) || rl(e, t, r, o, a) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : ll(e, t, o, c)) ? (Gs(e, t, o), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && Ws(e, t, o, c, a, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && // #12408 check if it's declared prop or it's async custom element
  (ul(e, t) || // @ts-expect-error _def is private
  e._def.__asyncLoader && (/[A-Z]/.test(t) || !tt(o))) ? Gs(e, wt(t), o, a, t) : (t === "true-value" ? e._trueValue = o : t === "false-value" && (e._falseValue = o), Ws(e, t, o, c));
};
function ll(e, t, r, o) {
  if (o)
    return !!(t === "innerHTML" || t === "textContent" || t in e && Ys(t) && D(r));
...
function ul(e, t) {
  ...
  if (!r)
    return !1;
  const o = wt(t);
  return Array.isArray(r) ? r.some((s) => wt(s) === o) : Object.keys(r).some((s) => wt(s) === o);
}
const ml = ["ctrl", "shift", "alt", "meta"], pl = {
  ...
  exact: (e, t) => ml.some((r) => e[`${r}Key`] && !t.includes(r))
}, dl = (e, t) => {
  if (!e) return e;
...
}, gl = /* @__PURE__ */ at({ patchProp: nl }, Kn);
let Js;
function bl() {
  return Js || (Js = kn(gl));
}
const hl = ((...e) => {
  ...
  return t.mount = (o) => {
    ...
    !D(a) && !a.render && !a.template && (a.template = s.innerHTML), s.nodeType === 1 && (s.textContent = "");
    const c = r(s, !1, fl(s));
...
const yl = "todo-app-list", xl = "todo-app-create", kl = "todo-app-delete", wl = (e) => `eq.${e}`, zl = "spectrum", _l = "light", Cl = "medium", $l = 140, Qs = (e) => Array.isArray(e) && e.every(
  (t) => typeof t == "object" && t !== null && "id" in t && "title" in t
), Al = (e) => typeof e == "object" && e !== null && "id" in e && "title" in e, Sl = (e) => {
  const t = /* @__PURE__ */ He([]), r = /* @__PURE__ */ He(!1), o = /* @__PURE__ */ He(!1), s = /* @__PURE__ */ He(null), a = { current: !1 }, c = (u) => u instanceof Error ? u.message : "Something went wrong. Please try again.", i = async () => {
    r.value = !0, s.value = null;
    try {
      const u = await e.connectors.execute({
        permalink: yl,
        method: "GET"
      });
      t.value = Qs(u) ? u : [];
    ...
    const d = u.trim();
    if (d && !a.current) {
      a.current = !0, o.value = !0, s.value = null;
      try {
        const y = await e.connectors.execute({
          permalink: xl,
          method: "POST",
          payload: { title: d }
        });
        Qs(y) && y.length > 0 ? t.value = [y[0], ...t.value] : Al(y) ? t.value = [y, ...t.value] : await i();
      } catch (y) {
        s.value = c(y);
      } finally {
        o.value = !1, a.current = !1;
      }
    }
  }, p = async (u) => {
    const d = t.value;
    t.value = t.value.filter((y) => y.id !== u), s.value = null;
    try {
      ...
      t.value = d, s.value = c(y);
    }
  };
  return Ja(i), { todos: t, loading: r, saving: o, error: s, load: i, add: n, remove: p };
}, jl = ["system", "color", "scale"], El = ["aria-label"], Tl = { class: "todo-header" }, Hl = { class: "todo-title" }, Il = { class: "todo-meta" }, Dl = { class: "todo-form-row" }, Pl = ["value", "maxlength", "disabled"], ql = ["disabled"], Ll = {
  key: 0,
  open: "",
  variant: "negative",
  class: "todo-toast"
  ...
  key: 2,
  class: "todo-list"
}, Ol = { class: "todo-item-text" }, Rl = ["aria-label", "onClick"], Ul = {
  key: 3,
  class: "todo-empty"
}, Nl = /* @__PURE__ */ Mi({
  __name: "App",
  ...
  setup(e) {
    const t = /* @__PURE__ */ He(e.sdk.getProps()), r = e.sdk.on("propsChanged", (z) => t.value = z);
    ns(r);
    const { todos: o, loading: s, saving: a, error: c, add: i, remove: n } = Sl(e.connectors), p = /* @__PURE__ */ He(""), u = (z) => {
      const E = z.target;
      if (!E || typeof E != "object" || !("value" in E)) return;
      const A = E.value;
      p.value = typeof A == "string" ? A : "";
    }, d = async () => {
      !p.value.trim() || a.value || (await i(p.value), p.value = "");
    }, y = (z) => {
      z.key === "Enter" && (z.preventDefault(), d());
    };
    return (z, E) => (te(), de("sp-theme", {
      system: st(zl),
      color: st(_l),
      scale: st(Cl),
      class: "todo-theme"
      ...
      pt("section", {
        ...
        pt("header", Tl, [
          pt("h2", Hl, he(t.value.title), 1),
          pt("p", Il, he(st(o).length) + " " + he(st(o).length === 1 ? "item" : "items"), 1)
        ]),
        pt("form", {
          class: "todo-form",
          onSubmit: dl(d, ["prevent"])
        }, [
          E[0] || (E[0] = pt("sp-field-label", {
            for: "todo-input",
            size: "m"
          }, "New todo", -1)),
          pt("div", Dl, [
            ...
            pt("sp-button", {
              variant: "accent",
              type: "submit",
              disabled: st(a) || !p.value.trim()
            }, he(st(a) ? "Adding…" : "Add"), 9, ql)
          ])
        ], 32),
        st(c) ? (te(), de("sp-toast", Ll, he(st(c)), 1)) : Tn("", !0),
        st(s) && st(o).length === 0 ? (te(), de("div", Bl, [...E[1] || (E[1] = [
          pt("sp-progress-circle", {
            indeterminate: "",
            size: "m",
            label: "Loading todos"
          }, null, -1)
        ])])) : st(o).length > 0 ? (te(), de("ul", Ml, [
          (te(!0), de(It, null, Ji(st(o), (A) => (te(), de("li", {
            key: A.id,
            class: "todo-item"
          }, [
            pt("span", Ol, he(A.title), 1),
            pt("sp-action-button", {
              quiet: "",
              "aria-label": `Delete ${A.title}`,
              onClick: (J) => st(n)(A.id)
            }, [...E[2] || (E[2] = [
              pt("sp-icon-delete", { slot: "icon" }, null, -1)
            ])], 8, Rl)
          ]))), 128))
        ])) : (te(), de("p", Ul, "No todos yet. Add your first one above."))
      ], 8, El)
    ], 8, jl));
  }
}), wc = "1.11.2", Fl = ["spectrum", "express", "spectrum-two"], Vl = ["medium", "large", "medium-express", "large-express", "medium-spectrum-two", "large-spectrum-two"], Kl = ["light", "lightest", "dark", "darkest", "light-express", "lightest-express", "dark-express", "darkest-express", "light-spectrum-two", "lightest-spectrum-two", "dark-spectrum-two", "darkest-spectrum-two"], Je = class mt extends HTMLElement {
  constructor() {
    ...
    const t = document.importNode(mt.template.content, !0);
  ...
  get styles() {
    const t = [...mt.themeFragmentsByKind.keys()], r = (s, a, c) => {
      ...
      const c = mt.themeFragmentsByKind.get(a);
      let i;
    ...
    return mt.themeFragmentsByKind, this.system, this.color, this.scale, [...o];
  }
  static get template() {
  ...
  connectedCallback() {
    if (this.shouldAdoptStyles(), mt.instances.add(this), !this.hasAttribute("dir")) {
      let t = this.assignedSlot || this.parentNode;
      for (; t !== document.documentElement && !(t instanceof mt); ) t = t.assignedSlot || t.parentNode || t.host;
      this.dir = t.dir === "rtl" ? t.dir : "ltr";
    }
  }
  disconnectedCallback() {
    mt.instances.delete(this);
  }
  ...
  static registerThemeFragment(t, r, o) {
    const s = mt.themeFragmentsByKind.get(r) || /* @__PURE__ */ new Map();
    s.size === 0 && (mt.themeFragmentsByKind.set(r, s), s.set("default", { name: t, styles: o }), mt.defaultFragments.add(t)), s.set(t, { name: t, styles: o }), mt.instances.forEach((a) => a.shouldAdoptStyles());
  }
  _provideContext() {
...
Je.themeFragmentsByKind = /* @__PURE__ */ new Map(), Je.defaultFragments = /* @__PURE__ */ new Set(["spectrum"]), Je.instances = /* @__PURE__ */ new Set(), Je.VERSION = wc;
let Qr = Je;
customElements.define("sp-theme", Qr);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Pr = globalThis, ds = Pr.ShadowRoot && (Pr.ShadyCSS === void 0 || Pr.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, gs = Symbol(), ta = /* @__PURE__ */ new WeakMap();
let zc = class {
  constructor(t, r, o) {
    if (this._$cssResult$ = !0, o !== gs) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
...
const Wl = (e) => new zc(typeof e == "string" ? e : e + "", void 0, gs), nt = (e, ...t) => {
  ...
  return new zc(r, e, gs);
}, Gl = (e, t) => {
  if (ds) e.adoptedStyleSheets = t.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet);
  else for (const r of t) {
    const o = document.createElement("style"), s = Pr.litNonce;
    s !== void 0 && o.setAttribute("nonce", s), o.textContent = r.cssText, e.appendChild(o);
  }
}, ea = ds ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Zl, defineProperty: Xl, getOwnPropertyDescriptor: Yl, getOwnPropertyNames: Jl, getOwnPropertySymbols: Ql, getPrototypeOf: tu } = Object, ae = globalThis, ra = ae.trustedTypes, eu = ra ? ra.emptyScript : "", vo = ae.reactiveElementPolyfillSupport, ir = (e, t) => e, Ur = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? eu : null;
      break;
  ...
  return r;
} }, bs = (e, t) => !Zl(e, t), oa = { attribute: !0, type: String, converter: Ur, reflect: !1, useDefault: !1, hasChanged: bs };
...
let Te = class extends HTMLElement {
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? oa;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(ir("properties"))) {
      const r = this.properties, o = [...Jl(r), ...Ql(r)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const s of o) r.unshift(ea(s));
    } else t !== void 0 && r.push(ea(t));
    return r;
  }
  static _$Eu(t, r) {
    const o = r.attribute;
  ...
  _$ET(t, r) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const c = (((a = o.converter) == null ? void 0 : a.toAttribute) !== void 0 ? o.converter : Ur).toAttribute(r, o.type);
  ...
  _$AK(t, r) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const i = o.getPropertyOptions(s), n = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((a = i.converter) == null ? void 0 : a.fromAttribute) !== void 0 ? i.converter : Ur;
      this._$Em = s;
  ...
  requestUpdate(t, r, o, s = !1, a) {
    ...
    if (t !== void 0) {
      ...
      if (s === !1 && (a = this[t]), o ?? (o = i.getPropertyOptions(t)), !((o.hasChanged ?? bs)(a, r) || o.useDefault && o.reflect && a === ((c = this._$Ej) == null ? void 0 : c.get(t)) && !this.hasAttribute(i._$Eu(t, o)))) return;
      this.C(t, r, o);
    }
...
Te.elementStyles = [], Te.shadowRootOptions = { mode: "open" }, Te[ir("elementProperties")] = /* @__PURE__ */ new Map(), Te[ir("finalized")] = /* @__PURE__ */ new Map(), vo == null || vo({ ReactiveElement: Te }), (ae.reactiveElementVersions ?? (ae.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const nr = globalThis, sa = (e) => e, Nr = nr.trustedTypes, aa = Nr ? Nr.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, _c = "$lit$", se = `lit$${Math.random().toFixed(9).slice(2)}$`, Cc = "?" + se, ru = `<${Cc}>`, ze = document, hr = () => ze.createComment(""), fr = (e) => e === null || typeof e != "object" && typeof e != "function", hs = Array.isArray, ou = (e) => hs(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", yo = `[ 	
\f\r]`, Xe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ca = /-->/g, ia = />/g, ge = RegExp(`>|${yo}(?:([^\\s"'>=/]+)(${yo}*=${yo}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), na = /'/g, la = /"/g, $c = /^(?:script|style|textarea|title)$/i, su = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), H = su(1), Lt = Symbol.for("lit-noChange"), W = Symbol.for("lit-nothing"), ua = /* @__PURE__ */ new WeakMap(), ye = ze.createTreeWalker(ze, 129);
function Ac(e, t) {
  if (!hs(e) || !e.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return aa !== void 0 ? aa.createHTML(t) : t;
}
const au = (e, t) => {
  const r = e.length - 1, o = [];
  let s, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", c = Xe;
  for (let i = 0; i < r; i++) {
    const n = e[i];
    let p, u, d = -1, y = 0;
    for (; y < n.length && (c.lastIndex = y, u = c.exec(n), u !== null); ) y = c.lastIndex, c === Xe ? u[1] === "!--" ? c = ca : u[1] !== void 0 ? c = ia : u[2] !== void 0 ? ($c.test(u[2]) && (s = RegExp("</" + u[2], "g")), c = ge) : u[3] !== void 0 && (c = ge) : c === ge ? u[0] === ">" ? (c = s ?? Xe, d = -1) : u[1] === void 0 ? d = -2 : (d = c.lastIndex - u[2].length, p = u[1], c = u[3] === void 0 ? ge : u[3] === '"' ? la : na) : c === la || c === na ? c = ge : c === ca || c === ia ? c = Xe : (c = ge, s = void 0);
    const z = c === ge && e[i + 1].startsWith("/>") ? " " : "";
    a += c === Xe ? n + ru : d >= 0 ? (o.push(p), n.slice(0, d) + _c + n.slice(d) + se + z) : n + se + (d === -2 ? i : z);
  }
  return [Ac(e, a + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
let Lo = class Sc {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let a = 0, c = 0;
    const i = t.length - 1, n = this.parts, [p, u] = au(t, r);
    if (this.el = Sc.createElement(p, o), ye.currentNode = this.el.content, r === 2 || r === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (s = ye.nextNode()) !== null && n.length < i; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(_c)) {
          const y = u[c++], z = s.getAttribute(d).split(se), E = /([.?@])?(.*)/.exec(y);
          n.push({ type: 1, index: a, name: E[2], strings: z, ctor: E[1] === "." ? iu : E[1] === "?" ? nu : E[1] === "@" ? lu : to }), s.removeAttribute(d);
        } else d.startsWith(se) && (n.push({ type: 6, index: a }), s.removeAttribute(d));
        if ($c.test(s.tagName)) {
          const d = s.textContent.split(se), y = d.length - 1;
          if (y > 0) {
            s.textContent = Nr ? Nr.emptyScript : "";
            for (let z = 0; z < y; z++) s.append(d[z], hr()), ye.nextNode(), n.push({ type: 2, index: ++a });
            s.append(d[y], hr());
          }
        }
      } else if (s.nodeType === 8) if (s.data === Cc) n.push({ type: 2, index: a });
      else {
        let d = -1;
        for (; (d = s.data.indexOf(se, d + 1)) !== -1; ) n.push({ type: 7, index: a }), d += se.length - 1;
      }
      a++;
    }
  }
  static createElement(t, r) {
    const o = ze.createElement("template");
    return o.innerHTML = t, o;
  }
};
function Oe(e, t, r = e, o) {
  var c, i;
  if (t === Lt) return t;
  let s = o !== void 0 ? (c = r._$Co) == null ? void 0 : c[o] : r._$Cl;
  const a = fr(t) ? void 0 : t._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== a && ((i = s == null ? void 0 : s._$AO) == null || i.call(s, !1), a === void 0 ? s = void 0 : (s = new a(e), s._$AT(e, r, o)), o !== void 0 ? (r._$Co ?? (r._$Co = []))[o] = s : r._$Cl = s), s !== void 0 && (t = Oe(e, s._$AS(e, t.values), s, o)), t;
}
let cu = class {
  constructor(t, r) {
  ...
  u(t) {
    const { el: { content: r }, parts: o } = this._$AD, s = ((t == null ? void 0 : t.creationScope) ?? ze).importNode(r, !0);
    ye.currentNode = s;
    let a = ye.nextNode(), c = 0, i = 0, n = o[0];
    for (; n !== void 0; ) {
      if (c === n.index) {
        let p;
        n.type === 2 ? p = new kr(a, a.nextSibling, this, t) : n.type === 1 ? p = new n.ctor(a, n.name, n.strings, this, t) : n.type === 6 && (p = new uu(a, this, t)), this._$AV.push(p), n = o[++i];
      }
      c !== (n == null ? void 0 : n.index) && (a = ye.nextNode(), c++);
    }
    return ye.currentNode = ze, s;
  }
  p(t) {
    let r = 0;
...
class kr {
  ...
  constructor(t, r, o, s) {
    this.type = 2, this._$AH = W, this._$AN = void 0, this._$AA = t, this._$AB = r, this._$AM = o, this.options = s, this._$Cv = (s == null ? void 0 : s.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, r = this) {
    t = Oe(this, t, r), fr(t) ? t === W || t == null || t === "" ? (this._$AH !== W && this._$AR(), this._$AH = W) : t !== this._$AH && t !== Lt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : ou(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== W && fr(this._$AH) ? this._$AA.nextSibling.data = t : this.T(ze.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var a;
    const { values: r, _$litType$: o } = t, s = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = Lo.createElement(Ac(o.h, o.h[0]), this.options)), o);
    if (((a = this._$AH) == null ? void 0 : a._$AD) === s) this._$AH.p(r);
    else {
      const c = new cu(s, this), i = c.u(this.options);
      c.p(r), this.T(i), this._$AH = c;
    }
  }
  _$AC(t) {
    let r = ua.get(t.strings);
    return r === void 0 && ua.set(t.strings, r = new Lo(t)), r;
  }
  k(t) {
    hs(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let o, s = 0;
    for (const a of t) s === r.length ? r.push(o = new kr(this.O(hr()), this.O(hr()), this, this.options)) : o = r[s], o._$AI(a), s++;
    s < r.length && (this._$AR(o && o._$AB.nextSibling, s), r.length = s);
  }
  _$AR(t = this._$AA.nextSibling, r) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, r); t !== this._$AB; ) {
      const s = sa(t).nextSibling;
      sa(t).remove(), t = s;
    }
  }
  setConnected(t) {
...
class to {
  ...
  constructor(t, r, o, s, a) {
    this.type = 1, this._$AH = W, this._$AN = void 0, this.element = t, this.name = r, this._$AM = s, this.options = a, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = W;
  }
  _$AI(t, r = this, o, s) {
    const a = this.strings;
    let c = !1;
    if (a === void 0) t = Oe(this, t, r, 0), c = !fr(t) || t !== this._$AH && t !== Lt, c && (this._$AH = t);
    else {
      const i = t;
      let n, p;
      for (t = a[0], n = 0; n < a.length - 1; n++) p = Oe(this, i[o + n], r, n), p === Lt && (p = this._$AH[n]), c || (c = !fr(p) || p !== this._$AH[n]), p === W ? t = W : t !== W && (t += (p ?? "") + a[n + 1]), this._$AH[n] = p;
    }
    c && !s && this.j(t);
  }
  j(t) {
...
class lu extends to {
  ...
  _$AI(t, r = this) {
    if ((t = Oe(this, t, r, 0) ?? W) === Lt) return;
    const o = this._$AH, s = t === W && o !== W || t.capture !== o.capture || t.once !== o.once || t.passive !== o.passive, a = t !== W && (o === W || s);
...
const xo = nr.litHtmlPolyfillSupport;
xo == null || xo(Lo, kr), (nr.litHtmlVersions ?? (nr.litHtmlVersions = [])).push("3.3.2");
const mu = (e, t, r) => {
  const o = (r == null ? void 0 : r.renderBefore) ?? t;
  let s = o._$litPart$;
  if (s === void 0) {
    const a = (r == null ? void 0 : r.renderBefore) ?? null;
    o._$litPart$ = s = new kr(t.insertBefore(hr(), a), a, void 0, r ?? {});
  }
  return s._$AI(e), s;
};
/**
...
let lr = class extends Te {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = mu(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
    var t;
...
var ha;
lr._$litElement$ = !0, lr.finalized = !0, (ha = we.litElementHydrateSupport) == null || ha.call(we, { LitElement: lr });
const ko = we.litElementPolyfillSupport;
ko == null || ko({ LitElement: lr });
(we.litElementVersions ?? (we.litElementVersions = [])).push("4.2.2");
const Bo = /* @__PURE__ */ new Set(), pu = () => {
  const e = document.documentElement.dir === "rtl" ? document.documentElement.dir : "ltr";
  Bo.forEach((t) => {
    t.setAttribute("dir", e);
  });
}, du = new MutationObserver(pu);
du.observe(document.documentElement, {
  attributes: !0,
  attributeFilter: ["dir"]
});
const gu = (e) => typeof e.startManagingContentDirection < "u" || e.tagName === "SP-THEME";
function bu(e) {
  class t extends e {
    /**
     * @internal
    ...
    connectedCallback() {
      if (!this.hasAttribute("dir")) {
        ...
        for (; o !== document.documentElement && !gu(
          o
        ); )
    ...
    disconnectedCallback() {
      super.disconnectedCallback(), this._dirParent && (this._dirParent === document.documentElement ? Bo.delete(this) : this._dirParent.stopManagingContentDirection(
        this
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const hu = { attribute: !0, type: String, converter: Ur, reflect: !1, hasChanged: bs }, fu = (e = hu, t, r) => {
...
function C(e) {
  return (t, r) => typeof r == "object" ? fu(e, t, r) : ((o, s, a) => {
...
var yu = Object.defineProperty, xu = Object.getOwnPropertyDescriptor, ku = (e, t, r, o) => {
  for (var s = xu(t, r), a = e.length - 1, c; a >= 0; a--)
    (c = e[a]) && (s = c(t, r, s) || s);
  return s && yu(t, r, s), s;
};
function Ue(e, {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ae = { ATTRIBUTE: 1, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4 }, Cu = (e) => (...t) => ({ _$litDirective$: e, values: t });
let $u = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Au = (e) => e.strings === void 0, Su = {}, ju = (e, t = Su) => e._$AH = t;
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Eu = Cu(class extends $u {
  constructor(e) {
    ...
    if (!Au(e)) throw Error("`live` bindings can only contain a single expression");
  }
  render(e) {
    return e;
  }
  update(e, [t]) {
    if (t === Lt || t === W) return t;
    const r = e.element, o = e.name;
    if (e.type === Ae.PROPERTY) {
      if (t === r[o]) return Lt;
    } else if (e.type === Ae.BOOLEAN_ATTRIBUTE) {
      if (!!t === r.hasAttribute(o)) return Lt;
    } else if (e.type === Ae.ATTRIBUTE && r.getAttribute(o) === t + "") return Lt;
    return ju(e), t;
  }
});
var Tu = Object.defineProperty, Se = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && Tu(t, r, s), s;
};
function Hu(e) {
  class t extends e {
    renderAnchor({ id: o, className: s, ariaHidden: a, labelledby: c, tabindex: i, anchorContent: n = H`<slot></slot>` }) {
      return H`<a
                    id=${o}
                    class=${K(s)}
                    href=${K(this.href)}
                    ...
                    aria-labelledby=${K(c)}
                    aria-hidden=${K(a ? "true" : void 0)}
                    tabindex=${K(i)}
                    referrerpolicy=${K(this.referrerpolicy)}
                    rel=${K(this.rel)}
                >${n}</a>`;
    }
  }
  return Se([C()], t.prototype, "download"), Se([C()], t.prototype, "label"), Se([C()], t.prototype, "href"), Se([C()], t.prototype, "target"), Se([C()], t.prototype, "referrerpolicy"), Se([C()], t.prototype, "rel"), t;
}
let Oo = !0;
try {
  document.body.querySelector(":focus-visible");
} catch {
  Oo = !1, import("./focus-visible-D25pRc1b.js").then((t) => t.f);
}
const Ec = (e) => {
  var t, r;
  const o = (c) => {
  ...
  class a extends (r = e, t = s, r) {
    ...
    connectedCallback() {
      super.connectedCallback && super.connectedCallback(), Oo || requestAnimationFrame(() => {
        this[s] == null && (this[s] = o(this));
      });
    }
    disconnectedCallback() {
      super.disconnectedCallback && super.disconnectedCallback(), Oo || requestAnimationFrame(() => {
...
var Iu = Object.defineProperty, Du = Object.getOwnPropertyDescriptor, wo = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? Du(t, r) : t, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = (o ? c(t, r, s) : c(s)) || s);
  return o && s && Iu(t, r, s), s;
};
function ma() {
  return new Promise((e) => requestAnimationFrame(() => e()));
}
class ur extends Ec(Re) {
  constructor() {
...
wo([C({ type: Boolean, reflect: !0 })], ur.prototype, "disabled", 2), wo([C({ type: Boolean })], ur.prototype, "autofocus", 2), wo([C({ type: Number })], ur.prototype, "tabIndex", 1);
let Pu = class {
...
var qu = Object.defineProperty, pa = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--)
    (c = e[a]) && (s = c(t, r, s) || s);
  return s && qu(t, r, s), s;
};
const zo = Symbol("assignedNodes");
function Lu(e, t, r = []) {
  var o, s;
  const a = (i) => (n) => i.matches(n);
  class c extends (s = e, o = zo, s) {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    constructor(...n) {
      super(...n), this.slotHasContent = !1, new Pu(this, {
        config: {
          characterData: !0,
          subtree: !0
        },
      ...
      if (!this.hasUpdated) {
        const { childNodes: p } = this, u = [...p].filter((d) => {
          ...
          return y.tagName ? r.some(
            ...
            !y.hasAttribute("slot")
          ) : y.textContent ? y.textContent.trim() : !1;
        });
...
`;
var Mu = Object.defineProperty, _o = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && Mu(t, r, s), s;
};
class Le extends Lu(Hu(ur), "", ["sp-overlay,sp-tooltip"]) {
  constructor() {
...
_o([C({ type: Boolean, reflect: !0 })], Le.prototype, "active"), _o([C({ type: String })], Le.prototype, "type"), _o([eo(".anchor")], Le.prototype, "anchorElement");
const Ou = nt`
...
var Nu = Object.defineProperty, wr = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--)
    (c = e[a]) && (s = c(t, r, s) || s);
  return s && Nu(t, r, s), s;
};
let Ne = class extends Ue(Re, {
  validSizes: Uu
}) {
  constructor() {
  ...
  handleSlotchange() {
    const t = Ru(this.label, this.slotEl);
    t && (this.label = t);
  }
  firstUpdated(t) {
...
], Ne.prototype, "staticColor");
wr([
  C({ type: Boolean, reflect: !0 })
], Ne.prototype, "indeterminate");
wr([
  C({ type: String })
], Ne.prototype, "label");
wr([
  C({ type: Number })
], Ne.prototype, "progress");
wr([
  eo("slot")
], Ne.prototype, "slotEl");
const Fu = nt`
...
`;
var Vu = Object.defineProperty, Ku = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && Vu(t, r, s), s;
};
class Ro extends Ne {
...
Ro.STATIC_COLORS = Tc, Ku([C({ type: String, reflect: !0, attribute: "static-color" })], Ro.prototype, "staticColor");
rt("sp-progress-circle", Ro);
class Wu {
  constructor(t) {
    this.cachedAriaLabel = null, this.host = t, this.host.addController(this);
  }
  renderPendingState() {
    return this.host.pending ? H`
                  <sp-progress-circle
                      id="loader"
                      size="s"
                      indeterminate
...
var Gu = Object.defineProperty, Zu = Object.getOwnPropertyDescriptor, be = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? Zu(t, r) : t, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = (o ? c(t, r, s) : c(s)) || s);
  return o && s && Gu(t, r, s), s;
};
const Xu = ["accent", "primary", "secondary", "negative", "white", "black"];
class ee extends Ue(Le, { noDefaultSize: !0 }) {
  constructor() {
    super(), this.pendingLabel = "Pending", this.pending = !1, this._variant = "accent", this.treatment = "fill", this.noWrap = !1, this.pendingStateController = new Wu(this);
  }
  static get styles() {
    return [...super.styles, Ou];
  }
  click() {
    ...
    if (t !== this.variant) {
      switch (this.requestUpdate("variant", this.variant), t) {
        ...
        case null:
          return;
        default:
          Xu.includes(t) ? this._variant = t : this._variant = "accent";
          break;
      }
...
be([C({ type: String, attribute: "pending-label" })], ee.prototype, "pendingLabel", 2), be([C({ type: Boolean, reflect: !0, attribute: !0 })], ee.prototype, "pending", 2), be([C()], ee.prototype, "variant", 1), be([C({ reflect: !0, attribute: "static-color" })], ee.prototype, "staticColor", 2), be([C({ reflect: !0 })], ee.prototype, "treatment", 2), be([C({ type: Boolean })], ee.prototype, "quiet", 1), be([C({ type: Boolean, attribute: "no-wrap", reflect: !0 })], ee.prototype, "noWrap", 2);
rt("sp-button", ee);
function Hc(e, t, r) {
...
function Ic(e, t, r) {
  ...
  } : (a.push(...o), e.setAttribute(t, a.join(" ")), () => Hc(e, t, o));
}
function Uo() {
...
class Yu {
  constructor(t, { mode: r } = { mode: "internal" }) {
    ...
    }, this.host = t, this.id = `sp-help-text-${Uo()}`, this.mode = r;
  }
  get isInternal() {
  ...
  render(t) {
    return H`
            <div
                id=${K(this.isInternal ? this.id : void 0)}
                aria-live="assertive"
            >
                <slot
                    name=${t ? "negative-help-text" : `pass-through-help-text-${Uo()}`}
  ...
  addId() {
    ...
    this.conditionId = Ic(this.host, "aria-describedby", t), this.host.hasAttribute("tabindex") && (this.previousTabindex = parseFloat(this.host.getAttribute("tabindex"))), this.host.tabIndex = 0;
  }
  removeId() {
...
function Ju(e, { mode: t } = { mode: "internal" }) {
  class r extends e {
    constructor() {
      super(...arguments), this.helpTextManager = new Yu(this, { mode: t });
    }
    get helpTextId() {
...
const Dc = Symbol("system resolver updated");
class Qu {
  constructor(t) {
  ...
  resolveSystem() {
    const t = new CustomEvent("sp-system-context", { bubbles: !0, composed: !0, detail: { callback: (r, o) => {
      const s = this.system;
      this.system = r, this.unsubscribe = o, this.host.requestUpdate(Dc, s);
    } }, cancelable: !0 });
...
`;
var em = Object.defineProperty, Co = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && em(t, r, s), s;
};
class ft extends Re {
  constructor() {
    super(...arguments), this.unsubscribeSystemContext = null, this.spectrumVersion = 1, this.label = "", this.systemResolver = new Qu(this);
  }
  static get styles() {
    return [tm];
  }
  ...
  update(t) {
    t.has("label") && (this.label ? this.removeAttribute("aria-hidden") : this.setAttribute("aria-hidden", "true")), t.has(Dc) && (this.spectrumVersion = this.systemResolver.system === "spectrum-two" ? 2 : 1), super.update(t);
  }
  render() {
    return H`
            <slot></slot>
...
Co([Mo()], ft.prototype, "spectrumVersion"), Co([C({ reflect: !0 })], ft.prototype, "label"), Co([C({ reflect: !0 })], ft.prototype, "size");
let No;
const vt = function(e, ...t) {
  return No ? No(e, ...t) : t.reduce((r, o, s) => r + o + e[s + 1], e[0]);
}, Ce = (e) => {
  No = e;
}, rm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark100" } = {}) => vt`<svg
  ...
  >
    ...
    />
  </svg>`, om = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark100" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class sm extends ft {
  render() {
    return Ce(H), this.spectrumVersion === 2 ? rm({ hidden: !this.label, title: this.label }) : om({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-checkmark100", sm);
let Fo;
const ie = function(e, ...t) {
  return Fo ? Fo(e, ...t) : t.reduce((r, o, s) => r + o + e[s + 1], e[0]);
}, ro = (e) => {
  Fo = e;
}, am = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Alert" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`, cm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Alert Triangle" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
...
class im extends ft {
  render() {
    return ro(H), this.spectrumVersion === 1 ? am({ hidden: !this.label, title: this.label }) : cm({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-alert", im);
const nm = nt`
...
`;
var um = Object.defineProperty, mm = Object.getOwnPropertyDescriptor, X = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? mm(t, r) : t, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = (o ? c(t, r, s) : c(s)) || s);
  return o && s && um(t, r, s), s;
};
const pm = ["text", "url", "tel", "email", "password"];
class Y extends Ju(Ue(ur, { noDefaultSize: !0 })) {
  constructor() {
  ...
  get type() {
    var t;
    return (t = pm.find((r) => r === this._type)) != null ? t : "text";
  }
  set value(t) {
  ...
  get renderMultiline() {
    return H`
            ...
            <textarea
                ...
                aria-invalid=${K(this.invalid || void 0)}
                class="input"
                maxlength=${K(this.maxlength > -1 ? this.maxlength : void 0)}
                minlength=${K(this.minlength > -1 ? this.minlength : void 0)}
                title=${this.invalid ? "" : W}
                ...
                rows=${K(this.rows > -1 ? this.rows : void 0)}
...
X([Mo()], Y.prototype, "appliedLabel", 2), X([C({ attribute: "allowed-keys" })], Y.prototype, "allowedKeys", 2), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "focused", 2), X([eo(".input:not(#sizer)")], Y.prototype, "inputElement", 2), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "invalid", 2), X([C()], Y.prototype, "label", 2), X([C({ type: String, reflect: !0 })], Y.prototype, "name", 2), X([C()], Y.prototype, "placeholder", 2), X([Mo()], Y.prototype, "type", 1), X([C({ attribute: "type", reflect: !0 })], Y.prototype, "_type", 2), X([C()], Y.prototype, "pattern", 2), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "grows", 2), X([C({ type: Number })], Y.prototype, "maxlength", 2), X([C({ type: Number })], Y.prototype, "minlength", 2), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "multiline", 2), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "readonly", 2), X([C({ type: Number })], Y.prototype, "rows", 2), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "valid", 2), X([C({ type: String })], Y.prototype, "value", 1), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "quiet", 2), X([C({ type: Boolean, reflect: !0 })], Y.prototype, "required", 2), X([C({ type: String, reflect: !0 })], Y.prototype, "autocomplete", 2);
class Pc extends Y {
  constructor() {
...
X([C({ type: String })], Pc.prototype, "value", 1);
rt("sp-textfield", Pc);
const dm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Asterisk100" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, gm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Asterisk100" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class bm extends ft {
  render() {
    return Ce(H), this.spectrumVersion === 2 ? dm({ hidden: !this.label, title: this.label }) : gm({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-asterisk100", bm);
const hm = nt`
...
`, qc = Symbol("element resolver updated");
class fm {
  ...
  set element(t) {
    ...
    this._element = t, this.host.requestUpdate(qc, r);
  }
  get selector() {
...
:host,:host{--spectrum-field-label-min-height:var(--spectrum-component-height-75);--spectrum-field-label-font-size:var(--spectrum-font-size-75);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-medium);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-200);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-medium)}:host([size=s]){--spectrum-field-label-min-height:var(--spectrum-component-height-75);--spectrum-field-label-font-size:var(--spectrum-font-size-75);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-small);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-100);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-small)}:host([size=l]){--spectrum-field-label-min-height:var(--spectrum-component-height-100);--spectrum-field-label-font-size:var(--spectrum-font-size-100);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-large);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-200);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-large)}:host([size=xl]){--spectrum-field-label-min-height:var(--spectrum-component-height-200);--spectrum-field-label-font-size:var(--spectrum-font-size-200);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-extra-large);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-200);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-extra-large)}:host{box-sizing:border-box;min-block-size:var(--mod-fieldlabel-min-height,var(--spectrum-field-label-min-height));padding-block:var(--mod-fieldlabel-padding-block,var(--mod-field-label-top-to-text,var(--spectrum-field-label-top-to-text))var(--mod-field-label-bottom-to-text,var(--spectrum-field-label-bottom-to-text)));padding-inline:0;padding-inline:var(--mod-fieldlabel-padding-inline,0);margin-block:0;margin-block:var(--mod-fieldlabel-margin-block,var(--mod-fieldlabel-margin-block-start,0)var(--mod-fieldlabel-margin-block-end,0));margin-inline:0;margin-inline:var(--mod-fieldlabel-margin-inline,var(--mod-fieldlabel-margin-inline-start,0)var(--mod-fieldlabel-margin-inline-end,0));font-size:var(--mod-fieldlabel-font-size,var(--spectrum-field-label-font-size));font-weight:var(--mod-fieldlabel-font-weight,var(--spectrum-regular-font-weight));line-height:var(--mod-fieldlabel-line-height,var(--spectrum-line-height-100));-webkit-font-smoothing:subpixel-antialiased;-moz-osx-font-smoothing:auto;color:var(--highcontrast-field-label-content-color,var(--mod-fieldlabel-color,var(--spectrum-neutral-subdued-content-color-default)));display:block}:host(:lang(ja)),:host(:lang(ko)),:host(:lang(zh)){--mod-fieldlabel-line-height:var(--mod-fieldlabel-line-height-cjk,var(--spectrum-cjk-line-height-100))}:host([disabled]){--mod-fieldlabel-color:var(--mod-disabled-content-color,var(--spectrum-disabled-content-color))}.required-icon{color:inherit;margin-block:0;margin-inline:var(--mod-field-label-text-to-asterisk,var(--spectrum-field-label-text-to-asterisk))0;vertical-align:initial;vertical-align:var(--mod-field-label-asterisk-vertical-align,baseline)}:host([side-aligned=start]),:host([side-aligned=end]){vertical-align:top;margin-block-start:var(--mod-fieldlabel-side-margin-block-start,var(--spectrum-field-label-side-margin-block-start));margin-block-end:0;margin-inline-end:var(--mod-fieldlabel-side-padding-right,var(--spectrum-field-label-side-padding-right));display:inline-block}:host([side-aligned=end]){text-align:end}@media (forced-colors:active){:host([disabled]){--highcontrast-field-label-content-color:GrayText}}:host{--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text)}:host([size=s]){--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text-small);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text-small)}:host([size=l]){--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text-large);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text-large)}:host([size=xl]){--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text-extra-large);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text-extra-large)}label{display:inline-block}
        `;
var ym = Object.defineProperty, je = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && ym(t, r, s), s;
};
class ve extends Ue(Re, { noDefaultSize: !0 }) {
  constructor() {
    super(...arguments), this.disabled = !1, this.id = "", this.for = "", this.required = !1, this.resolvedElement = new fm(this);
  }
  static get styles() {
    return [vm, hm];
  }
  ...
  applyTargetLabel(t) {
    if (this.target = t || this.target, this.target) {
      ...
      typeof r < "u" ? r(this.labelText, this) : s === this.getRootNode() ? (t ? Ic : Hc)(o, "aria-labelledby", [this.id]) : t ? o.setAttribute("aria-label", this.labelText) : o.removeAttribute("aria-label");
    }
  }
  async manageTarget() {
  ...
  willUpdate(t) {
    this.hasAttribute("id") || this.setAttribute("id", `${this.tagName.toLowerCase()}-${Uo()}`), t.has("for") && (this.resolvedElement.selector = this.for ? `#${this.for}` : ""), (t.has("id") || t.has(qc)) && this.manageTarget();
  }
}
je([C({ type: Boolean, reflect: !0 })], ve.prototype, "disabled"), je([C({ type: String })], ve.prototype, "id"), je([C({ type: String })], ve.prototype, "for"), je([C({ type: Boolean, reflect: !0 })], ve.prototype, "required"), je([eo("slot")], ve.prototype, "slotEl"), je([C({ type: String, reflect: !0, attribute: "side-aligned" })], ve.prototype, "sideAligned");
rt("sp-field-label", ve);
class xm extends Le {
}
const km = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross200" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, wm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross200" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class zm extends ft {
  render() {
    return Ce(H), this.spectrumVersion === 2 ? km({ hidden: !this.label, title: this.label }) : wm({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-cross200", zm);
const _m = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross300" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, Cm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross300" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class $m extends ft {
  render() {
    return Ce(H), this.spectrumVersion === 2 ? _m({ hidden: !this.label, title: this.label }) : Cm({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-cross300", $m);
const Am = nt`
...
`, jm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross400" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, Em = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross400" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Tm extends ft {
  render() {
    return Ce(H), this.spectrumVersion === 2 ? jm({ hidden: !this.label, title: this.label }) : Em({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-cross400", Tm);
const Hm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross500" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, Im = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Cross500" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Dm extends ft {
  render() {
    return Ce(H), this.spectrumVersion === 2 ? Hm({ hidden: !this.label, title: this.label }) : Im({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-cross500", Dm);
var Pm = Object.defineProperty, da = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && Pm(t, r, s), s;
};
const qm = { s: () => H`
    ...
    `, xl: () => H`
        ...
        ></sp-icon-cross500>
    ` };
class Vo extends Ue(xm, { noDefaultSize: !0 }) {
  constructor() {
    super(...arguments), this.variant = "";
  }
  static get styles() {
    return [...super.styles, Sm, Am];
  }
  get buttonContent() {
    return [qm[this.size](), H`
...
da([C({ reflect: !0 })], Vo.prototype, "variant"), da([C({ reflect: !0, attribute: "static-color" })], Vo.prototype, "staticColor");
const Lm = nt`
...
`, Mm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Corner Triangle300" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, Om = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Corner Triangle300" } = {}) => vt`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Rm extends ft {
  render() {
    return Ce(H), this.spectrumVersion === 2 ? Mm({ hidden: !this.label, title: this.label }) : Om({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-corner-triangle300", Rm);
var Um = Object.defineProperty, Nm = Object.getOwnPropertyDescriptor, Qt = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? Nm(t, r) : t, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = (o ? c(t, r, s) : c(s)) || s);
  return o && s && Um(t, r, s), s;
};
const Fm = { xs: "spectrum-UIIcon-CornerTriangle75", s: "spectrum-UIIcon-CornerTriangle75", m: "spectrum-UIIcon-CornerTriangle100", l: "spectrum-UIIcon-CornerTriangle200", xl: "spectrum-UIIcon-CornerTriangle300" }, Vm = 300;
let ga;
class Ut extends Ue(Le, { validSizes: ["xs", "s", "m", "l", "xl"], noDefaultSize: !0 }) {
  constructor() {
  ...
  handlePointerdownHoldAffordance(t) {
    t.button === 0 && (this.addEventListener("pointerup", this.handlePointerupHoldAffordance), this.addEventListener("pointercancel", this.handlePointerupHoldAffordance), ga = setTimeout(() => {
      this.dispatchEvent(new CustomEvent("longpress", { bubbles: !0, composed: !0, detail: { source: "pointer" } }));
    }, Vm));
  }
  handlePointerupHoldAffordance() {
    clearTimeout(ga), this.removeEventListener("pointerup", this.handlePointerupHoldAffordance), this.removeEventListener("pointercancel", this.handlePointerupHoldAffordance);
  }
  handleKeydown(t) {
  ...
  get buttonContent() {
    ...
    return this.holdAffordance && t.unshift(H`
                <sp-icon-corner-triangle300
                    class="hold-affordance ${Fm[this.size]}"
                ></sp-icon-corner-triangle300>
            `), t;
  }
  updated(t) {
...
Qt([C({ type: Boolean, reflect: !0 })], Ut.prototype, "emphasized", 2), Qt([C({ type: Boolean, reflect: !0, attribute: "hold-affordance" })], Ut.prototype, "holdAffordance", 2), Qt([C({ type: Boolean, reflect: !0 })], Ut.prototype, "quiet", 2), Qt([C({ reflect: !0 })], Ut.prototype, "role", 2), Qt([C({ type: Boolean, reflect: !0 })], Ut.prototype, "selected", 2), Qt([C({ type: Boolean, reflect: !0 })], Ut.prototype, "toggles", 2), Qt([C({ reflect: !0, attribute: "static-color" })], Ut.prototype, "staticColor", 2), Qt([C({ type: String })], Ut.prototype, "value", 1);
rt("sp-action-button", Ut);
const Km = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Delete" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`, Wm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Delete" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
...
class Gm extends ft {
  render() {
    return ro(H), this.spectrumVersion === 2 ? Km({ hidden: !this.label, title: this.label }) : Wm({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-delete", Gm);
rt("sp-close-button", Vo);
const Zm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Info" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`, Xm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Info Circle" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
...
class Ym extends ft {
  render() {
    return ro(H), this.spectrumVersion === 1 ? Zm({ hidden: !this.label, title: this.label }) : Xm({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-info", Ym);
const Jm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark Circle" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`, Qm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark Circle" } = {}) => ie`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 36 36"
...
class tp extends ft {
  render() {
    return ro(H), this.spectrumVersion === 2 ? Jm({ hidden: !this.label, title: this.label }) : Qm({ hidden: !this.label, title: this.label });
  }
}
rt("sp-icon-checkmark-circle", tp);
const ep = nt`
...
`;
var rp = Object.defineProperty, op = Object.getOwnPropertyDescriptor, Tr = (e, t, r, o) => {
  for (var s = o > 1 ? void 0 : o ? op(t, r) : t, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = (o ? c(t, r, s) : c(s)) || s);
  return o && s && rp(t, r, s), s;
};
const sp = ["negative", "positive", "info", "error", "warning"];
class Qe extends Ec(Re) {
  constructor() {
    super(...arguments), this.open = !1, this._timeout = null, this._variant = "", this.countdownStart = 0, this.nextCount = -1, this.doCountdown = (t) => {
      this.countdownStart || (this.countdownStart = performance.now()), t - this.countdownStart > this._timeout ? (this.shouldClose(), this.countdownStart = 0) : this.countdown();
    }, this.countdown = () => {
  ...
  set timeout(t) {
    const r = typeof t !== null && t > 0 ? Math.max(6e3, t) : null, o = this.timeout;
    r && this.countdownStart && (this.countdownStart = performance.now()), this._timeout = r, this.requestUpdate("timeout", o);
  }
  get timeout() {
  ...
  set variant(t) {
    ...
    sp.includes(t) ? (this.setAttribute("variant", t), this._variant = t) : (this.removeAttribute("variant"), this._variant = ""), this.requestUpdate("variant", r);
  }
  get variant() {
    return this._variant;
  }
  ...
  shouldClose() {
    this.dispatchEvent(new CustomEvent("close", { composed: !0, bubbles: !0, cancelable: !0 })) && this.close();
  }
  close() {
    this.open = !1;
  }
  ...
  updated(t) {
    super.updated(t), t.has("open") && (this.open ? this.timeout && this.startCountdown() : this.timeout && this.stopCountdown()), t.has("timeout") && (this.timeout !== null && this.open ? this.startCountdown() : this.stopCountdown());
  }
}
Tr([C({ type: Boolean, reflect: !0 })], Qe.prototype, "open", 2), Tr([C({ type: Number })], Qe.prototype, "timeout", 1), Tr([C({ type: String })], Qe.prototype, "variant", 1), Tr([C({ type: String, attribute: "icon-label" })], Qe.prototype, "iconLabel", 2);
rt("sp-toast", Qe);
let ap = Mc;
...
async function bp(e) {
  ...
  if (t.textContent = ap, ba.add(t), e.shadowRoot.insertBefore(t, e.shadowRoot.firstChild), !window.WidgetServiceSDK) {
    const s = e.getContainer();
    s.textContent = "Connectors SDK failed to load. Include the UMD script in index.html.";
    return;
  }
  const r = new window.WidgetServiceSDK(), o = hl(Nl, { sdk: e, connectors: r });
  o.mount(e.getContainer()), e.on("destroy", () => {
    ba.delete(t), t.remove(), o.unmount();
  });
}
export {
  bp as init

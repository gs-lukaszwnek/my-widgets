...
const G = {}, qe = [], Lt = () => {
}, Ha = () => !1, Yr = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && // uppercase letter
(e.charCodeAt(2) > 122 || e.charCodeAt(2) < 97), Jr = (e) => e.startsWith("onUpdate:"), ut = Object.assign, Qo = (e, t) => {
  const r = e.indexOf(t);
  r > -1 && e.splice(r, 1);
}, ei = Object.prototype.hasOwnProperty, L = (e, t) => ei.call(e, t), D = Array.isArray, Pe = (e) => kr(e) === "[object Map]", _a = (e) => kr(e) === "[object Set]", As = (e) => kr(e) === "[object Date]", I = (e) => typeof e == "function", at = (e) => typeof e == "string", Ot = (e) => typeof e == "symbol", R = (e) => e !== null && typeof e == "object", $a = (e) => (R(e) || I(e)) && I(e.then) && I(e.catch), Ca = Object.prototype.toString, kr = (e) => Ca.call(e), ri = (e) => kr(e).slice(8, -1), Aa = (e) => kr(e) === "[object Object]", ts = (e) => at(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, er = /* @__PURE__ */ Jo(
...
), Sa = Qr((e) => e.charAt(0).toUpperCase() + e.slice(1)), po = Qr(
  (e) => e ? `on${Sa(e)}` : ""
), qt = (e, t) => !Object.is(e, t), go = (e, ...t) => {
...
let Ss;
const to = () => Ss || (Ss = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function es(e) {
  if (D(e)) {
    const t = {};
    for (let r = 0; r < e.length; r++) {
      const o = e[r], s = at(o) ? li(o) : es(o);
      if (s)
        for (const a in s)
          t[a] = s[a];
    }
...
function li(e) {
  const t = {};
  return e.replace(ni, "").split(ci).forEach((r) => {
    if (r) {
      const o = r.split(ii);
...
const ui = "itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly", mi = /* @__PURE__ */ Jo(ui);
function Ta(e) {
  return !!e || e === "";
}
function pi(e, t) {
...
const Da = (e) => !!(e && e.__v_isRef === !0), Je = (e) => at(e) ? e : e == null ? "" : D(e) || R(e) && (e.toString === Ca || !I(e.toString)) ? Da(e) ? Je(e.value) : JSON.stringify(e, Ba, 2) : String(e), Ba = (e, t) => Da(t) ? Ba(e, t.value) : Pe(t) ? {
  [`Map(${t.size})`]: [...t.entries()].reduce(
    (r, [o, s], a) => (r[bo(o, a) + " =>"] = s, r),
    {}
  )
} : _a(t) ? {
  [`Set(${t.size})`]: [...t.values()].map((r) => bo(r))
} : Ot(t) ? bo(t) : R(t) && !D(t) && !Aa(t) ? String(t) : t, bo = (e, t = "") => {
  var r;
  return (
...
class di {
  ...
  constructor(t = !1) {
    this.detached = t, this._active = !0, this._on = 0, this.effects = [], this.cleanups = [], this._isPaused = !1, this.__v_skip = !0, this.parent = yt, !t && yt && (this.index = (yt.scopes || (yt.scopes = [])).push(
      this
    ) - 1);
  }
  get active() {
...
class Ia {
  ...
  run() {
    if (!(this.flags & 1))
      return this.fn();
    this.flags |= 2, Es(this), Ma(this);
    const t = K, r = Ht;
    K = this, Ht = !0;
    try {
      return this.fn();
    } finally {
      La(this), K = t, Ht = r, this.flags &= -3;
    }
  }
  stop() {
    if (this.flags & 1) {
...
function La(e) {
  ...
  for (; o; ) {
    const s = o.prevDep;
    o.version === -1 ? (o === r && (r = s), as(o), bi(o)) : t = o, o.dep.activeLink = o.prevActiveLink, o.prevActiveLink = void 0, o = s;
  }
...
function Oa(e) {
  if (e.flags & 4 && !(e.flags & 16) || (e.flags &= -17, e.globalVersion === dr) || (e.globalVersion = dr, !e.isSSR && e.flags & 128 && (!e.deps && !e._dirty || !Do(e))))
    return;
  e.flags |= 2;
  const t = e.dep, r = K, o = Ht;
  K = e, Ht = !0;
  try {
    Ma(e);
...
class cs {
  ...
  track(t) {
    if (!K || !Ht || K === this.computed)
      return;
    let r = this.activeLink;
    if (r === void 0 || r.sub !== K)
      r = this.activeLink = new hi(K, this), K.deps ? (r.prevDep = K.depsTail, K.depsTail.nextDep = r, K.depsTail = r) : K.deps = K.depsTail = r, Ua(r);
    else if (r.version === -1 && (r.version = this.version, r.nextDep)) {
      const o = r.nextDep;
      o.prevDep = r.prevDep, r.prevDep && (r.prevDep.nextDep = o), r.prevDep = K.depsTail, r.nextDep = void 0, K.depsTail.nextDep = r, K.depsTail = r, K.deps === r && (K.deps = o);
    }
    return r;
  }
  trigger(t) {
...
const Bo = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ Symbol(
  ""
), Io = /* @__PURE__ */ Symbol(
  ""
), gr = /* @__PURE__ */ Symbol(
...
function Zt(e, t, r, o, s, a) {
  ...
  if (os(), t === "clear")
    ...
    if (n && r === "length") {
      const u = Number(o);
      c.forEach((d, b) => {
        (b === "length" || b === gr || !Ot(b) && b >= u) && i(d);
      });
    } else
      switch ((r !== void 0 || c.has(void 0)) && i(c.get(r)), p && i(c.get(gr)), t) {
        case "add":
          n ? p && i(c.get("length")) : (i(c.get(je)), Pe(e) && i(c.get(Io)));
          break;
        case "delete":
          n || (i(c.get(je)), Pe(e) && i(c.get(Io)));
          break;
        case "set":
          Pe(e) && i(c.get(je));
          break;
...
function Ae(e) {
  ...
  return t === e ? t : (mt(t, "iterate", gr), /* @__PURE__ */ zt(e) ? t : t.map(_t));
}
function ro(e) {
  return mt(e = /* @__PURE__ */ M(e), "iterate", gr), e;
}
function Dt(e, t) {
  return /* @__PURE__ */ te(e) ? Oe(/* @__PURE__ */ He(e) ? _t(t) : t) : _t(t);
}
const fi = {
  __proto__: null,
  [Symbol.iterator]() {
    return fo(this, Symbol.iterator, (e) => Dt(this, e));
  },
  concat(...e) {
  ...
  entries() {
    return fo(this, "entries", (e) => (e[1] = Dt(this, e[1]), e));
  },
  every(e, t) {
  ...
  values() {
    return fo(this, "values", (e) => Dt(this, e));
  }
};
function fo(e, t, r) {
  const o = ro(e), s = o[t]();
  return o !== e && !/* @__PURE__ */ zt(e) && (s._next = s.next, s.next = () => {
    const a = s._next();
...
function Vt(e, t, r, o, s, a) {
  const c = ro(e), i = c !== e && !/* @__PURE__ */ zt(e), n = c[t];
  if (n !== vi[t]) {
    const d = n.apply(e, a);
    return i ? _t(d) : d;
  }
...
function Ts(e, t, r, o) {
  const s = ro(e), a = s !== e && !/* @__PURE__ */ zt(e);
  let c = r, i = !1;
  s !== e && (a ? (i = o.length === 0, c = function(p, u, d) {
    return i && (i = !1, p = Dt(e, p)), r.call(this, p, Dt(e, u), d, e);
...
function vo(e, t, r) {
  ...
  mt(o, "iterate", gr);
  const s = o[t](...r);
  return (s === -1 || s === !1) && /* @__PURE__ */ us(r[0]) ? (r[0] = /* @__PURE__ */ M(r[0]), o[t](...r)) : s;
}
function Ge(e, t, r = []) {
  Jt(), os();
  const o = (/* @__PURE__ */ M(e))[t].apply(e, r);
  return ss(), Qt(), o;
}
const yi = /* @__PURE__ */ Jo("__proto__,__v_isRef,__isVue"), Na = new Set(
...
class Fa {
  ...
  get(t, r, o) {
    ...
    if (r === "__v_isShallow")
      return a;
    if (r === "__v_raw")
      return o === (s ? a ? Si : Ga : a ? Wa : Ka).get(t) || // receiver is not the reactive proxy, but has the same prototype
    ...
    if ((Ot(r) ? Na.has(r) : yi(r)) || (s || mt(t, "get", r), a))
      return i;
    if (/* @__PURE__ */ pt(i)) {
      const n = c && ts(r) ? i : i.value;
      return s && R(n) ? /* @__PURE__ */ Po(n) : n;
    }
    return R(i) ? s ? /* @__PURE__ */ Po(i) : /* @__PURE__ */ ns(i) : i;
  }
}
class Va extends Fa {
  constructor(t = !1) {
  ...
  set(t, r, o, s) {
    ...
    const c = D(t) && ts(r);
    if (!this._isShallow) {
      const p = /* @__PURE__ */ te(a);
      if (!/* @__PURE__ */ zt(o) && !/* @__PURE__ */ te(o) && (a = /* @__PURE__ */ M(a), o = /* @__PURE__ */ M(o)), !c && /* @__PURE__ */ pt(a) && !/* @__PURE__ */ pt(o))
        return p || (a.value = o), !0;
    }
    const i = c ? Number(r) < t.length : L(t, r), n = Reflect.set(
      t,
      r,
      o,
      /* @__PURE__ */ pt(t) ? t : s
    );
    return t === /* @__PURE__ */ M(s) && (i ? qt(o, a) && Zt(t, "set", r, o) : Zt(t, "add", r, o)), n;
  }
  deleteProperty(t, r) {
    const o = L(t, r);
    t[r];
    const s = Reflect.deleteProperty(t, r);
    return s && o && Zt(t, "delete", r, void 0), s;
  }
  has(t, r) {
    const o = Reflect.has(t, r);
    return (!Ot(r) || !Na.has(r)) && mt(t, "has", r), o;
  }
  ownKeys(t) {
    return mt(
      t,
...
const wi = /* @__PURE__ */ new Va(), zi = /* @__PURE__ */ new xi(), ji = /* @__PURE__ */ new Va(!0);
const qo = (e) => e, Tr = (e) => Reflect.getPrototypeOf(e);
function Hi(e, t, r) {
  return function(...o) {
    const s = this.__v_raw, a = /* @__PURE__ */ M(s), c = Pe(a), i = e === "entries" || e === Symbol.iterator && c, n = e === "keys" && c, p = s[e](...o), u = r ? qo : t ? Oe : _t;
    return !t && mt(
      a,
      "iterate",
      n ? Io : je
...
function _i(e, t) {
  const r = {
    get(s) {
      const a = this.__v_raw, c = /* @__PURE__ */ M(a), i = /* @__PURE__ */ M(s);
      e || (qt(s, i) && mt(c, "get", s), mt(c, "get", i));
      const { has: n } = Tr(c), p = t ? qo : e ? Oe : _t;
      if (n.call(c, s))
        return p(a.get(s));
      if (n.call(c, i))
        return p(a.get(i));
    ...
    get size() {
      ...
      return !e && mt(/* @__PURE__ */ M(s), "iterate", je), s.size;
    },
    has(s) {
      const a = this.__v_raw, c = /* @__PURE__ */ M(a), i = /* @__PURE__ */ M(s);
      return e || (qt(s, i) && mt(c, "has", s), mt(c, "has", i)), s === i ? a.has(s) : a.has(s) || a.has(i);
    },
    forEach(s, a) {
      const c = this, i = c.__v_raw, n = /* @__PURE__ */ M(i), p = t ? qo : e ? Oe : _t;
      return !e && mt(n, "iterate", je), i.forEach((u, d) => s.call(a, p(u), p(d), c));
    }
  };
  return ut(
    r,
    e ? {
      ...
      add(s) {
        const a = /* @__PURE__ */ M(this), c = Tr(a), i = /* @__PURE__ */ M(s), n = !t && !/* @__PURE__ */ zt(s) && !/* @__PURE__ */ te(s) ? i : s;
        return c.has.call(a, n) || qt(s, n) && c.has.call(a, s) || qt(i, n) && c.has.call(a, i) || (a.add(n), Zt(a, "add", n, n)), this;
      },
      set(s, a) {
        !t && !/* @__PURE__ */ zt(a) && !/* @__PURE__ */ te(a) && (a = /* @__PURE__ */ M(a));
        const c = /* @__PURE__ */ M(this), { has: i, get: n } = Tr(c);
        let p = i.call(c, s);
        p || (s = /* @__PURE__ */ M(s), p = i.call(c, s));
        const u = n.call(c, s);
        return c.set(s, a), p ? qt(a, u) && Zt(c, "set", s, a) : Zt(c, "add", s, a), this;
      },
      delete(s) {
        const a = /* @__PURE__ */ M(this), { has: c, get: i } = Tr(a);
        let n = c.call(a, s);
        n || (s = /* @__PURE__ */ M(s), n = c.call(a, s)), i && i.call(a, s);
        const p = a.delete(s);
        return n && Zt(a, "delete", s, void 0), p;
      },
      clear() {
        const s = /* @__PURE__ */ M(this), a = s.size !== 0, c = s.clear();
        return a && Zt(
          s,
          "clear",
          void 0,
...
const Ka = /* @__PURE__ */ new WeakMap(), Wa = /* @__PURE__ */ new WeakMap(), Ga = /* @__PURE__ */ new WeakMap(), Si = /* @__PURE__ */ new WeakMap();
function Ei(e) {
  switch (e) {
    case "Object":
    case "Array":
...
function Ti(e) {
  return e.__v_skip || !Object.isExtensible(e) ? 0 : Ei(ri(e));
}
// @__NO_SIDE_EFFECTS__
function ns(e) {
  return /* @__PURE__ */ te(e) ? e : ls(
    e,
    !1,
    wi,
    $i,
...
// @__NO_SIDE_EFFECTS__
function He(e) {
  return /* @__PURE__ */ te(e) ? /* @__PURE__ */ He(e.__v_raw) : !!(e && e.__v_isReactive);
}
// @__NO_SIDE_EFFECTS__
function te(e) {
...
function Bi(e) {
  return !L(e, "__v_skip") && Object.isExtensible(e) && Ea(e, "__v_skip", !0), e;
}
const _t = (e) => R(e) ? /* @__PURE__ */ ns(e) : e, Oe = (e) => R(e) ? /* @__PURE__ */ Po(e) : e;
// @__NO_SIDE_EFFECTS__
function pt(e) {
...
function Ii(e, t) {
  return /* @__PURE__ */ pt(e) ? e : new qi(e, t);
}
class qi {
  constructor(t, r) {
    this.dep = new cs(), this.__v_isRef = !0, this.__v_isShallow = !1, this._rawValue = r ? t : /* @__PURE__ */ M(t), this._value = r ? t : _t(t), this.__v_isShallow = r;
  }
  get value() {
    return this.dep.track(), this._value;
  }
  set value(t) {
    const r = this._rawValue, o = this.__v_isShallow || /* @__PURE__ */ zt(t) || /* @__PURE__ */ te(t);
    t = o ? t : /* @__PURE__ */ M(t), qt(t, r) && (this._rawValue = t, this._value = o ? t : _t(t), this.dep.trigger());
  }
}
function it(e) {
  return /* @__PURE__ */ pt(e) ? e.value : e;
}
const Pi = {
  get: (e, t, r) => t === "__v_raw" ? e : it(Reflect.get(e, t, r)),
  set: (e, t, r, o) => {
    const s = e[t];
    return /* @__PURE__ */ pt(s) && !/* @__PURE__ */ pt(r) ? (s.value = r, !0) : Reflect.set(e, t, r, o);
  }
};
function Xa(e) {
  return /* @__PURE__ */ He(e) ? e : new Proxy(e, Pi);
}
class Mi {
  constructor(t, r, o) {
    this.fn = t, this.setter = r, this._value = void 0, this.dep = new cs(this), this.__v_isRef = !0, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = dr - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !r, this.isSSR = o;
  }
  /**
   * @internal
   */
...
function Li(e, t, r = !1) {
  let o, s;
  return I(e) ? o = e : (o = e.get, s = e.set), new Mi(o, s, r);
}
const Br = {}, Nr = /* @__PURE__ */ new WeakMap();
let ye;
function Oi(e, t = !1, r = ye) {
  if (r) {
    let o = Nr.get(r);
    o || Nr.set(r, o = []), o.push(e);
  }
}
function Ri(e, t, r = G) {
  const { immediate: o, deep: s, once: a, scheduler: c, augmentJob: i, call: n } = r, p = (_) => s ? _ : /* @__PURE__ */ zt(_) || s === !1 || s === 0 ? ie(_, 1) : ie(_);
  let u, d, b, w, $ = !1, S = !1;
  if (/* @__PURE__ */ pt(e) ? (d = () => e.value, $ = /* @__PURE__ */ zt(e)) : /* @__PURE__ */ He(e) ? (d = () => p(e), $ = !0) : D(e) ? (S = !0, $ = e.some((_) => /* @__PURE__ */ He(_) || /* @__PURE__ */ zt(_)), d = () => e.map((_) => {
    if (/* @__PURE__ */ pt(_))
      return _.value;
    if (/* @__PURE__ */ He(_))
      return p(_);
    ...
    ye = u;
    try {
      return n ? n(e, 3, [w]) : e(w);
    } finally {
      ye = _;
    }
  } : d = Lt, t && s) {
    const _ = d, B = s === !0 ? 1 / 0 : s;
    d = () => ie(_(), B);
  }
  const Y = gi(), O = () => {
    u.stop(), Y && Y.active && Qo(Y.effects, u);
  };
  if (a && t) {
    const _ = t;
    t = (...B) => {
  ...
  let q = S ? new Array(e.length).fill(Br) : Br;
  const U = (_) => {
    if (!(!(u.flags & 1) || !u.dirty && !_))
      if (t) {
        const B = u.run();
        if (s || $ || (S ? B.some((ot, wt) => qt(ot, q[wt])) : qt(B, q))) {
          b && b();
          const ot = ye;
          ye = u;
          try {
  ...
  return i && i(U), u = new Ia(d), u.scheduler = c ? () => c(U, !1) : U, w = (_) => Oi(_, !1, u), b = u.onStop = () => {
    const _ = Nr.get(u);
    if (_) {
      if (n)
        n(_, 4);
  ...
  }, t ? o ? U(!0) : q = u.run() : c ? c(U.bind(null, !0), !0) : u.run(), O.pause = u.pause.bind(u), O.resume = u.resume.bind(u), O.stop = O, O;
}
function ie(e, t = 1 / 0, r) {
  if (t <= 0 || !R(e) || e.__v_skip || (r = r || /* @__PURE__ */ new Map(), (r.get(e) || 0) >= t))
    return e;
  if (r.set(e, t), t--, /* @__PURE__ */ pt(e))
    ie(e.value, t, r);
  else if (D(e))
    ...
    for (const o of Object.getOwnPropertySymbols(e))
      Object.prototype.propertyIsEnumerable.call(e, o) && ie(e[o], t, r);
  }
  return e;
}
/**
...
function oo(e, t, r, o = !0) {
  const s = t ? t.vnode : null, { errorHandler: a, throwUnhandledErrorInProduction: c } = t && t.appContext.config || G;
  if (t) {
    let i = t.parent;
...
function Fi(e) {
  let t = Tt + 1, r = ht.length;
  for (; t < r; ) {
    const o = t + r >>> 1, s = ht[o], a = br(s);
...
function ms(e) {
  if (!(e.flags & 1)) {
    const t = br(e), r = ht[ht.length - 1];
    !r || // fast path when the job id is larger than the tail
    !(e.flags & 2) && t >= br(r) ? ht.push(e) : ht.splice(Fi(t), 0, e), e.flags |= 1, Ya();
  }
}
function Ya() {
  Fr || (Fr = Za.then(Qa));
...
function Vi(e) {
  D(e) ? Me.push(...e) : ce && e.id === -1 ? ce.splice(De + 1, 0, e) : e.flags & 1 || (Me.push(e), e.flags |= 1), Ya();
}
function Ds(e, t, r = Tt + 1) {
  for (; r < ht.length; r++) {
    const o = ht[r];
    if (o && o.flags & 2) {
      if (e && o.id !== e.uid)
        continue;
      ht.splice(r, 1), r--, o.flags & 4 && (o.flags &= -2), o(), o.flags & 4 || (o.flags &= -2);
    }
  }
}
function Ja(e) {
...
function Qa(e) {
  try {
    ...
    Tt = -1, ht.length = 0, Ja(), Fr = null, (ht.length || Me.length) && Qa();
  }
}
let Pt = null, tc = null;
function Vr(e) {
  const t = Pt;
  return Pt = e, tc = e && e.type.__scopeId || null, t;
}
function Ki(e, t = Pt, r) {
  if (!t || e._n)
    return e;
  const o = (...s) => {
    o._d && Fs(-1);
...
function Wi(e, t) {
  if (ft) {
    ...
    o === r && (r = ft.provides = Object.create(o)), r[e] = t;
  }
}
function Pr(e, t, r = !1) {
  const o = Xn();
  if (o || Le) {
    let s = Le ? Le._context.provides : o ? o.parent == null || o.ce ? o.vnode.appContext && o.vnode.appContext.provides : o.parent.provides : void 0;
    if (s && e in s)
      return s[e];
    if (arguments.length > 1)
      return r && I(t) ? t.call(o && o.proxy) : t;
  }
}
const Gi = /* @__PURE__ */ Symbol.for("v-scx"), Xi = () => Pr(Gi);
function yo(e, t, r) {
  return ec(e, t, r);
}
function ec(e, t, r = G) {
  const { immediate: o, deep: s, flush: a, once: c } = r, i = ut({}, r), n = t && o || !t && a !== "post";
  let p;
  if (fr) {
    if (a === "sync") {
      const w = Xi();
  ...
  i.call = (w, $, S) => Rt(w, u, $, S);
  let d = !1;
  a === "post" ? i.scheduler = (w) => {
    vt(w, u && u.suspense);
  } : a !== "sync" && (d = !0, i.scheduler = (w, $) => {
    $ ? w() : ms(w);
  }), i.augmentJob = (w) => {
    t && (w.flags |= 4), d && (w.flags |= 2, u && (w.id = u.uid, w.i = u));
  };
  const b = Ri(e, t, i);
  return fr && (p ? p.push(b) : n && b()), b;
}
function Zi(e, t, r) {
  const o = this.proxy, s = at(e) ? e.includes(".") ? rc(o, e) : () => o[e] : e.bind(o, o);
  let a;
  I(t) ? a = t : (a = t.handler, r = t);
  const c = wr(this), i = ec(s, a.bind(o), r);
  return c(), i;
}
function rc(e, t) {
  const r = t.split(".");
...
const Yi = /* @__PURE__ */ Symbol("_vte"), Ji = (e) => e.__isTeleport, Qi = /* @__PURE__ */ Symbol("_leaveCb");
function ps(e, t) {
...
function sr(e, t, r, o, s = !1) {
  ...
  if (ar(o) && !s) {
    o.shapeFlag & 512 && o.type.__asyncResolved && o.component.subTree.component && sr(e, t, r, o.component.subTree);
    return;
  }
  const a = o.shapeFlag & 4 ? fs(o.component) : o.el, c = s ? null : a, { i, r: n } = e, p = t && t.r, u = i.refs === G ? i.refs = {} : i.refs, d = i.setupState, b = /* @__PURE__ */ M(d), w = d === G ? Ha : (S) => Bs(u, S) ? !1 : L(b, S), $ = (S, Y) => !(Y && Bs(u, Y));
  if (p != null && p !== n) {
    if (Is(t), at(p))
      u[p] = null, w(p) && (d[p] = null);
    else if (/* @__PURE__ */ pt(p)) {
      const S = t;
      $(p, S.k) && (p.value = null), S.k && (u[S.k] = null);
    }
  }
  if (I(n))
    xr(n, i, 12, [c, u]);
  else {
    const S = at(n), Y = /* @__PURE__ */ pt(n);
    if (S || Y) {
      const O = () => {
        if (e.f) {
          const q = S ? w(n) ? d[n] : u[n] : $() || !e.k ? n.value : u[e.k];
          if (s)
            D(q) && Qo(q, a);
          else if (D(q))
            ...
            const U = [a];
            $(n, e.k) && (n.value = U), e.k && (u[e.k] = U);
          }
        } else S ? (u[n] = c, w(n) && (d[n] = c)) : Y && ($(n, e.k) && (n.value = c), e.k && (u[e.k] = c));
      };
      if (c) {
        const q = () => {
          O(), Kr.delete(e);
        };
        q.id = -1, Kr.set(e, q), vt(q, r);
      } else
        Is(e), O();
    }
  }
...
const ar = (e) => !!e.type.__asyncLoader, sc = (e) => e.type.__isKeepAlive;
function en(e, t) {
  ac(e, "a", t);
}
function rn(e, t) {
...
function ac(e, t, r = ft) {
  ...
  if (so(t, o, r), r) {
    let s = r.parent;
    for (; s && s.parent; )
      sc(s.parent.vnode) && on(o, t, r, s), s = s.parent;
  }
}
function on(e, t, r, o) {
  const s = so(
...
function so(e, t, r = ft, o = !1) {
  if (r) {
    const s = r[e] || (r[e] = []), a = t.__weh || (t.__weh = (...c) => {
      Jt();
      const i = wr(r), n = Rt(t, r, e, c);
      return i(), Qt(), n;
    });
...
const ee = (e) => (t, r = ft) => {
  (!fr || e === "sp") && so(e, (...o) => t(...o), r);
}, sn = ee("bm"), cc = ee("m"), an = ee(
  "bu"
), cn = ee("u"), nn = ee(
  "bum"
), ds = ee("um"), ln = ee(
...
function gn(e, t, r, o) {
  ...
  const a = r, c = D(e);
  if (c || at(e)) {
    const i = c && /* @__PURE__ */ He(e);
    let n = !1, p = !1;
    i && (n = !/* @__PURE__ */ zt(e), p = /* @__PURE__ */ te(e), e = ro(e)), s = new Array(e.length);
    for (let u = 0, d = e.length; u < d; u++)
      s[u] = t(
        n ? p ? Oe(_t(e[u])) : _t(e[u]) : e[u],
        u,
        void 0,
        a
      );
...
const Mo = (e) => e ? Cc(e) ? fs(e) : Mo(e.parent) : null, cr = (
...
), ko = (e, t) => e !== G && !e.__isScriptSetup && L(e, t), bn = {
  get({ _: e }, t) {
    if (t === "__v_skip")
      return !0;
    ...
    let u, d;
    if (p)
      return t === "$attrs" && mt(e.attrs, "get", ""), p(e);
    if (
    ...
    if (
      // global properties
      d = n.config.globalProperties, L(d, t)
    )
      return d[t];
  },
  set({ _: e }, t, r) {
    const { data: o, setupState: s, ctx: a } = e;
    return ko(s, t) ? (s[t] = r, !0) : o !== G && L(o, t) ? (o[t] = r, !0) : L(e.props, t) || t[0] === "$" && t.slice(1) in e ? !1 : (a[t] = r, !0);
  },
  has({
    _: { data: e, setupState: t, accessCache: r, ctx: o, appContext: s, props: a, type: c }
  }, i) {
    let n;
    return !!(r[i] || e !== G && i[0] !== "$" && L(e, i) || ko(t, i) || L(a, i) || L(o, i) || L(cr, i) || L(s.config.globalProperties, i) || (n = c.__cssModules) && n[i]);
  },
  defineProperty(e, t, r) {
    return r.get != null ? e._.accessCache[t] = 0 : L(r, "value") && this.set(e, t, r.value, null), Reflect.defineProperty(e, t, r);
  }
};
function qs(e) {
  return D(e) ? e.reduce(
...
let Lo = !0;
function hn(e) {
  const t = nc(e), r = e.proxy, o = e.ctx;
  Lo = !1, t.beforeCreate && Ps(t.beforeCreate, e, "bc");
  const {
    // state
    data: s,
    computed: a,
  ...
  if (s) {
    const J = s.call(r, r);
    R(J) && (e.data = /* @__PURE__ */ ns(J));
  }
  if (Lo = !0, a)
    for (const J in a) {
      const F = a[J], de = I(F) ? F.bind(r, r) : I(F.get) ? F.get.bind(r, r) : Lt, Sr = !I(F) && I(F.set) ? F.set.bind(r) : Lt, ge = Lr({
        get: de,
        set: Sr
      });
  ...
  u && Ps(u, e, "c");
  function dt(J, F) {
    D(F) ? F.forEach((de) => J(de.bind(r))) : F && J(F.bind(r));
  }
  if (dt(sn, d), dt(cc, b), dt(an, w), dt(cn, $), dt(en, S), dt(rn, Y), dt(pn, re), dt(mn, ot), dt(un, wt), dt(nn, q), dt(ds, _), dt(ln, $r), D(pe))
    if (pe.length) {
  ...
  B && e.render === Lt && (e.render = B), Fe != null && (e.inheritAttrs = Fe), Cr && (e.components = Cr), Ar && (e.directives = Ar), $r && oc(e);
}
function fn(e, t, r = Lt) {
  D(e) && (e = Oo(e));
  for (const o in e) {
    const s = e[o];
    let a;
    R(s) ? "default" in s ? a = Pr(
      s.from || o,
      s.default,
      !0
    ) : a = Pr(s.from || o) : a = Pr(s), /* @__PURE__ */ pt(a) ? Object.defineProperty(t, o, {
      enumerable: !0,
      configurable: !0,
      get: () => a.value,
      set: (c) => a.value = c
...
function ic(e, t, r, o) {
  ...
  if (at(e)) {
    ...
    if (D(e))
      e.forEach((a) => ic(a, t, r, o));
    else {
      const a = I(e.handler) ? e.handler.bind(r) : t[e.handler];
      I(a) && yo(s, a, e);
    }
}
function nc(e) {
  ...
  return i ? n = i : !s.length && !r && !o ? n = t : (n = {}, s.length && s.forEach(
    (p) => Wr(n, p, c, !0)
  ), Wr(n, t, c)), R(t) && a.set(t, n), n;
}
function Wr(e, t, r, o = !1) {
  const { mixins: s, extends: a } = t;
  a && Wr(e, a, r, !0), s && s.forEach(
    (c) => Wr(e, c, r, !0)
  );
  for (const c in t)
    if (!(o && c === "expose")) {
...
function Ls(e, t) {
  return e ? D(e) && D(t) ? [.../* @__PURE__ */ new Set([...e, ...t])] : ut(
...
function kn(e, t) {
  if (!e) return t;
  if (!t) return e;
  const r = ut(/* @__PURE__ */ Object.create(null), e);
  for (const o in t)
    r[o] = gt(e[o], t[o]);
  return r;
}
...
function wn(e, t) {
  return function(o, s = null) {
    I(o) || (o = ut({}, o)), s != null && !R(s) && (s = null);
    const a = lc(), c = /* @__PURE__ */ new WeakSet(), i = [];
    let n = !1;
    const p = a.app = {
      _uid: xn++,
      _component: o,
      ...
      use(u, ...d) {
        return c.has(u) || (u && I(u.install) ? (c.add(u), u.install(p, ...d)) : I(u) && (c.add(u), u(p, ...d))), p;
      },
      mixin(u) {
      ...
      mount(u, d, b) {
        if (!n) {
          const w = p._ceVNode || Yt(o, s);
          return w.appContext = a, b === !0 ? b = "svg" : b === !1 && (b = void 0), e(w, u, b), n = !0, p._container = u, u.__vue_app__ = p, fs(w.component);
        }
      },
      onUnmount(u) {
        i.push(u);
...
let Le = null;
const zn = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${jt(t)}Modifiers`] || e[`${Ce(t)}Modifiers`];
function jn(e, t, ...r) {
  if (e.isUnmounted) return;
  const o = e.vnode.props || G;
  let s = r;
  const a = t.startsWith("update:"), c = a && zn(o, t.slice(7));
  c && (c.trim && (s = r.map((u) => at(u) ? u.trim() : u)), c.number && (s = r.map(ai)));
  let i, n = o[i = po(t)] || // also try camelCase event handler (#2249)
  o[i = po(jt(t))];
  !n && a && (n = o[i = po(Ce(t))]), n && Rt(
    n,
    e,
    6,
    s
...
function uc(e, t, r = !1) {
  ...
  return !a && !i ? (R(e) && o.set(e, null), null) : (D(a) ? a.forEach((n) => c[n] = null) : ut(c, a), R(e) && o.set(e, c), c);
}
function ao(e, t) {
  return !e || !Yr(t) ? !1 : (t = t.slice(2).replace(/Once$/, ""), L(e, t[0].toLowerCase() + t.slice(1)) || L(e, Ce(t)) || L(e, t));
}
function Os(e) {
  const {
    type: t,
  ...
  try {
    ...
    ir.length = 0, oo(_, e, 1), O = Yt(ue);
  }
  let U = O;
  if (q && S !== !1) {
    const _ = Object.keys(q), { shapeFlag: B } = U;
    _.length && B & 7 && (a && _.some(Jr) && (q = $n(
      q,
      a
    )), U = Re(U, q, !1, !0));
  }
  return r.dirs && (U = Re(U, null, !1, !0), U.dirs = U.dirs ? U.dirs.concat(r.dirs) : r.dirs), r.transition && ps(U, r.transition), O = U, Vr(Y), O;
}
const _n = (e) => {
  let t;
  for (const r in e)
    (r === "class" || r === "style" || Yr(r)) && ((t || (t = {}))[r] = e[r]);
  return t;
}, $n = (e, t) => {
  const r = {};
  for (const o in e)
    (!Jr(o) || !(o.slice(9) in t)) && (r[o] = e[o]);
  return r;
};
function Cn(e, t, r) {
  ...
  if (r && n >= 0) {
    ...
    return (s || i) && (!i || !i.$stable) ? !0 : o === c ? !1 : o ? c ? Rs(o, c, p) : !0 : !!c;
  return !1;
}
function Rs(e, t, r) {
...
function mc(e, t, r) {
  const o = e[r], s = t[r];
  return r === "style" && R(o) && R(s) ? !rs(o, s) : o !== s;
}
...
const pc = {}, dc = () => Object.create(pc), gc = (e) => Object.getPrototypeOf(e) === pc;
function Sn(e, t, r, o = !1) {
  const s = {}, a = dc();
  e.propsDefaults = /* @__PURE__ */ Object.create(null), bc(e, t, s, a);
  for (const c in e.propsOptions[0])
    c in s || (s[c] = void 0);
  r ? e.props = o ? s : /* @__PURE__ */ Di(s) : e.type.props ? e.props = s : e.props = a, e.attrs = a;
}
function En(e, t, r, o) {
  const {
    props: s,
    attrs: a,
    vnode: { patchFlag: c }
  } = e, i = /* @__PURE__ */ M(s), [n] = e.propsOptions;
  let p = !1;
  if (
    ...
    for (const d in i)
      ...
      ((u = Ce(d)) === d || !L(t, u))) && (n ? r && // for camelCase
...
function bc(e, t, r, o) {
  ...
  if (t)
    for (let n in t) {
      ...
      const p = t[n];
      let u;
      s && L(s, u = jt(n)) ? !a || !a.includes(u) ? r[u] = p : (i || (i = {}))[u] = p : ao(e.emitsOptions, n) || (!(n in o) || p !== o[n]) && (o[n] = p, c = !0);
    }
  if (a) {
    const n = /* @__PURE__ */ M(r), p = i || G;
...
function Ro(e, t, r, o, s, a) {
  ...
  if (c != null) {
    ...
    if (i && o === void 0) {
      const n = c.default;
      if (c.type !== Function && !c.skipFactory && I(n)) {
...
function hc(e, t, r = !1) {
  ...
  if (D(a))
    ...
    for (const u in a) {
      const d = jt(u);
      if (Us(d)) {
        const b = a[u], w = c[d] = D(b) || I(b) ? { type: b } : ut({}, b), $ = w.type;
        let S = !1, Y = !0;
        if (D($))
          for (let O = 0; O < $.length; ++O) {
            const q = $[O], U = I(q) && q.name;
            if (U === "Boolean") {
              S = !0;
              break;
            } else U === "String" && (Y = !1);
        ...
        w[
          ...
          1
          /* shouldCastTrue */
        ] = Y, (S || L(w, "default")) && i.push(d);
      }
    }
  const p = [c, i];
  return R(e) && o.set(e, p), p;
}
function Us(e) {
  return e[0] !== "$" && !er(e);
}
const gs = (e) => e === "_" || e === "_ctx" || e === "$stable", bs = (e) => D(e) ? e.map(It) : [It(e)], Dn = (e, t, r) => {
  if (t._n)
    return t;
  const o = Ki((...s) => bs(t(...s)), r);
  return o._c = !1, o;
}, fc = (e, t, r) => {
  const o = e._ctx;
  for (const s in e) {
  ...
  if (e.vnode.shapeFlag & 32) {
    const s = t._;
    s ? (yc(o, t, r), r && Ea(o, "_", s, !0)) : fc(t, o);
  } else t && vc(e, t);
}, In = (e, t, r) => {
  ...
  if (o.shapeFlag & 32) {
    const i = t._;
    i ? r && i === 1 ? a = !1 : yc(s, t, r) : (a = !t.$stable, fc(t, s)), c = t;
  } else t && (vc(e, t), c = { default: 1 });
  if (a)
    for (const i in s)
      !gs(i) && c[i] == null && delete s[i];
}, vt = On;
function qn(e) {
  return Pn(e);
}
function Pn(e, t) {
  ...
  const {
    ...
    setScopeId: w = Lt,
    insertStaticContent: $
  } = e, S = (l, m, g, y = null, h = null, f = null, j = void 0, x = null, k = !!m.dynamicChildren) => {
    if (l === m)
      return;
    l && !Xe(l, m) && (y = Er(l), $t(l, h, f, !0), l = null), m.patchFlag === -2 && (k = !1, m.dynamicChildren = null);
    const { type: v, ref: E, shapeFlag: H } = m;
    switch (v) {
      case co:
        Y(l, m, g, y);
        break;
    ...
    E != null && h ? sr(E, l && l.ref, f, m || l, !m) : E == null && l && l.ref != null && sr(l.ref, null, f, l, !0);
  }, Y = (l, m, g, y) => {
    if (l == null)
      o(
        m.el = i(m.children),
    ...
    let k, v;
    const { props: E, shapeFlag: H, transition: C, dirs: T } = l;
    if (k = l.el = c(
      l.type,
      f,
      E && E.is,
      E
    ), H & 8 ? u(k, l.children) : H & 16 && re(
      l.children,
      k,
      null,
      y,
      ...
      j,
      x
    ), T && be(l, null, y, "created"), wt(k, l, l.scopeId, j, y), E) {
      for (const N in E)
        N !== "value" && !er(N) && a(k, N, null, E[N], f, y);
      "value" in E && a(k, "value", null, E.value, f), (v = E.onVnodeBeforeMount) && Et(v, y, l);
    }
    T && be(l, null, y, "beforeMount");
    const P = Mn(h, C);
    P && C.beforeEnter(k), o(k, m, g), ((v = E && E.onVnodeMounted) || P || T) && vt(() => {
      try {
        v && Et(v, y, l), P && C.enter(k), T && be(l, null, y, "mounted");
      } finally {
      }
    }, h);
  }, wt = (l, m, g, y, h) => {
    ...
    if (h) {
      let f = h.subTree;
      if (m === f || zc(f.type) && (f.ssContent === m || f.ssFallback === m)) {
        const j = h.vnode;
        wt(
          l,
          j,
  ...
  }, re = (l, m, g, y, h, f, j, x, k = 0) => {
    for (let v = k; v < l.length; v++) {
      const E = l[v] = x ? Xt(l[v]) : It(l[v]);
      S(
        null,
        E,
        m,
    ...
    const x = m.el = l.el;
    let { patchFlag: k, dynamicChildren: v, dirs: E } = m;
    k |= l.patchFlag & 16;
    const H = l.props || G, C = m.props || G;
    let T;
    if (g && he(g, !1), (T = C.onVnodeBeforeUpdate) && Et(T, g, m, l), E && be(m, l, g, "beforeUpdate"), g && he(g, !0), (H.innerHTML && C.innerHTML == null || H.textContent && C.textContent == null) && u(x, ""), v ? pe(
      l.dynamicChildren,
      v,
      x,
      g,
      ...
      if (k & 16)
        Fe(x, H, C, g, h);
      else if (k & 2 && H.class !== C.class && a(x, "class", null, C.class, h), k & 4 && a(x, "style", H.style, C.style, h), k & 8) {
        const P = m.dynamicProps;
        for (let N = 0; N < P.length; N++) {
          const V = P[N], st = H[V], lt = C[V];
          (lt !== st || V === "value") && a(x, V, st, lt, h, g);
        }
      }
      k & 1 && l.children !== m.children && u(x, m.children);
    } else !j && v == null && Fe(x, H, C, g, h);
    ((T = C.onVnodeUpdated) || E) && vt(() => {
      T && Et(T, g, m, l), E && be(m, l, g, "updated");
    }, y);
  }, pe = (l, m, g, y, h, f, j) => {
    for (let x = 0; x < m.length; x++) {
      const k = l[x], v = m[x], E = (
        ...
        (k.type === Bt || // - In the case of different nodes, there is going to be a replacement
        // which also requires the correct parent container
        !Xe(k, v) || // - In the case of a component, it could contain anything.
    ...
    if (m !== g) {
      ...
      for (const f in g) {
        if (er(f)) continue;
        const j = g[f], x = m[f];
        j !== x && f !== "value" && a(l, f, x, j, h, y);
      }
      "value" in g && a(l, "value", m.value, g.value, h);
    }
  }, Cr = (l, m, g, y, h, f, j, x, k) => {
    const v = m.el = l ? l.el : i(""), E = m.anchor = l ? l.anchor : i("");
    let { patchFlag: H, dynamicChildren: C, slotScopeIds: T } = m;
    T && (x = x ? x.concat(T) : T), l == null ? (o(v, g, y), o(E, g, y), re(
      // #10007
      ...
      x,
      k
    )) : H > 0 && H & 64 && C && // #2715 the previous fragment could've been a BAILed one as a result
    // of renderSlot() with no valid children
    l.dynamicChildren && l.dynamicChildren.length === C.length ? (pe(
      l.dynamicChildren,
      C,
      g,
      h,
  ...
  }, Ar = (l, m, g, y, h, f, j, x, k) => {
    m.slotScopeIds = x, l == null ? m.shapeFlag & 512 ? h.ctx.activate(
      m,
      g,
      y,
      j,
    ...
    const x = l.component = Gn(
      l,
      y,
      h
    );
    if (sc(l) && (x.ctx.renderer = Ke), Zn(x, !1, j), x.asyncDep) {
      if (h && h.registerDep(x, dt, j), !l.el) {
        const k = x.subTree = Yt(ue);
        O(null, k, m, g), l.placeholder = k.el;
      }
    } else
      dt(
        x,
    ...
    const x = () => {
      if (l.isMounted) {
        let { next: H, bu: C, u: T, parent: P, vnode: N } = l;
        {
          const At = xc(l);
          if (At) {
            H && (H.el = N.el, J(l, H, j)), At.asyncDep.then(() => {
              vt(() => {
                l.isUnmounted || v();
              }, h);
            });
        ...
        let V = H, st;
        he(l, !1), H ? (H.el = N.el, J(l, H, j)) : H = N, C && go(C), (st = H.props && H.props.onVnodeBeforeUpdate) && Et(st, P, H, N), he(l, !0);
        const lt = Os(l), Ct = l.subTree;
        l.subTree = lt, S(
          Ct,
          lt,
          ...
          h,
          f
        ), H.el = lt.el, V === null && An(l, lt.el), T && vt(T, h), (st = H.props && H.props.onVnodeUpdated) && vt(
          () => Et(st, P, H, N),
          h
        );
      } else {
        let H;
        const { el: C, props: T } = m, { bm: P, m: N, parent: V, root: st, type: lt } = l, Ct = ar(m);
        he(l, !1), P && go(P), !Ct && (H = T && T.onVnodeBeforeMount) && Et(H, V, m), he(l, !0);
        {
          st.ce && st.ce._hasShadowRoot() && st.ce._injectChildStyle(
            lt,
            l.parent ? l.parent.type : void 0
          );
          const At = l.subTree = Os(l);
          S(
            null,
            At,
            g,
        ...
        if (N && vt(N, h), !Ct && (H = T && T.onVnodeMounted)) {
          const At = m;
          vt(
            () => Et(H, V, At),
            h
        ...
        (m.shapeFlag & 256 || V && ar(V.vnode) && V.vnode.shapeFlag & 256) && l.a && vt(l.a, h), l.isMounted = !0, m = g = y = null;
      }
    };
    l.scope.on();
    const k = l.effect = new Ia(x);
    l.scope.off();
    const v = l.update = k.run.bind(k), E = l.job = k.runIfDirty.bind(k);
    E.i = l, E.id = l.uid, k.scheduler = () => ms(E), he(l, !0), v();
  }, J = (l, m, g) => {
    m.component = l;
    const y = l.vnode.props;
    l.vnode = m, l.next = null, En(l, m.props, y, g), In(l, m.children, g), Jt(), Ds(l), Qt();
  }, F = (l, m, g, y, h, f, j, x, k = !1) => {
    const v = l && l.children, E = l ? l.shapeFlag : 0, H = m.children, { patchFlag: C, shapeFlag: T } = m;
    if (C > 0) {
      if (C & 128) {
        Sr(
          v,
    ...
    T & 8 ? (E & 16 && Ve(v, h, f), H !== v && u(g, H)) : E & 16 ? T & 16 ? Sr(
      v,
      H,
      g,
      y,
  ...
  }, de = (l, m, g, y, h, f, j, x, k) => {
    l = l || qe, m = m || qe;
    const v = l.length, E = m.length, H = Math.min(v, E);
    let C;
    for (C = 0; C < H; C++) {
      const T = m[C] = k ? Xt(m[C]) : It(m[C]);
      S(
        l[C],
        T,
        g,
  ...
  }, Sr = (l, m, g, y, h, f, j, x, k) => {
    let v = 0;
    const E = m.length;
    let H = l.length - 1, C = E - 1;
    for (; v <= H && v <= C; ) {
      const T = l[v], P = m[v] = k ? Xt(m[v]) : It(m[v]);
      if (Xe(T, P))
        S(
          T,
          P,
    ...
    for (; v <= H && v <= C; ) {
      const T = l[H], P = m[C] = k ? Xt(m[C]) : It(m[C]);
      if (Xe(T, P))
        S(
          T,
          P,
    ...
    if (v > H) {
      ...
      const T = v, P = v, N = /* @__PURE__ */ new Map();
      for (v = P; v <= C; v++) {
        const kt = m[v] = k ? Xt(m[v]) : It(m[v]);
        kt.key != null && N.set(kt.key, v);
      }
      let V, st = 0;
      const lt = C - P + 1;
      let Ct = !1, At = 0;
      const We = new Array(lt);
      for (v = 0; v < lt; v++) We[v] = 0;
      for (v = T; v <= H; v++) {
        const kt = l[v];
        if (st >= lt) {
          $t(kt, h, f, !0);
        ...
        if (kt.key != null)
          ...
          for (V = P; V <= C; V++)
            if (We[V - P] === 0 && Xe(kt, m[V])) {
              St = V;
              break;
            }
        St === void 0 ? $t(kt, h, f, !0) : (We[St - P] = v + 1, St >= At ? At = St : Ct = !0, S(
          kt,
          m[St],
          g,
          null,
      ...
      const _s = Ct ? Ln(We) : qe;
      for (V = _s.length - 1, v = lt - 1; v >= 0; v--) {
        const kt = P + v, St = m[kt], $s = m[kt + 1], Cs = kt + 1 < E ? (
        ...
        We[v] === 0 ? S(
          ...
          x,
          k
        ) : Ct && (V < 0 || v !== _s[V] ? ge(St, g, Cs, 2) : V--);
      }
    }
  }, ge = (l, m, g, y, h = null) => {
    const { el: f, type: j, transition: x, children: k, shapeFlag: v } = l;
    if (v & 6) {
      ge(l.component.subTree, m, g, y);
      return;
    }
    if (v & 128) {
    ...
    if (y !== 2 && v & 1 && x)
      if (y === 0)
        x.beforeEnter(f), o(f, m, g), vt(() => x.enter(f), h);
      else {
        const { leave: H, delayLeave: C, afterLeave: T } = x, P = () => {
    ...
    if (H === -2 && (h = !1), x != null && (Jt(), sr(x, null, g, l, !0), Qt()), T != null && (m.renderCache[T] = void 0), E & 256) {
      m.ctx.deactivate(l);
      return;
    }
    const N = E & 1 && C, V = !ar(l);
    let st;
    if (V && (st = j && j.onVnodeBeforeUnmount) && Et(st, m, l), E & 6)
      Qc(l.component, g, y);
    else {
      if (E & 128) {
      ...
      N && be(l, null, m, "beforeUnmount"), E & 64 ? l.type.remove(
        l,
        m,
        g,
        Ke,
      ...
      (f !== Bt || H > 0 && H & 64) ? Ve(
        ...
        !1,
        !0
      ) : (f === Bt && H & 384 || !h && E & 16) && Ve(k, m, g), y && js(l);
    }
    const lt = P != null && T == null;
    (V && (st = j && j.onVnodeUnmounted) || N || lt) && vt(() => {
      st && Et(st, m, l), N && be(l, null, m, "unmounted"), lt && (l.el = null);
    }, g);
  }, js = (l) => {
    ...
    if (l.shapeFlag & 1 && h && !h.persisted) {
      const { leave: j, delayLeave: x } = h, k = () => j(g, f);
      x ? x(l.el, f, k) : k();
    } else
      f();
  }, Jc = (l, m) => {
    ...
    const { bum: y, scope: h, job: f, subTree: j, um: x, m: k, a: v } = l;
    Ns(k), Ns(v), y && go(y), h.stop(), f && (f.flags |= 8, $t(j, l, m, g)), x && vt(x, m), vt(() => {
      l.isUnmounted = !0;
    }, m);
  }, Ve = (l, m, g, y = !1, h = !1, f = 0) => {
    ...
    const m = b(l.anchor || l.el), g = m && m[Yi];
    return g ? b(g) : m;
  };
  let mo = !1;
  const Hs = (l, m, g) => {
    let y;
    l == null ? m._vnode && ($t(m._vnode, null, null, !0), y = m._vnode.component) : S(
      m._vnode || null,
      l,
      m,
      null,
      ...
      null,
      g
    ), m._vnode = l, mo || (mo = !0, Ds(y), Ja(), mo = !1);
  }, Ke = {
    p: S,
    um: $t,
    m: ge,
...
function kc(e, t, r = !1) {
  ...
  if (D(o) && D(s))
    for (let a = 0; a < o.length; a++) {
      const c = o[a];
      let i = s[a];
      i.shapeFlag & 1 && !i.dynamicChildren && ((i.patchFlag <= 0 || i.patchFlag === 32) && (i = s[a] = Xt(s[a]), i.el = c.el), !r && i.patchFlag !== -2 && kc(c, i)), i.type === co && (i.patchFlag === -1 && (i = s[a] = Xt(i)), i.el = c.el), i.type === ue && !i.el && (i.el = c.el);
    }
}
function Ln(e) {
  const t = e.slice(), r = [0];
...
function On(e, t) {
  t && t.pendingBranch ? D(e) ? t.effects.push(...e) : t.effects.push(e) : Vi(e);
}
const Bt = /* @__PURE__ */ Symbol.for("v-fgt"), co = /* @__PURE__ */ Symbol.for("v-txt"), ue = /* @__PURE__ */ Symbol.for("v-cmt"), wo = /* @__PURE__ */ Symbol.for("v-stc"), ir = [];
let xt = null;
function Kt(e = !1) {
  ir.push(xt = e ? null : []);
}
function Rn() {
  ir.pop(), xt = ir[ir.length - 1] || null;
}
let hr = 1;
function Fs(e, t = !1) {
  hr += e, e < 0 && xt && t && (xt.hasOnce = !0);
}
function jc(e) {
  return e.dynamicChildren = hr > 0 ? xt || qe : null, Rn(), hr > 0 && xt && xt.push(e), e;
}
function oe(e, t, r, o, s, a) {
  return jc(
    et(
      e,
      t,
...
const _c = ({ key: e }) => e ?? null, Mr = ({
  ref: e,
  ref_key: t,
  ref_for: r
}) => (typeof e == "number" && (e = "" + e), e != null ? at(e) || /* @__PURE__ */ pt(e) || I(e) ? { i: Pt, r: e, k: t, f: !!r } : e : null);
function et(e, t = null, r = null, o = 0, s = null, a = e === Bt ? 0 : 1, c = !1, i = !1) {
  const n = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: e,
  ...
  return i ? (hs(n, r), a & 128 && e.normalize(n)) : r && (n.shapeFlag |= at(r) ? 8 : 16), hr > 0 && // avoid a block node from tracking itself
...
function Nn(e, t = null, r = null, o = 0, s = null, a = !1) {
  if ((!e || e === dn) && (e = ue), Hc(e)) {
    ...
    return r && hs(i, r), hr > 0 && !a && xt && (i.shapeFlag & 6 ? xt[xt.indexOf(e)] = i : xt.push(i)), i.patchFlag = -2, i;
  }
  if (tl(e) && (e = e.__vccOpts), t) {
    t = Fn(t);
    let { class: i, style: n } = t;
    i && !at(i) && (t.class = eo(i)), R(n) && (/* @__PURE__ */ us(n) && !D(n) && (n = ut({}, n)), t.style = es(n));
  }
  const c = at(e) ? 1 : zc(e) ? 128 : Ji(e) ? 64 : R(e) ? 4 : I(e) ? 2 : 0;
  return et(
    e,
    t,
    r,
...
function Fn(e) {
  return e ? /* @__PURE__ */ us(e) || gc(e) ? ut({}, e) : e : null;
}
function Re(e, t, r = !1, o = !1) {
  const { props: s, ref: a, patchFlag: c, children: i, transition: n } = e, p = t ? Vn(s || {}, t) : s, u = {
    ...
    ref: t && t.ref ? (
      ...
      r && a ? D(a) ? a.concat(Mr(t)) : [a, Mr(t)] : Mr(t)
    ) : a,
    scopeId: e.scopeId,
    ...
    // fast paths only.
    patchFlag: t && e.type !== Bt ? c === -1 ? 16 : c | 16 : c,
...
function $c(e = " ", t = 0) {
  return Yt(co, null, e, t);
}
function Vs(e = "", t = !1) {
  return t ? (Kt(), Un(ue, null, e)) : Yt(ue, null, e);
}
function It(e) {
  return e == null || typeof e == "boolean" ? Yt(ue) : D(e) ? Yt(
    Bt,
    null,
    // #3666, avoid reference pollution when reusing vnode
    e.slice()
  ) : Hc(e) ? Xt(e) : Yt(co, null, String(e));
}
function Xt(e) {
...
function hs(e, t) {
  ...
  if (t == null)
    ...
    if (o & 65) {
      ...
      r = 32;
      const s = t._;
      !s && !gc(t) ? t._ctx = Pt : s === 3 && Pt && (Pt.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
  else I(t) ? (t = { default: t, _ctx: Pt }, r = 32) : (t = String(t), o & 64 ? (r = 16, t = [$c(t)]) : r = 8);
...
function Zn(e, t = !1, r = !1) {
  t && Uo(t);
  const { props: o, children: s } = e.vnode, a = Cc(e);
...
function Yn(e, t) {
  ...
  if (o) {
    Jt();
    const s = e.setupContext = o.length > 1 ? Qn(e) : null, a = wr(e), c = xr(
      o,
      e,
      0,
      [
...
function Ws(e, t, r) {
  I(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : R(t) && (e.setupState = Xa(t)), Ac(e);
}
function Ac(e, t, r) {
  const o = e.type;
...
function fs(e) {
  return e.exposed ? e.exposeProxy || (e.exposeProxy = new Proxy(Xa(Bi(e.exposed)), {
    get(t, r) {
      if (r in t)
        return t[r];
      if (r in cr)
...
const Lr = (e, t) => /* @__PURE__ */ Li(e, t, fr), el = "3.5.32";
/**
...
if (Gs)
  try {
    No = /* @__PURE__ */ Gs.createPolicy("vue", {
      createHTML: (e) => e
    });
  } catch {
  }
const Sc = No ? (e) => No.createHTML(e) : (e) => e, rl = "http://www.w3.org/2000/svg", ol = "http://www.w3.org/1998/Math/MathML", Gt = typeof document < "u" ? document : null, Xs = Gt && /* @__PURE__ */ Gt.createElement("template"), sl = {
  insert: (e, t, r) => {
  ...
  createElement: (e, t, r, o) => {
    const s = t === "svg" ? Gt.createElementNS(rl, e) : t === "mathml" ? Gt.createElementNS(ol, e) : r ? Gt.createElement(e, { is: r }) : Gt.createElement(e);
...
const Zs = /* @__PURE__ */ Symbol("_vod"), il = /* @__PURE__ */ Symbol("_vsh"), nl = /* @__PURE__ */ Symbol(""), ll = /(?:^|;)\s*display\s*:/;
function ul(e, t, r) {
  const o = e.style, s = at(r);
  let a = !1;
  if (r && !s) {
    if (t)
      if (at(t))
  ...
  Zs in e && (e[Zs] = a ? o.display : "", e[il] && (o.display = "none"));
}
...
function ta(e, t, r, o, s, a = mi(t)) {
  o && t.startsWith("xlink:") ? r == null ? e.removeAttributeNS(Qs, t.slice(6, t.length)) : e.setAttributeNS(Qs, t, r) : r == null || a && !Ta(r) ? e.removeAttribute(t) : e.setAttribute(
    t,
    a ? "" : Ot(r) ? String(r) : r
  );
}
function ea(e, t, r, o, s) {
  if (t === "innerHTML" || t === "textContent") {
    r != null && (e[t] = t === "innerHTML" ? Sc(r) : r);
    return;
  }
  const a = e.tagName;
  ...
  if (r === "" || r == null) {
    const i = typeof e[t];
    i === "boolean" ? r = Ta(r) : r == null && i === "string" ? (r = "", c = !0) : i === "number" && (r = 0, c = !0);
  }
  try {
    e[t] = r;
  } catch {
...
const ra = /* @__PURE__ */ Symbol("_vei");
function gl(e, t, r, o, s = null) {
  const a = e[ra] || (e[ra] = {}), c = a[t];
  if (o && c)
    c.value = o;
  else {
    const [i, n] = bl(t);
...
e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, kl = (e, t, r, o, s, a) => {
  const c = s === "svg";
  t === "class" ? cl(e, o, c) : t === "style" ? ul(e, r, o) : Yr(t) ? Jr(t) || gl(e, t, r, o, a) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : xl(e, t, o, c)) ? (ea(e, t, o), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && ta(e, t, o, c, a, t !== "value")) : /* #11081 force set props for possible async custom element */ e._isVueCE && // #12408 check if it's declared prop or it's async custom element
  (wl(e, t) || // @ts-expect-error _def is private
  e._def.__asyncLoader && (/[A-Z]/.test(t) || !at(o))) ? ea(e, jt(t), o, a, t) : (t === "true-value" ? e._trueValue = o : t === "false-value" && (e._falseValue = o), ta(e, t, o, c));
};
function xl(e, t, r, o) {
  if (o)
    return !!(t === "innerHTML" || t === "textContent" || t in e && sa(t) && I(r));
...
function wl(e, t) {
  ...
  if (!r)
    return !1;
  const o = jt(t);
  return Array.isArray(r) ? r.some((s) => jt(s) === o) : Object.keys(r).some((s) => jt(s) === o);
}
const zl = /* @__PURE__ */ ut({ patchProp: kl }, sl);
let aa;
function jl() {
  return aa || (aa = qn(zl));
}
const Hl = ((...e) => {
  ...
  return t.mount = (o) => {
    ...
    !I(a) && !a.render && !a.template && (a.template = s.innerHTML), s.nodeType === 1 && (s.textContent = "");
    const c = r(s, !1, _l(s));
...
const Cl = "todo-app-list-todos", Al = "todo-app-create-todo", Sl = "todo-app-update-todo", El = "todo-app-delete-todo", Tl = (e) => {
...
}, ca = (e) => Array.isArray(e) ? e.filter(Tl) : [], Ir = (e) => e instanceof Error ? e.message : typeof e == "string" ? e : "Something went wrong", Dl = (e) => {
  const t = /* @__PURE__ */ we([]), r = /* @__PURE__ */ we(!0), o = /* @__PURE__ */ we(null), s = /* @__PURE__ */ we(!1), a = /* @__PURE__ */ we(/* @__PURE__ */ new Set()), c = (b, w) => {
    const $ = new Set(a.value);
    w ? $.add(b) : $.delete(b), a.value = $;
  }, i = async () => {
    ...
    const w = b.trim();
    if (!(w.length === 0 || s.value)) {
      s.value = !0, o.value = null;
      try {
        const $ = await e.connectors.execute({
          permalink: Al,
          method: "POST",
          payload: { title: w, completed: !1 }
        }), S = ca($);
        S.length > 0 ? t.value = [S[0], ...t.value] : await i();
      } catch ($) {
        o.value = Ir($);
      } finally {
        s.value = !1;
    ...
    c(b.id, !0);
    const w = t.value;
    t.value = t.value.filter(($) => $.id !== b.id);
    try {
      await e.connectors.execute({
        permalink: El,
        method: "DELETE",
  ...
  scale: "medium",
  class: "todo-root"
}, Il = { class: "todo-header" }, ql = { class: "todo-heading" }, Pl = { class: "todo-title" }, Ml = ["variant"], Ll = ["disabled"], Ol = ["placeholder", "value", "disabled"], Rl = ["disabled"], Ul = {
  key: 0,
  class: "todo-error",
  role: "alert"
}, Nl = {
  ...
  setup(e) {
    const t = (_) => typeof _ == "object" && _ !== null, r = /* @__PURE__ */ we(e.sdk.getProps()), o = e.sdk.on("propsChanged", (_) => {
      t(_) && (r.value = _);
    });
    ds(o);
    const s = Lr(() => r.value.title ?? "My todos"), a = Lr(
      ...
      deleteTodo: S,
      dismissError: Y
    } = Dl(e.connectors), O = Lr(
      () => i.value.filter((_) => !_.completed).length
    ), q = async (_) => {
      if (_.preventDefault(), u.value || c.value.trim().length === 0) return;
      const B = c.value;
      c.value = "", await w(B);
    }, U = (_) => {
      const B = _.target;
      B instanceof HTMLInputElement && (c.value = B.value);
    };
    return (_, B) => (Kt(), oe("sp-theme", Bl, [
      et("header", Il, [
        et("div", ql, [
          et("h2", Pl, Je(s.value), 1),
          it(n) ? Vs("", !0) : (Kt(), oe("sp-status-light", {
            key: 0,
            size: "s",
            variant: O.value === 0 ? "positive" : "notice"
          }, Je(O.value === 0 ? "All clear" : `${O.value} open`), 9, Ml))
        ]),
        et("sp-action-button", {
          quiet: "",
          size: "m",
          ...
          et("sp-icon-refresh", { slot: "icon" }, null, -1)
        ])], 8, Ll)
      ]),
      et("form", {
        class: "todo-form",
        ...
        et("sp-button", {
          variant: "accent",
          type: "submit",
          disabled: it(u) || c.value.trim().length === 0
        }, [...B[3] || (B[3] = [
          et("sp-icon-add", { slot: "icon" }, null, -1),
          $c(" Add ", -1)
        ])], 8, Rl)
      ], 32),
      B[7] || (B[7] = et("sp-divider", {
        size: "s",
        class: "todo-divider"
      }, null, -1)),
      it(p) ? (Kt(), oe("div", Ul, [
        et("sp-status-light", Nl, Je(it(p)), 1),
        et("sp-action-button", {
          quiet: "",
          size: "s",
      ...
      it(n) ? (Kt(), oe("div", Fl, [...B[4] || (B[4] = [
        et("sp-progress-circle", {
          size: "m",
          indeterminate: ""
        }, null, -1),
        et("span", { class: "todo-muted" }, "Loading todos…", -1)
      ])])) : it(i).length > 0 ? (Kt(), oe("ul", Vl, [
        (Kt(!0), oe(Bt, null, gn(it(i), (ot) => (Kt(), oe("li", {
          key: ot.id,
          class: eo(["todo-item", { "todo-item--done": ot.completed }])
        }, [
          et("sp-checkbox", {
            size: "m",
            checked: ot.completed,
            disabled: it(d).has(ot.id),
            onChange: (wt) => it($)(ot)
          }, [
            et("span", Wl, Je(ot.title), 1)
          ], 40, Kl),
          et("sp-action-button", {
            quiet: "",
            size: "s",
            ...
            et("sp-icon-delete", { slot: "icon" }, null, -1)
          ])], 8, Gl)
        ], 2))), 128))
      ])) : (Kt(), oe("div", Xl, [...B[6] || (B[6] = [
        et("sp-illustrated-message", { heading: "Nothing here yet" }, [
          et("span", { slot: "description" }, " Add your first todo above to get started. ")
        ], -1)
      ])]))
    ]));
  }
}), Ec = "1.11.2", Yl = ["spectrum", "express", "spectrum-two"], Jl = ["medium", "large", "medium-express", "large-express", "medium-spectrum-two", "large-spectrum-two"], Ql = ["light", "lightest", "dark", "darkest", "light-express", "lightest-express", "dark-express", "darkest-express", "light-spectrum-two", "lightest-spectrum-two", "dark-spectrum-two", "darkest-spectrum-two"], tr = class bt extends HTMLElement {
  constructor() {
    ...
    const t = document.importNode(bt.template.content, !0);
  ...
  get system() {
    const t = bt.themeFragmentsByKind.get("system"), { name: r } = t && t.get("default") || {};
  ...
  get color() {
    const t = bt.themeFragmentsByKind.get("color"), { name: r } = t && t.get("default") || {};
  ...
  get scale() {
    const t = bt.themeFragmentsByKind.get("scale"), { name: r } = t && t.get("default") || {};
  ...
  get styles() {
    const t = [...bt.themeFragmentsByKind.keys()], r = (s, a, c) => {
      ...
      const c = bt.themeFragmentsByKind.get(a);
      let i;
    ...
    return bt.themeFragmentsByKind, this.system, this.color, this.scale, [...o];
  }
  static get template() {
  ...
  connectedCallback() {
    if (this.shouldAdoptStyles(), bt.instances.add(this), !this.hasAttribute("dir")) {
      let t = this.assignedSlot || this.parentNode;
      for (; t !== document.documentElement && !(t instanceof bt); ) t = t.assignedSlot || t.parentNode || t.host;
      this.dir = t.dir === "rtl" ? t.dir : "ltr";
    }
  }
  disconnectedCallback() {
    bt.instances.delete(this);
  }
  ...
  static registerThemeFragment(t, r, o) {
    const s = bt.themeFragmentsByKind.get(r) || /* @__PURE__ */ new Map();
    s.size === 0 && (bt.themeFragmentsByKind.set(r, s), s.set("default", { name: t, styles: o }), bt.defaultFragments.add(t)), s.set(t, { name: t, styles: o }), bt.instances.forEach((a) => a.shouldAdoptStyles());
  }
  _provideContext() {
...
tr.themeFragmentsByKind = /* @__PURE__ */ new Map(), tr.defaultFragments = /* @__PURE__ */ new Set(["spectrum"]), tr.instances = /* @__PURE__ */ new Set(), tr.VERSION = Ec;
let io = tr;
customElements.define("sp-theme", io);
/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Rr = globalThis, vs = Rr.ShadowRoot && (Rr.ShadyCSS === void 0 || Rr.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, ys = Symbol(), ia = /* @__PURE__ */ new WeakMap();
let Tc = class {
  constructor(t, r, o) {
    if (this._$cssResult$ = !0, o !== ys) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (vs && t === void 0) {
      ...
      o && (t = ia.get(r)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), o && ia.set(r, t));
    }
    return t;
  }
  toString() {
...
const tu = (e) => new Tc(typeof e == "string" ? e : e + "", void 0, ys), rt = (e, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ru, defineProperty: ou, getOwnPropertyDescriptor: su, getOwnPropertyNames: au, getOwnPropertySymbols: cu, getPrototypeOf: iu } = Object, le = globalThis, la = le.trustedTypes, nu = la ? la.emptyScript : "", Ho = le.reactiveElementPolyfillSupport, nr = (e, t) => e, Xr = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? nu : null;
      break;
  ...
  return r;
} }, ks = (e, t) => !ru(e, t), ua = { attribute: !0, type: String, converter: Xr, reflect: !1, useDefault: !1, hasChanged: ks };
...
let Be = class extends HTMLElement {
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? ua;
  }
  static _$Ei() {
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const s of o) r.unshift(na(s));
    } else t !== void 0 && r.push(na(t));
    return r;
  }
  static _$Eu(t, r) {
    const o = r.attribute;
  ...
  _$ET(t, r) {
    ...
    if (s !== void 0 && o.reflect === !0) {
      const c = (((a = o.converter) == null ? void 0 : a.toAttribute) !== void 0 ? o.converter : Xr).toAttribute(r, o.type);
  ...
  _$AK(t, r) {
    ...
    if (s !== void 0 && this._$Em !== s) {
      const i = o.getPropertyOptions(s), n = typeof i.converter == "function" ? { fromAttribute: i.converter } : ((a = i.converter) == null ? void 0 : a.fromAttribute) !== void 0 ? i.converter : Xr;
      this._$Em = s;
  ...
  requestUpdate(t, r, o, s = !1, a) {
    ...
    if (t !== void 0) {
      ...
      if (s === !1 && (a = this[t]), o ?? (o = i.getPropertyOptions(t)), !((o.hasChanged ?? ks)(a, r) || o.useDefault && o.reflect && a === ((c = this._$Ej) == null ? void 0 : c.get(t)) && !this.hasAttribute(i._$Eu(t, o)))) return;
      this.C(t, r, o);
    }
...
Be.elementStyles = [], Be.shadowRootOptions = { mode: "open" }, Be[nr("elementProperties")] = /* @__PURE__ */ new Map(), Be[nr("finalized")] = /* @__PURE__ */ new Map(), Ho == null || Ho({ ReactiveElement: Be }), (le.reactiveElementVersions ?? (le.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lr = globalThis, ma = (e) => e, Zr = lr.trustedTypes, pa = Zr ? Zr.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, Dc = "$lit$", ne = `lit$${Math.random().toFixed(9).slice(2)}$`, Bc = "?" + ne, lu = `<${Bc}>`, $e = document, vr = () => $e.createComment(""), yr = (e) => e === null || typeof e != "object" && typeof e != "function", xs = Array.isArray, uu = (e) => xs(e) || typeof (e == null ? void 0 : e[Symbol.iterator]) == "function", _o = `[ 	
\f\r]`, Ze = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, da = /-->/g, ga = />/g, fe = RegExp(`>|${_o}(?:([^\\s"'>=/]+)(${_o}*=${_o}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), ba = /'/g, ha = /"/g, Ic = /^(?:script|style|textarea|title)$/i, mu = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), A = mu(1), Mt = Symbol.for("lit-noChange"), X = Symbol.for("lit-nothing"), fa = /* @__PURE__ */ new WeakMap(), ze = $e.createTreeWalker($e, 129);
function qc(e, t) {
  if (!xs(e) || !e.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return pa !== void 0 ? pa.createHTML(t) : t;
}
const pu = (e, t) => {
  const r = e.length - 1, o = [];
  let s, a = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", c = Ze;
  for (let i = 0; i < r; i++) {
    const n = e[i];
    let p, u, d = -1, b = 0;
    for (; b < n.length && (c.lastIndex = b, u = c.exec(n), u !== null); ) b = c.lastIndex, c === Ze ? u[1] === "!--" ? c = da : u[1] !== void 0 ? c = ga : u[2] !== void 0 ? (Ic.test(u[2]) && (s = RegExp("</" + u[2], "g")), c = fe) : u[3] !== void 0 && (c = fe) : c === fe ? u[0] === ">" ? (c = s ?? Ze, d = -1) : u[1] === void 0 ? d = -2 : (d = c.lastIndex - u[2].length, p = u[1], c = u[3] === void 0 ? fe : u[3] === '"' ? ha : ba) : c === ha || c === ba ? c = fe : c === da || c === ga ? c = Ze : (c = fe, s = void 0);
    const w = c === fe && e[i + 1].startsWith("/>") ? " " : "";
    a += c === Ze ? n + lu : d >= 0 ? (o.push(p), n.slice(0, d) + Dc + n.slice(d) + ne + w) : n + ne + (d === -2 ? i : w);
  }
  return [qc(e, a + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
let Fo = class Pc {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    if (this.el = Pc.createElement(p, o), ze.currentNode = this.el.content, r === 2 || r === 3) {
      const d = this.el.content.firstChild;
      d.replaceWith(...d.childNodes);
    }
    for (; (s = ze.nextNode()) !== null && n.length < i; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const d of s.getAttributeNames()) if (d.endsWith(Dc)) {
          const b = u[c++], w = s.getAttribute(d).split(ne), $ = /([.?@])?(.*)/.exec(b);
          n.push({ type: 1, index: a, name: $[2], strings: w, ctor: $[1] === "." ? gu : $[1] === "?" ? bu : $[1] === "@" ? hu : no }), s.removeAttribute(d);
        } else d.startsWith(ne) && (n.push({ type: 6, index: a }), s.removeAttribute(d));
        if (Ic.test(s.tagName)) {
          const d = s.textContent.split(ne), b = d.length - 1;
          if (b > 0) {
            s.textContent = Zr ? Zr.emptyScript : "";
            for (let w = 0; w < b; w++) s.append(d[w], vr()), ze.nextNode(), n.push({ type: 2, index: ++a });
            s.append(d[b], vr());
          }
        }
      } else if (s.nodeType === 8) if (s.data === Bc) n.push({ type: 2, index: a });
      else {
        let d = -1;
        for (; (d = s.data.indexOf(ne, d + 1)) !== -1; ) n.push({ type: 7, index: a }), d += ne.length - 1;
      }
      a++;
    }
  }
...
function Ue(e, t, r = e, o) {
  var c, i;
  if (t === Mt) return t;
  let s = o !== void 0 ? (c = r._$Co) == null ? void 0 : c[o] : r._$Cl;
  const a = yr(t) ? void 0 : t._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== a && ((i = s == null ? void 0 : s._$AO) == null || i.call(s, !1), a === void 0 ? s = void 0 : (s = new a(e), s._$AT(e, r, o)), o !== void 0 ? (r._$Co ?? (r._$Co = []))[o] = s : r._$Cl = s), s !== void 0 && (t = Ue(e, s._$AS(e, t.values), s, o)), t;
}
let du = class {
  constructor(t, r) {
  ...
  u(t) {
    const { el: { content: r }, parts: o } = this._$AD, s = ((t == null ? void 0 : t.creationScope) ?? $e).importNode(r, !0);
    ze.currentNode = s;
    let a = ze.nextNode(), c = 0, i = 0, n = o[0];
    for (; n !== void 0; ) {
      if (c === n.index) {
        let p;
        n.type === 2 ? p = new zr(a, a.nextSibling, this, t) : n.type === 1 ? p = new n.ctor(a, n.name, n.strings, this, t) : n.type === 6 && (p = new fu(a, this, t)), this._$AV.push(p), n = o[++i];
      }
      c !== (n == null ? void 0 : n.index) && (a = ze.nextNode(), c++);
    }
    return ze.currentNode = $e, s;
  }
  p(t) {
    let r = 0;
...
class zr {
  ...
  constructor(t, r, o, s) {
    this.type = 2, this._$AH = X, this._$AN = void 0, this._$AA = t, this._$AB = r, this._$AM = o, this.options = s, this._$Cv = (s == null ? void 0 : s.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, r = this) {
    t = Ue(this, t, r), yr(t) ? t === X || t == null || t === "" ? (this._$AH !== X && this._$AR(), this._$AH = X) : t !== this._$AH && t !== Mt && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : uu(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== X && yr(this._$AH) ? this._$AA.nextSibling.data = t : this.T($e.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var a;
    const { values: r, _$litType$: o } = t, s = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = Fo.createElement(qc(o.h, o.h[0]), this.options)), o);
  ...
  _$AC(t) {
    let r = fa.get(t.strings);
    return r === void 0 && fa.set(t.strings, r = new Fo(t)), r;
  }
  k(t) {
    xs(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let o, s = 0;
    for (const a of t) s === r.length ? r.push(o = new zr(this.O(vr()), this.O(vr()), this, this.options)) : o = r[s], o._$AI(a), s++;
    s < r.length && (this._$AR(o && o._$AB.nextSibling, s), r.length = s);
  }
  _$AR(t = this._$AA.nextSibling, r) {
    var o;
    for ((o = this._$AP) == null ? void 0 : o.call(this, !1, !0, r); t !== this._$AB; ) {
      const s = ma(t).nextSibling;
      ma(t).remove(), t = s;
    }
  }
  setConnected(t) {
...
class no {
  ...
  constructor(t, r, o, s, a) {
    this.type = 1, this._$AH = X, this._$AN = void 0, this.element = t, this.name = r, this._$AM = s, this.options = a, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = X;
  }
  _$AI(t, r = this, o, s) {
    const a = this.strings;
    let c = !1;
    if (a === void 0) t = Ue(this, t, r, 0), c = !yr(t) || t !== this._$AH && t !== Mt, c && (this._$AH = t);
    else {
      const i = t;
      let n, p;
      for (t = a[0], n = 0; n < a.length - 1; n++) p = Ue(this, i[o + n], r, n), p === Mt && (p = this._$AH[n]), c || (c = !yr(p) || p !== this._$AH[n]), p === X ? t = X : t !== X && (t += (p ?? "") + a[n + 1]), this._$AH[n] = p;
    }
    c && !s && this.j(t);
  }
  j(t) {
...
class hu extends no {
  ...
  _$AI(t, r = this) {
    if ((t = Ue(this, t, r, 0) ?? X) === Mt) return;
    const o = this._$AH, s = t === X && o !== X || t.capture !== o.capture || t.once !== o.once || t.passive !== o.passive, a = t !== X && (o === X || s);
...
const $o = lr.litHtmlPolyfillSupport;
$o == null || $o(Fo, zr), (lr.litHtmlVersions ?? (lr.litHtmlVersions = [])).push("3.3.2");
const vu = (e, t, r) => {
  const o = (r == null ? void 0 : r.renderBefore) ?? t;
  let s = o._$litPart$;
  if (s === void 0) {
    const a = (r == null ? void 0 : r.renderBefore) ?? null;
    o._$litPart$ = s = new zr(t.insertBefore(vr(), a), a, void 0, r ?? {});
  }
  return s._$AI(e), s;
};
/**
...
var ja;
ur._$litElement$ = !0, ur.finalized = !0, (ja = _e.litElementHydrateSupport) == null || ja.call(_e, { LitElement: ur });
const Co = _e.litElementPolyfillSupport;
Co == null || Co({ LitElement: ur });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const zu = { attribute: !0, type: String, converter: Xr, reflect: !1, hasChanged: ks }, ju = (e = zu, t, r) => {
...
`;
io.registerThemeFragment("spectrum-two", "system", Su);
io.registerThemeFragment("light-spectrum-two", "color", Au);
const Eu = rt`
...
`;
io.registerThemeFragment("medium-spectrum-two", "scale", Eu);
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Se = { ATTRIBUTE: 1, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4 }, Tu = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Du = class {
  constructor(t) {
  }
  get _$AU() {
...
const Pu = Tu(class extends Du {
  constructor(e) {
    if (super(e), e.type !== Se.PROPERTY && e.type !== Se.ATTRIBUTE && e.type !== Se.BOOLEAN_ATTRIBUTE) throw Error("The `live` directive is not allowed on child or event bindings");
  ...
  update(e, [t]) {
    if (t === Mt || t === X) return t;
    const r = e.element, o = e.name;
    if (e.type === Se.PROPERTY) {
      if (t === r[o]) return Mt;
    } else if (e.type === Se.BOOLEAN_ATTRIBUTE) {
      if (!!t === r.hasAttribute(o)) return Mt;
    } else if (e.type === Se.ATTRIBUTE && r.getAttribute(o) === t + "") return Mt;
    return qu(e), t;
  }
});
var Mu = Object.defineProperty, Ee = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && Mu(t, r, s), s;
};
function Lu(e) {
  class t extends e {
    renderAnchor({ id: o, className: s, ariaHidden: a, labelledby: c, tabindex: i, anchorContent: n = A`<slot></slot>` }) {
      return A`<a
                    id=${o}
                    class=${W(s)}
                    href=${W(this.href)}
                    ...
                    aria-labelledby=${W(c)}
                    aria-hidden=${W(a ? "true" : void 0)}
                    tabindex=${W(i)}
                    referrerpolicy=${W(this.referrerpolicy)}
                    rel=${W(this.rel)}
                >${n}</a>`;
    }
  }
  return Ee([z()], t.prototype, "download"), Ee([z()], t.prototype, "label"), Ee([z()], t.prototype, "href"), Ee([z()], t.prototype, "target"), Ee([z()], t.prototype, "referrerpolicy"), Ee([z()], t.prototype, "rel"), t;
}
let Wo = !0;
try {
...
Ao([z({ type: Boolean, reflect: !0 })], mr.prototype, "disabled", 2), Ao([z({ type: Boolean })], mr.prototype, "autofocus", 2), Ao([z({ type: Number })], mr.prototype, "tabIndex", 1);
let Nu = class {
...
var Fu = Object.defineProperty, ya = (e, t, r, o) => {
...
class pr extends Vu(Lu(mr), "", ["sp-overlay,sp-tooltip"]) {
  constructor() {
...
Eo([z({ type: Boolean, reflect: !0 })], pr.prototype, "active"), Eo([z({ type: String })], pr.prototype, "type"), Eo([jr(".anchor")], pr.prototype, "anchorElement");
const Gu = rt`
...
var Yu = Object.defineProperty, Hr = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--)
    (c = e[a]) && (s = c(t, r, s) || s);
  return s && Yu(t, r, s), s;
};
let Ne = class extends me(Ut, {
  validSizes: Zu
}) {
  constructor() {
...
Go.STATIC_COLORS = Lc, tm([z({ type: String, reflect: !0, attribute: "static-color" })], Go.prototype, "staticColor");
Z("sp-progress-circle", Go);
class em {
  constructor(t) {
    this.cachedAriaLabel = null, this.host = t, this.host.addController(this);
  }
  renderPendingState() {
    return this.host.pending ? A`
                  <sp-progress-circle
                      id="loader"
                      size="s"
                      indeterminate
...
var rm = Object.defineProperty, om = Object.getOwnPropertyDescriptor, ve = (e, t, r, o) => {
...
class ae extends me(pr, { noDefaultSize: !0 }) {
  constructor() {
...
ve([z({ type: String, attribute: "pending-label" })], ae.prototype, "pendingLabel", 2), ve([z({ type: Boolean, reflect: !0, attribute: !0 })], ae.prototype, "pending", 2), ve([z()], ae.prototype, "variant", 1), ve([z({ reflect: !0, attribute: "static-color" })], ae.prototype, "staticColor", 2), ve([z({ reflect: !0 })], ae.prototype, "treatment", 2), ve([z({ type: Boolean })], ae.prototype, "quiet", 1), ve([z({ type: Boolean, attribute: "no-wrap", reflect: !0 })], ae.prototype, "noWrap", 2);
Z("sp-button", ae);
function Oc(e, t, r) {
...
function Rc(e, t, r) {
  ...
  } : (a.push(...o), e.setAttribute(t, a.join(" ")), () => Oc(e, t, o));
}
function Xo() {
...
class am {
  ...
  render(t) {
    return A`
            <div
                id=${W(this.isInternal ? this.id : void 0)}
                aria-live="assertive"
            >
                <slot
  ...
  addId() {
    ...
    this.conditionId = Rc(this.host, "aria-describedby", t), this.host.hasAttribute("tabindex") && (this.previousTabindex = parseFloat(this.host.getAttribute("tabindex"))), this.host.tabIndex = 0;
  }
  removeId() {
...
const Uc = Symbol("system resolver updated");
class im {
  constructor(t) {
  ...
  resolveSystem() {
    const t = new CustomEvent("sp-system-context", { bubbles: !0, composed: !0, detail: { callback: (r, o) => {
      const s = this.system;
      this.system = r, this.unsubscribe = o, this.host.requestUpdate(Uc, s);
    } }, cancelable: !0 });
...
class nt extends Ut {
  ...
  update(t) {
    t.has("label") && (this.label ? this.removeAttribute("aria-hidden") : this.setAttribute("aria-hidden", "true")), t.has(Uc) && (this.spectrumVersion = this.systemResolver.system === "spectrum-two" ? 2 : 1), super.update(t);
  }
  render() {
    return A`
            <slot></slot>
...
To([Ko()], nt.prototype, "spectrumVersion"), To([z({ reflect: !0 })], nt.prototype, "label"), To([z({ reflect: !0 })], nt.prototype, "size");
let Zo;
const ct = function(e, ...t) {
  return Zo ? Zo(e, ...t) : t.reduce((r, o, s) => r + o + e[s + 1], e[0]);
}, Nt = (e) => {
  Zo = e;
}, um = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark100" } = {}) => ct`<svg
  ...
  >
    ...
    />
  </svg>`, mm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark100" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class pm extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? um({ hidden: !this.label, title: this.label }) : mm({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-checkmark100", pm);
let Yo;
const Ft = function(e, ...t) {
  return Yo ? Yo(e, ...t) : t.reduce((r, o, s) => r + o + e[s + 1], e[0]);
}, _r = (e) => {
  Yo = e;
}, dm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Alert" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
  ...
  >
    ...
    />
  </svg>`, gm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Alert Triangle" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
...
class bm extends nt {
  render() {
    return _r(A), this.spectrumVersion === 1 ? dm({ hidden: !this.label, title: this.label }) : gm({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-alert", bm);
const hm = rt`
...
`;
var fm = Object.defineProperty, vm = Object.getOwnPropertyDescriptor, Q = (e, t, r, o) => {
...
class tt extends cm(me(mr, { noDefaultSize: !0 })) {
  constructor() {
  ...
  get renderMultiline() {
    return A`
            ...
            <textarea
                ...
                aria-invalid=${W(this.invalid || void 0)}
                class="input"
                maxlength=${W(this.maxlength > -1 ? this.maxlength : void 0)}
                minlength=${W(this.minlength > -1 ? this.minlength : void 0)}
                title=${this.invalid ? "" : X}
                ...
                rows=${W(this.rows > -1 ? this.rows : void 0)}
...
Q([Ko()], tt.prototype, "appliedLabel", 2), Q([z({ attribute: "allowed-keys" })], tt.prototype, "allowedKeys", 2), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "focused", 2), Q([jr(".input:not(#sizer)")], tt.prototype, "inputElement", 2), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "invalid", 2), Q([z()], tt.prototype, "label", 2), Q([z({ type: String, reflect: !0 })], tt.prototype, "name", 2), Q([z()], tt.prototype, "placeholder", 2), Q([Ko()], tt.prototype, "type", 1), Q([z({ attribute: "type", reflect: !0 })], tt.prototype, "_type", 2), Q([z()], tt.prototype, "pattern", 2), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "grows", 2), Q([z({ type: Number })], tt.prototype, "maxlength", 2), Q([z({ type: Number })], tt.prototype, "minlength", 2), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "multiline", 2), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "readonly", 2), Q([z({ type: Number })], tt.prototype, "rows", 2), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "valid", 2), Q([z({ type: String })], tt.prototype, "value", 1), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "quiet", 2), Q([z({ type: Boolean, reflect: !0 })], tt.prototype, "required", 2), Q([z({ type: String, reflect: !0 })], tt.prototype, "autocomplete", 2);
class Fc extends tt {
  constructor() {
...
Q([z({ type: String })], Fc.prototype, "value", 1);
Z("sp-textfield", Fc);
...
function xm(e) {
  ...
  return qr([z({ type: Boolean, reflect: !0 })], t.prototype, "checked"), qr([z({ type: String, reflect: !0 })], t.prototype, "name"), qr([z({ type: Boolean, reflect: !0 })], t.prototype, "readonly"), qr([jr("#input")], t.prototype, "inputElement"), t;
}
const wm = rt`
...
`, zm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark75" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, jm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark75" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Hm extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? zm({ hidden: !this.label, title: this.label }) : jm({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-checkmark75", Hm);
const _m = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark200" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, $m = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark200" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Cm extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? _m({ hidden: !this.label, title: this.label }) : $m({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-checkmark200", Cm);
const Am = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark300" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, Sm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark300" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 14"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Em extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? Am({ hidden: !this.label, title: this.label }) : Sm({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-checkmark300", Em);
const Tm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash75" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  </svg>`, Dm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash75" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Bm extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? Tm({ hidden: !this.label, title: this.label }) : Dm({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-dash75", Bm);
const Im = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash100" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  </svg>`, qm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash100" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 10 10"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Pm extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? Im({ hidden: !this.label, title: this.label }) : qm({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-dash100", Pm);
const Mm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash200" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  </svg>`, Lm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash200" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Om extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? Mm({ hidden: !this.label, title: this.label }) : Lm({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-dash200", Om);
const Rm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash300" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  </svg>`, Um = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Dash300" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 12 12"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Nm extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? Rm({ hidden: !this.label, title: this.label }) : Um({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-dash300", Nm);
const Fm = rt`
...
`;
var Vm = Object.defineProperty, Ye = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && Vm(t, r, s), s;
};
const Km = { s: () => A`
        ...
        `, xl: () => A`
            ...
            ></sp-icon-dash300>
        ` };
class ke extends me(xm(Ut), { noDefaultSize: !0 }) {
  constructor() {
  ...
  render() {
    return A`
            ${super.render()}
            <span id="box">
                ${this.checked ? Km[this.size]() : A``}
                ${this.indeterminate ? Wm[this.size]() : A``}
            </span>
...
ke.shadowRootOptions = { ...Ut.shadowRootOptions, delegatesFocus: !0 }, Ye([z({ type: Boolean, reflect: !0 })], ke.prototype, "disabled"), Ye([z({ type: Boolean, reflect: !0 })], ke.prototype, "indeterminate"), Ye([z({ type: Boolean, reflect: !0 })], ke.prototype, "invalid"), Ye([z({ type: Boolean, reflect: !0 })], ke.prototype, "emphasized"), Ye([z({ reflect: !0, type: Number, attribute: "tabindex" })], ke.prototype, "tabIndex");
Z("sp-checkbox", ke);
const Gm = rt`
...
`, Zm = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Corner Triangle300" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, Ym = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Corner Triangle300" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 7 7"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class Jm extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? Zm({ hidden: !this.label, title: this.label }) : Ym({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-corner-triangle300", Jm);
var Qm = Object.defineProperty, tp = Object.getOwnPropertyDescriptor, se = (e, t, r, o) => {
...
let ka;
class Wt extends me(pr, { validSizes: ["xs", "s", "m", "l", "xl"], noDefaultSize: !0 }) {
  constructor() {
  ...
  handlePointerdownHoldAffordance(t) {
    t.button === 0 && (this.addEventListener("pointerup", this.handlePointerupHoldAffordance), this.addEventListener("pointercancel", this.handlePointerupHoldAffordance), ka = setTimeout(() => {
      this.dispatchEvent(new CustomEvent("longpress", { bubbles: !0, composed: !0, detail: { source: "pointer" } }));
    }, rp));
  }
  handlePointerupHoldAffordance() {
    clearTimeout(ka), this.removeEventListener("pointerup", this.handlePointerupHoldAffordance), this.removeEventListener("pointercancel", this.handlePointerupHoldAffordance);
  }
  handleKeydown(t) {
  ...
  get buttonContent() {
    ...
    return this.holdAffordance && t.unshift(A`
...
se([z({ type: Boolean, reflect: !0 })], Wt.prototype, "emphasized", 2), se([z({ type: Boolean, reflect: !0, attribute: "hold-affordance" })], Wt.prototype, "holdAffordance", 2), se([z({ type: Boolean, reflect: !0 })], Wt.prototype, "quiet", 2), se([z({ reflect: !0 })], Wt.prototype, "role", 2), se([z({ type: Boolean, reflect: !0 })], Wt.prototype, "selected", 2), se([z({ type: Boolean, reflect: !0 })], Wt.prototype, "toggles", 2), se([z({ reflect: !0, attribute: "static-color" })], Wt.prototype, "staticColor", 2), se([z({ type: String })], Wt.prototype, "value", 1);
Z("sp-action-button", Wt);
const op = [
  "s",
  "m",
  "l"
], sp = ["white", "black"];
var ap = Object.defineProperty, Vc = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--)
    (c = e[a]) && (s = c(t, r, s) || s);
  return s && ap(t, r, s), s;
};
class lo extends me(Ut, {
  validSizes: op,
...
Vc([
  z({ type: Boolean, reflect: !0 })
], lo.prototype, "vertical");
Vc([
  z({ reflect: !0, attribute: "static-color" })
], lo.prototype, "staticColor");
const cp = rt`
...
Kc.styles = [cp];
Z("sp-divider", Kc);
const ip = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Asterisk100" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r ? "true" : "false"}
    role="img"
  ...
  >
    ...
    />
  </svg>`, np = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Asterisk100" } = {}) => ct`<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 8 8"
    aria-hidden=${r ? "true" : "false"}
    role="img"
...
class lp extends nt {
  render() {
    return Nt(A), this.spectrumVersion === 2 ? ip({ hidden: !this.label, title: this.label }) : np({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-asterisk100", lp);
const up = rt`
...
`, Wc = Symbol("element resolver updated");
class mp {
  ...
  set element(t) {
    ...
    this._element = t, this.host.requestUpdate(Wc, r);
  }
  get selector() {
...
:host,:host{--spectrum-field-label-min-height:var(--spectrum-component-height-75);--spectrum-field-label-font-size:var(--spectrum-font-size-75);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-medium);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-200);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-medium)}:host([size=s]){--spectrum-field-label-min-height:var(--spectrum-component-height-75);--spectrum-field-label-font-size:var(--spectrum-font-size-75);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-small);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-100);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-small)}:host([size=l]){--spectrum-field-label-min-height:var(--spectrum-component-height-100);--spectrum-field-label-font-size:var(--spectrum-font-size-100);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-large);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-200);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-large)}:host([size=xl]){--spectrum-field-label-min-height:var(--spectrum-component-height-200);--spectrum-field-label-font-size:var(--spectrum-font-size-200);--spectrum-field-label-side-margin-block-start:var(--spectrum-field-label-top-margin-extra-large);--spectrum-field-label-side-padding-right:var(--spectrum-spacing-200);--spectrum-field-label-text-to-asterisk:var(--spectrum-field-label-text-to-asterisk-extra-large)}:host{box-sizing:border-box;min-block-size:var(--mod-fieldlabel-min-height,var(--spectrum-field-label-min-height));padding-block:var(--mod-fieldlabel-padding-block,var(--mod-field-label-top-to-text,var(--spectrum-field-label-top-to-text))var(--mod-field-label-bottom-to-text,var(--spectrum-field-label-bottom-to-text)));padding-inline:0;padding-inline:var(--mod-fieldlabel-padding-inline,0);margin-block:0;margin-block:var(--mod-fieldlabel-margin-block,var(--mod-fieldlabel-margin-block-start,0)var(--mod-fieldlabel-margin-block-end,0));margin-inline:0;margin-inline:var(--mod-fieldlabel-margin-inline,var(--mod-fieldlabel-margin-inline-start,0)var(--mod-fieldlabel-margin-inline-end,0));font-size:var(--mod-fieldlabel-font-size,var(--spectrum-field-label-font-size));font-weight:var(--mod-fieldlabel-font-weight,var(--spectrum-regular-font-weight));line-height:var(--mod-fieldlabel-line-height,var(--spectrum-line-height-100));-webkit-font-smoothing:subpixel-antialiased;-moz-osx-font-smoothing:auto;color:var(--highcontrast-field-label-content-color,var(--mod-fieldlabel-color,var(--spectrum-neutral-subdued-content-color-default)));display:block}:host(:lang(ja)),:host(:lang(ko)),:host(:lang(zh)){--mod-fieldlabel-line-height:var(--mod-fieldlabel-line-height-cjk,var(--spectrum-cjk-line-height-100))}:host([disabled]){--mod-fieldlabel-color:var(--mod-disabled-content-color,var(--spectrum-disabled-content-color))}.required-icon{color:inherit;margin-block:0;margin-inline:var(--mod-field-label-text-to-asterisk,var(--spectrum-field-label-text-to-asterisk))0;vertical-align:initial;vertical-align:var(--mod-field-label-asterisk-vertical-align,baseline)}:host([side-aligned=start]),:host([side-aligned=end]){vertical-align:top;margin-block-start:var(--mod-fieldlabel-side-margin-block-start,var(--spectrum-field-label-side-margin-block-start));margin-block-end:0;margin-inline-end:var(--mod-fieldlabel-side-padding-right,var(--spectrum-field-label-side-padding-right));display:inline-block}:host([side-aligned=end]){text-align:end}@media (forced-colors:active){:host([disabled]){--highcontrast-field-label-content-color:GrayText}}:host{--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text)}:host([size=s]){--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text-small);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text-small)}:host([size=l]){--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text-large);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text-large)}:host([size=xl]){--spectrum-field-label-top-to-text:var(--system-field-label-top-to-text-extra-large);--spectrum-field-label-bottom-to-text:var(--system-field-label-bottom-to-text-extra-large)}label{display:inline-block}
        `;
var dp = Object.defineProperty, Te = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && dp(t, r, s), s;
};
class xe extends me(Ut, { noDefaultSize: !0 }) {
  constructor() {
  ...
  applyTargetLabel(t) {
    if (this.target = t || this.target, this.target) {
      ...
      typeof r < "u" ? r(this.labelText, this) : s === this.getRootNode() ? (t ? Rc : Oc)(o, "aria-labelledby", [this.id]) : t ? o.setAttribute("aria-label", this.labelText) : o.removeAttribute("aria-label");
    }
  }
  async manageTarget() {
  ...
  willUpdate(t) {
    this.hasAttribute("id") || this.setAttribute("id", `${this.tagName.toLowerCase()}-${Xo()}`), t.has("for") && (this.resolvedElement.selector = this.for ? `#${this.for}` : ""), (t.has("id") || t.has(Wc)) && this.manageTarget();
  }
}
Te([z({ type: Boolean, reflect: !0 })], xe.prototype, "disabled"), Te([z({ type: String })], xe.prototype, "id"), Te([z({ type: String })], xe.prototype, "for"), Te([z({ type: Boolean, reflect: !0 })], xe.prototype, "required"), Te([jr("slot")], xe.prototype, "slotEl"), Te([z({ type: String, reflect: !0, attribute: "side-aligned" })], xe.prototype, "sideAligned");
Z("sp-field-label", xe);
...
`;
var yp = Object.defineProperty, xa = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && yp(t, r, s), s;
};
class Ie extends Gc {
...
Ie.VARIANTS_COLOR = ws, Ie.VARIANTS_SEMANTIC = Xc, Ie.VARIANTS = fp, xa([z({ type: String, reflect: !0 })], Ie.prototype, "variant"), xa([z({ type: Boolean, reflect: !0 })], Ie.prototype, "disabled");
Z("sp-status-light", Ie);
const kp = rt`
...
`, jp = [Zc, Yc, zp];
var Hp = Object.defineProperty, wa = (e, t, r, o) => {
  for (var s = void 0, a = e.length - 1, c; a >= 0; a--) (c = e[a]) && (s = c(t, r, s) || s);
  return s && Hp(t, r, s), s;
};
class Ur extends Ut {
...
Ur.is = "sp-illustrated-message", wa([z()], Ur.prototype, "heading"), wa([z()], Ur.prototype, "description");
Z("sp-illustrated-message", Ur);
const _p = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Delete" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`, $p = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Delete" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
...
class Cp extends nt {
  render() {
    return _r(A), this.spectrumVersion === 2 ? _p({ hidden: !this.label, title: this.label }) : $p({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-delete", Cp);
const Ap = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Add" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`, Sp = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Add" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
...
class Ep extends nt {
  render() {
    return _r(A), this.spectrumVersion === 2 ? Ap({ hidden: !this.label, title: this.label }) : Sp({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-add", Ep);
const Tp = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    <path
      ...
      fill="currentColor"
    />
  </svg>`, Dp = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Checkmark" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    height="${t}"
    viewBox="0 0 36 36"
    width="${e}"
...
class Bp extends nt {
  render() {
    return _r(A), this.spectrumVersion === 2 ? Tp({ hidden: !this.label, title: this.label }) : Dp({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-checkmark", Bp);
const Ip = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Refresh" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 20 20"
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    />
  </svg>`, qp = ({ width: e = 24, height: t = 24, hidden: r = !1, title: o = "Refresh" } = {}) => Ft`<svg
    xmlns="http://www.w3.org/2000/svg"
    width="${e}"
    height="${t}"
    viewBox="0 0 36 36"
...
class Pp extends nt {
  render() {
    return _r(A), this.spectrumVersion === 2 ? Ip({ hidden: !this.label, title: this.label }) : qp({ hidden: !this.label, title: this.label });
  }
}
Z("sp-icon-refresh", Pp);
let Mp = ti;
const za = /* @__PURE__ */ new Set(), Lp = () => window.WidgetServiceSDK ? new window.WidgetServiceSDK() : null;
async function Yp(e) {
  await e.whenReady();
  const t = document.createElement("style");
  t.textContent = Mp, za.add(t), e.shadowRoot.insertBefore(t, e.shadowRoot.firstChild);
  const r = Lp();
  if (!r) {
  ...
  o.mount(e.getContainer()), e.on("destroy", () => {
    za.delete(t), t.remove(), o.unmount();
  });
}
export {
  Yp as init
